 ...
 *           not all the format are available. Instead, only %02X, %x, %d, %u, %s and %c are
 * available. %f,, %+, %#, %- and others are excluded
 ...
 * @param  Pointer to a buffer where the resulting C-string is stored. The buffer should have a size
