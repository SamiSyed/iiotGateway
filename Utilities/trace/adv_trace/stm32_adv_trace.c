 ...
 *
 *  @note only valid if UTIL_ADV_TRACE_OVERRUN has been enabled inside utilities
 * conf
 */
typedef enum {
 ...
 *
 *  @note only valid if UTIL_ADV_TRACE_UNCHUNK_MODE has been enabled inside
 * utilities conf
 */
typedef enum {
 ...
 *
 *  @note some part of the context are depend with the selected switch inside
 * the configuration file UTIL_ADV_TRACE_UNCHUNK_MODE, UTIL_ADV_TRACE_OVERRUN,
...
typedef struct {
  ...
  cb_timestamp
      *timestamp_func; /*!<ptr of function used to insert time stamp.        */
...
static UTIL_ADV_TRACE_MEMLOCATION uint8_t
    ADV_TRACE_Buffer[UTIL_ADV_TRACE_FIFO_SIZE];
...
UTIL_ADV_TRACE_Status_t UTIL_ADV_TRACE_COND_FSend(uint32_t VerboseLevel,
...
#else
  uint8_t
      buf[UTIL_ADV_TRACE_TMP_BUF_SIZE + UTIL_ADV_TRACE_TMP_MAX_TIMESTMAP_SIZE];
#endif
  ...
  buff_size = (uint16_t)UTIL_ADV_TRACE_VSNPRINTF(
      (char *)sztmp, UTIL_ADV_TRACE_TMP_BUF_SIZE, strFormat, vaArgs);
  ...
  if (TRACE_AllocateBufer((buff_size + timestamp_size), &writepos) != -1) {
    ...
    (void)UTIL_ADV_TRACE_VSNPRINTF((char *)(&ADV_TRACE_Buffer[writepos]),
                                   UTIL_ADV_TRACE_TMP_BUF_SIZE, strFormat,
                                   vaArgs);
    va_end(vaArgs);
...
#if defined(UTIL_ADV_TRACE_OVERRUN)
  UTIL_ADV_TRACE_ENTER_CRITICAL_SECTION();
  if ((ADV_TRACE_Ctx.OverRunStatus == TRACE_OVERRUN_NONE) &&
      (NULL != ADV_TRACE_Ctx.overrun_func)) {
  ...
  va_start(vaArgs, strFormat);
  buff_size += (uint16_t)UTIL_ADV_TRACE_VSNPRINTF((char *)(buf + buff_size),
...
UTIL_ADV_TRACE_Status_t UTIL_ADV_TRACE_FSend(const char *strFormat, ...) {
  ...
  va_start(vaArgs, strFormat);
  uint16_t bufSize = (uint16_t)UTIL_ADV_TRACE_VSNPRINTF(
      (char *)buf, UTIL_ADV_TRACE_TMP_BUF_SIZE, strFormat, vaArgs);
  va_end(vaArgs);
...
uint32_t UTIL_ADV_TRACE_GetRegion(void) { return ADV_TRACE_Ctx.RegionMask; }
  ...
  if (TRACE_IsLocked() == 0u) {
    ...
    if (ADV_TRACE_Ctx.TraceRdPtr != ADV_TRACE_Ctx.TraceWrPtr) {
      ...
      if (TRACE_UNCHUNK_DETECTED == ADV_TRACE_Ctx.unchunk_status) {
        ADV_TRACE_Ctx.TraceSentSize = (uint16_t)(ADV_TRACE_Ctx.unchunk_enabled -
                                                 ADV_TRACE_Ctx.TraceRdPtr);
        ADV_TRACE_Ctx.unchunk_status = TRACE_UNCHUNK_TRANSFER;
        ADV_TRACE_Ctx.unchunk_enabled = 0;

        UTIL_ADV_TRACE_DEBUG("\nTRACE_TxCpltCallback::unchunk start(%d,%d)\n",
                             ADV_TRACE_Ctx.unchunk_enabled,
                             ADV_TRACE_Ctx.TraceRdPtr);
      ...
      if (TRACE_UNCHUNK_NONE == ADV_TRACE_Ctx.unchunk_status) {
        ...
        if (ADV_TRACE_Ctx.TraceWrPtr > ADV_TRACE_Ctx.TraceRdPtr) {
          ADV_TRACE_Ctx.TraceSentSize =
              ADV_TRACE_Ctx.TraceWrPtr - ADV_TRACE_Ctx.TraceRdPtr;
        } else /* TraceRdPtr > TraceWrPtr */
        {
          ADV_TRACE_Ctx.TraceSentSize =
              UTIL_ADV_TRACE_FIFO_SIZE - ADV_TRACE_Ctx.TraceRdPtr;
        }
#ifdef UTIL_ADV_TRACE_UNCHUNK_MODE
      }
#endif
...
/**
 * @brief Tx callback called by the low layer level to inform a transfer
 * complete
...
static void TRACE_TxCpltCallback(void *Ptr) {
  ...
  if ((ADV_TRACE_Ctx.TraceRdPtr != ADV_TRACE_Ctx.TraceWrPtr) &&
    ...
    if (TRACE_UNCHUNK_DETECTED == ADV_TRACE_Ctx.unchunk_status) {
      ...
      if (0u == ADV_TRACE_Ctx.TraceSentSize) {
        /* this case occurs when an ongoing write aligned the Rd position with
         * chunk position */
...
static int16_t TRACE_AllocateBufer(uint16_t Size, uint16_t *Pos) {
  ...
  if (ADV_TRACE_Ctx.TraceWrPtr == ADV_TRACE_Ctx.TraceRdPtr) {
    ...
    if (ADV_TRACE_Ctx.TraceWrPtr > ADV_TRACE_Ctx.TraceRdPtr) {
      freesize =
          (uint16_t)(UTIL_ADV_TRACE_FIFO_SIZE - ADV_TRACE_Ctx.TraceWrPtr);
      if ((Size >= freesize) && (ADV_TRACE_Ctx.TraceRdPtr > Size)) {
        ADV_TRACE_Ctx.unchunk_status = TRACE_UNCHUNK_DETECTED;
        ADV_TRACE_Ctx.unchunk_enabled = ADV_TRACE_Ctx.TraceWrPtr;
        freesize = ADV_TRACE_Ctx.TraceRdPtr;
      ...
      freesize =
          (uint16_t)(ADV_TRACE_Ctx.TraceRdPtr - ADV_TRACE_Ctx.TraceWrPtr);
    }
#else
    if (ADV_TRACE_Ctx.TraceWrPtr > ADV_TRACE_Ctx.TraceRdPtr) {
      freesize = UTIL_ADV_TRACE_FIFO_SIZE - ADV_TRACE_Ctx.TraceWrPtr +
                 ADV_TRACE_Ctx.TraceRdPtr;
    } else {
  ...
  if (freesize > Size) {
    *Pos = ADV_TRACE_Ctx.TraceWrPtr;
    ADV_TRACE_Ctx.TraceWrPtr =
        (ADV_TRACE_Ctx.TraceWrPtr + Size) % UTIL_ADV_TRACE_FIFO_SIZE;
    ret = 0;
#if defined(UTIL_ADV_TRACE_OVERRUN)
    if (ADV_TRACE_Ctx.OverRunStatus == TRACE_OVERRUN_EXECUTED) {
      /* clear the over run */
    ...
    UTIL_ADV_TRACE_DEBUG("\n--TRACE_AllocateBufer(%d-%d-%d::%d-%d)--\n",
                         freesize - Size, Size, ADV_TRACE_Ctx.unchunk_enabled,
                         ADV_TRACE_Ctx.TraceRdPtr, ADV_TRACE_Ctx.TraceWrPtr);
#else
    UTIL_ADV_TRACE_DEBUG("\n--TRACE_AllocateBufer(%d-%d::%d-%d)--\n",
                         freesize - Size, Size, ADV_TRACE_Ctx.TraceRdPtr,
                         ADV_TRACE_Ctx.TraceWrPtr);
#endif
  }
#if defined(UTIL_ADV_TRACE_OVERRUN)
