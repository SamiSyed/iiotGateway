                                                  ...
                                                  ...)
{
    ...
    buff_size = (uint16_t)
        UTIL_ADV_TRACE_VSNPRINTF((char *)sztmp, UTIL_ADV_TRACE_TMP_BUF_SIZE, strFormat, vaArgs);
...
UTIL_ADV_TRACE_Status_t UTIL_ADV_TRACE_FSend(const char *strFormat, ...)
{
    ...
    va_start(vaArgs, strFormat);
    uint16_t bufSize = (uint16_t)
        UTIL_ADV_TRACE_VSNPRINTF((char *)buf, UTIL_ADV_TRACE_TMP_BUF_SIZE, strFormat, vaArgs);
    va_end(vaArgs);
        ...
        if (ADV_TRACE_Ctx.TraceRdPtr != ADV_TRACE_Ctx.TraceWrPtr)
        {
            ...
            if (TRACE_UNCHUNK_DETECTED == ADV_TRACE_Ctx.unchunk_status)
            {
                ADV_TRACE_Ctx.TraceSentSize
                    = (uint16_t)(ADV_TRACE_Ctx.unchunk_enabled - ADV_TRACE_Ctx.TraceRdPtr);
...
static void TRACE_TxCpltCallback(void *Ptr)
{
    ...
    {
        ADV_TRACE_Ctx.TraceRdPtr
            = (ADV_TRACE_Ctx.TraceRdPtr + ADV_TRACE_Ctx.TraceSentSize) % UTIL_ADV_TRACE_FIFO_SIZE;
    }
#else
    ADV_TRACE_Ctx.TraceRdPtr
        = (ADV_TRACE_Ctx.TraceRdPtr + ADV_TRACE_Ctx.TraceSentSize) % UTIL_ADV_TRACE_FIFO_SIZE;
    ...
    if ((ADV_TRACE_Ctx.TraceRdPtr != ADV_TRACE_Ctx.TraceWrPtr) && (1u == ADV_TRACE_Ctx.TraceLock))
    {
        ...
        if (TRACE_UNCHUNK_DETECTED == ADV_TRACE_Ctx.unchunk_status)
        {
            ...
            if (0u == ADV_TRACE_Ctx.TraceSentSize)
            {
                /* this case occurs when an ongoing write aligned the Rd position with chunk
                 * position */
...
static int16_t TRACE_AllocateBufer(uint16_t Size, uint16_t *Pos)
{
    ...
    else
    {
        ...
        {
            freesize
                = UTIL_ADV_TRACE_FIFO_SIZE - ADV_TRACE_Ctx.TraceWrPtr + ADV_TRACE_Ctx.TraceRdPtr;
        }
        else
        {
