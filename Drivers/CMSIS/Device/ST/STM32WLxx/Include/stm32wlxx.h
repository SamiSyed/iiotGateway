...
#if !defined(STM32WL55xx) && !defined(STM32WL54xx) && !defined(STM32WLE5xx)                        \
...
#define __STM32WLxx_CMSIS_DEVICE_VERSION                                                           \
    ((__STM32WLxx_CMSIS_VERSION_MAIN << 24) | (__STM32WLxx_CMSIS_VERSION_SUB1 << 16)               \
     | (__STM32WLxx_CMSIS_VERSION_SUB2 << 8) | (__STM32WLxx_CMSIS_VERSION_RC))
...
#else
#error                                                                                             \
    "Please select first the target STM32WLxx device used in your application, for instance xxx (in stm32wlxx.h file)"
#endif /* STM32WL55xx ... */
