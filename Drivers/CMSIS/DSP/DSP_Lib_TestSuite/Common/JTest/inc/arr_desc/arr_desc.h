...
#define ARR_DESC_DEFINE(type, name, element_count, content)                                            \
    ...
    ARR_DESC_INTERNAL_DEFINE(name, &ARR_DESC_ARR_NAME(name), element_count, sizeof(type)) /* Note      \
                                                                                             the       \
                                                                                             lacking   \
                                                                                             semicolon \
                                                                                           */
...
#define ARR_DESC_MEMCMP(arr_desc_ptr_a, arr_desc_ptr_b, bytes)                                     \
    memcmp((arr_desc_ptr_a)->data_ptr, (arr_desc_ptr_b)->data_ptr, bytes) /* Note the lacking      \
                                                                             semicolon */
