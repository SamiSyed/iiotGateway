...
#define CFFT_FAMILY_DEFINE_TEST(fn_specifier,                                                      \
    ...
    {                                                                                              \
        ...
        TEMPLATE_DO_ARR_DESC(                                                                      \
            ...
            arm_cfft_##fn_specifier##_init_##type_suffix(&cfft_inst_fut,                           \
                                                         fftlen,                                   \
                                                         ifft_flag,                                \
                                                         (uint8_t)1);                              \
            arm_cfft_##fn_specifier##_init_##type_suffix(&cfft_inst_ref,                           \
                                                         fftlen,                                   \
                                                         ifft_flag,                                \
                                                         (uint8_t)1);                              \
                                                                                                   \
            ...
            JTEST_COUNT_CYCLES(                                                                    \
                arm_cfft_##fn_specifier##_##type_suffix(&cfft_inst_fut,                            \
