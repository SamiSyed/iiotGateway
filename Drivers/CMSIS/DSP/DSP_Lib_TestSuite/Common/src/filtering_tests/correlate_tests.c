...
#define CORRELATE_arm_correlate_fast_opt_INPUT_INTERFACE(input_a,                                  \
                                                         input_a_len,                              \
                                                         input_b,                                  \
                                                         input_b_len)                              \
    PAREN(input_a,                                                                                 \
...
#define CORRELATE_ref_correlate_fast_opt_INPUT_INTERFACE(input_a,                                  \
                                                         input_a_len,                              \
                                                         input_b,                                  \
                                                         input_b_len)                              \
    PAREN(input_a,                                                                                 \
...
#define CORRELATE_TEST_TEMPLATE(fut,                                                               \
                                fut_arg_interface,                                                 \
                                ref,                                                               \
                                ref_arg_interface,                                                 \
                                suffix,                                                            \
