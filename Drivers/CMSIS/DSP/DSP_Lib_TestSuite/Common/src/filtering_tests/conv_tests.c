...
#define CONV_arm_conv_partial_INPUT_INTERFACE(input_a,                                             \
                                              input_a_len,                                         \
                                              input_b,                                             \
                                              input_b_len,                                         \
                                              first_index,                                         \
...
#define CONV_ref_conv_partial_INPUT_INTERFACE(input_a,                                             \
                                              input_a_len,                                         \
                                              input_b,                                             \
                                              input_b_len,                                         \
                                              first_index,                                         \
...
#define CONV_arm_conv_partial_fast_INPUT_INTERFACE(input_a,                                        \
                                                   input_a_len,                                    \
                                                   input_b,                                        \
                                                   input_b_len,                                    \
                                                   first_index,                                    \
...
#define CONV_ref_conv_partial_fast_INPUT_INTERFACE(input_a,                                        \
                                                   input_a_len,                                    \
                                                   input_b,                                        \
                                                   input_b_len,                                    \
                                                   first_index,                                    \
...
#define CONV_arm_conv_partial_opt_INPUT_INTERFACE(input_a,                                         \
                                                  input_a_len,                                     \
                                                  input_b,                                         \
                                                  input_b_len,                                     \
                                                  first_index,                                     \
...
#define CONV_ref_conv_partial_opt_INPUT_INTERFACE(input_a,                                         \
                                                  input_a_len,                                     \
                                                  input_b,                                         \
                                                  input_b_len,                                     \
                                                  first_index,                                     \
...
#define CONV_arm_conv_partial_fast_opt_INPUT_INTERFACE(input_a,                                    \
                                                       input_a_len,                                \
                                                       input_b,                                    \
                                                       input_b_len,                                \
                                                       first_index,                                \
...
#define CONV_ref_conv_partial_fast_opt_INPUT_INTERFACE(input_a,                                    \
                                                       input_a_len,                                \
                                                       input_b,                                    \
                                                       input_b_len,                                \
                                                       first_index,                                \
...
#define CONV_PARTIAL_TEST_TEMPLATE(fut,                                                            \
                                   fut_arg_interface,                                              \
                                   ref,                                                            \
                                   ref_arg_interface,                                              \
                                   suffix,                                                         \
                        ...
                        if (CONV_TEST_VALID_PARTIAL_PARAMS(conv_len_a,                             \
                            ...
                            TEST_CALL_FUT_AND_REF(fut,                                             \
                                                  ...
                                                  ref_arg_interface(input_a_ptr,                   \
                                                                    ...
                                                                    num_points));                  \
                                                                                                   \
                            FILTERING_SNR_COMPARE_INTERFACE_OFFSET(first_index,                    \
                                                                   num_points,                     \
                                                                   output_type);                   \
                        } else {                                                                   \
