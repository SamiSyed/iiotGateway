...
#define __ARMv8MML_CMSIS_VERSION                                                                   \
    ((__ARMv8MML_CMSIS_VERSION_MAIN << 16U) | __ARMv8MML_CMSIS_VERSION_SUB) /*!< \deprecated CMSIS \
                                                                               HAL version number  \
                                                                             */
...
__STATIC_INLINE void __NVIC_SetPriorityGrouping(uint32_t PriorityGroup)
{
    ...
    reg_value &= ~((uint32_t)(SCB_AIRCR_VECTKEY_Msk | SCB_AIRCR_PRIGROUP_Msk)); /* clear bits to
                                                                                   change */
