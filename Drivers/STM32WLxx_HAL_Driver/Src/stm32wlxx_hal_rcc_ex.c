...
uint32_t HAL_RCCEx_GetPeriphCLKFreq(uint32_t PeriphClk) {
  ...
  case RCC_PERIPHCLK_RTC:
    ...
    case LL_RCC_RTC_CLKSOURCE_HSE_DIV32: /* HSE/32 clock used as RTC clock
                                            source */
  ...
  case RCC_PERIPHCLK_USART1:
    ...
    default:
      frequency = __LL_RCC_CALC_PCLK2_FREQ(
          __LL_RCC_CALC_HCLK1_FREQ(HAL_RCC_GetSysClockFreq(),
 ...
 * @note   Prior to enable the LSE Clock Security System, LSE oscillator has to
 * be enabled with HAL_RCC_OscConfig() and the LSE oscillator clock has to be
 * selected as RTC clock with HAL_RCCEx_PeriphCLKConfig().
 * @retval None
 */
void HAL_RCCEx_EnableLSECSS(void) { LL_RCC_LSE_EnableCSS(); }
 ...
 *         calibration LSE oscillator has to be enabled with @ref
 * HAL_RCC_OscConfig().
 * @retval None
 */
void HAL_RCCEx_EnableMSIPLLMode(void) { LL_RCC_MSI_EnablePLLMode(); }
 ...
 * @retval None
 */
void HAL_RCCEx_DisableMSIPLLMode(void) { LL_RCC_MSI_DisablePLLMode(); }
