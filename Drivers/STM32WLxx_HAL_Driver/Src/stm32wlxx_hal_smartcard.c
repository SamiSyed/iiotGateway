...
#define USART_CR2_FIELDS                                                                           \
    ((uint32_t)(USART_CR2_RTOEN | USART_CR2_CLK_FIELDS | USART_CR2_STOP)) /*!< USART CR2 fields of \
                                                                             parameters set by     \
                                                                             SMARTCARD_SetConfig   \
                                                                             API */
                                                   ...
                                                   HAL_SMARTCARD_CallbackIDTypeDef CallbackID)
{
    ...
    if (HAL_SMARTCARD_STATE_READY == hsmartcard->gState)
    {
        ...
        case HAL_SMARTCARD_ABORT_COMPLETE_CB_ID:
            hsmartcard->AbortCpltCallback = HAL_SMARTCARD_AbortCpltCallback; /* Legacy weak
                                                                                AbortCpltCallback */
            break;
        ...
        case HAL_SMARTCARD_ABORT_RECEIVE_COMPLETE_CB_ID:
            hsmartcard->AbortReceiveCpltCallback = HAL_SMARTCARD_AbortReceiveCpltCallback; /* Legacy
                                                                                              weak
        ...
        case HAL_SMARTCARD_MSPDEINIT_CB_ID:
            hsmartcard->MspDeInitCallback = HAL_SMARTCARD_MspDeInit; /* Legacy weak
                                                                        MspDeInitCallback */
            break;
...
{
    /* Disable RTOIE, EOBIE, RXNE, PE, RXFT, TXFT and  ERR (Frame error, noise error, overrun error)
     * interrupts */
    CLEAR_BIT(hsmartcard->Instance->CR1,
