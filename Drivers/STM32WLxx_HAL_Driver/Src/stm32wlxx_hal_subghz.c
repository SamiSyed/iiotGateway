/*******************************************************************************
 ...
 [..]
    ...
    (#) Initialize the SUBGHZ handle and SUBGHZSPI SPI registers by calling the @ref
HAL_SUBGHZ_Init(&hUserSubghz), configures also the low level Hardware (GPIO, CLOCK, NVIC...etc) by
calling the customized @ref HAL_SUBGHZ_MspInit() API.
 ...
 * __HAL_SUBGHZ_RESET_HANDLE_STATE_RF_READY to avoid the reset of Radio peripheral.
 * @retval HAL status
 */
...
@verbatim
 ...
 ===============================================================================
    ...
    This subsection provides a set of functions allowing to control the SUBGHZ.
     (+) HAL_SUBGHZ_GetState() API can be helpful to check in run-time the state of the SUBGHZ
peripheral
