...
#define TIM_GET_OR1_MASK(__INSTANCE__)                                         \
  (((__INSTANCE__) == TIM1)    ? (TIM1_OR1_ETR_ADC_RMP | TIM1_OR1_TI1_RMP)     \
   ...
   : ((__INSTANCE__) == TIM16) ? TIM16_OR1_TI1_RMP                             \
                               : TIM17_OR1_TI1_RMP)
/**
 * @}
 */
 ...
 * I/O
 *            @arg TIM_TIM1_ETR_ADC_AWD1:            TIM1_ETR is connected to
 * ADC AWD1
 *            @arg TIM_TIM1_ETR_ADC_AWD2:            TIM1_ETR is connected to
 * ADC AWD2
 *            @arg TIM_TIM1_ETR_ADC_AWD3:            TIM1_ETR is connected to
 * ADC AWD3
 *            @arg TIM_TIM1_ETR_COMP1:               TIM1_ETR is connected to
 * COMP1 output
 *            @arg TIM_TIM1_ETR_COMP2:               TIM1_ETR is connected to
 * COMP2 output field2 can have the following values:
 ...
 * MSI
 *            @arg TIM_TIM17_TI1_HSE:               TIM17 TI1 is connected to
 * HSE div 32
...
HAL_StatusTypeDef HAL_TIMEx_RemapConfig(TIM_HandleTypeDef *htim,
  ...
  MODIFY_REG(tmpor, TIM_GET_OR1_MASK(htim->Instance),
