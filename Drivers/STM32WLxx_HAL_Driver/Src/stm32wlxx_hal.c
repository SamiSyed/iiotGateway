...
#define __STM32WLxx_HAL_VERSION                                                                    \
    ((__STM32WLxx_HAL_VERSION_MAIN << 24U) | (__STM32WLxx_HAL_VERSION_SUB1 << 16U)                 \
...
HAL_StatusTypeDef HAL_RADIO_Init(void)
{
    ...
    gpio_init_structure.Pin
        = (RADIO_SWITCH_CTRL1_PIN | RADIO_SWITCH_CTRL2_PIN | RADIO_SWITCH_CTRL3_PIN);
    ...
    status = HAL_GPIO_LockPin(
        RADIO_SWITCH_CTRL_GPIO_PORT,
        (RADIO_SWITCH_CTRL1_PIN | RADIO_SWITCH_CTRL2_PIN | RADIO_SWITCH_CTRL3_PIN));
    if (status == HAL_OK)
    {
...
HAL_StatusTypeDef HAL_RADIO_SetSwitchConfig(HAL_RADIO_SwitchConfig_TypeDef Config)
{
    ...
    case RADIO_SWITCH_RFO_LP:
    {
        ...
        HAL_GPIO_WriteMultipleStatePin(RADIO_SWITCH_CTRL_GPIO_PORT,
                                       RADIO_SWITCH_CTRL2_PIN,
