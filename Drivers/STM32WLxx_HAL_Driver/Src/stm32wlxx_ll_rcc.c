...
ErrorStatus LL_RCC_DeInit(void)
{
    ...
    /* Reset CFGR register */
    LL_RCC_WriteReg(CFGR, 0x00070000U); /* MSI selected as System Clock and all prescaler to not
                                           divided */
 ...
 *         - @ref  LL_RCC_PERIPH_FREQUENCY_NO indicates that oscillator (MSI) or PLLs (PLL) is not
 * ready
 */
 ...
 *         - @ref  LL_RCC_PERIPH_FREQUENCY_NO indicates that oscillator (HSI) or PLLs (PLL) is not
 * ready
 */
...
static uint32_t RCC_PLL_GetFreqDomain_RNG(void)
{
    ...
    return __LL_RCC_CALC_PLLCLK_RNG_FREQ(pllinputfreq,
                                         LL_RCC_PLL_GetDivider(),
                                         LL_RCC_PLL_GetN(),
                                         LL_RCC_PLL_GetQ());
}
...
static uint32_t RCC_PLL_GetFreqDomain_I2S(void)
{
    ...
    return __LL_RCC_CALC_PLLCLK_I2S2_FREQ(pllinputfreq,
                                          LL_RCC_PLL_GetDivider(),
                                          LL_RCC_PLL_GetN(),
                                          LL_RCC_PLL_GetQ());
}
