...
#endif
        /* Clearing flags after the Callback because the content of RTC_TSTR and RTC_TSDR are
         * cleared when TSF bit is reset.*/
        WRITE_REG(RTC->SCR, RTC_SCR_CITSF | RTC_SCR_CTSF);
    }
...
HAL_StatusTypeDef HAL_RTCEx_SetTamper(RTC_HandleTypeDef *hrtc, RTC_TamperTypeDef *sTamper)
{
    ...
    tmpreg
        &= ~((sTamper->Tamper << TAMP_CR2_TAMP1TRG_Pos) | (sTamper->Tamper << TAMP_CR2_TAMP1MSK_Pos)
                                              ...
                                              RTC_InternalTamperTypeDef *sIntTamper)
{
    ...
    {
        /* Control register 3 */
        SET_BIT(TAMP->CR3, (sIntTamper->IntTamper >> 16U)); /* Shift of 16 bit to manage ITAMP on
                                                               MSB part of CR3 */
    }
