/**
 ...
 FLASH memory of all STM32WLxx devices.
...
void HAL_FLASH_IRQHandler(void) {
  ...
  if ((pFlash.ProcedureOnGoing &
    ...
    param = pFlash.Address;
              ...
              (FLASH_TYPEERASE_MASSERASE | FLASH_TYPEERASE_PAGES)) != 0U) {
...
HAL_StatusTypeDef HAL_FLASH_Lock(void) {
  ...
  /* @Note  The lock and unlock procedure is done only using CR registers even
   * from CPU2 */
 ...
 *            @arg @ref HAL_FLASH_ERROR_MIS FLASH Fast programming data miss
 * error
