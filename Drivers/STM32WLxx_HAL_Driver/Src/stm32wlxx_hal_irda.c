...
/**
 * @note   When IRDA parity is not enabled (PCE = 0), and Word Length is configured to 9 bits (M1-M0
 * = 01), address of user data buffer containing data to be sent, should be aligned on a half word
 * frontier (16 bits) (as sent data will be handled using u16 pointer cast). Depending on
...
/**
 * @note   When IRDA parity is not enabled (PCE = 0), and Word Length is configured to 9 bits (M1-M0
 * = 01), address of user data buffer for storing data to be received, should be aligned on a half
 * word frontier (16 bits) (as received data will be handled using u16 pointer cast). Depending on
 * compilation chain, use of specific alignment compilation directives or pragmas might be required
 * to ensure proper alignment for pData.
 */
#endif /* CORE_CM0PLUS */
 ...
 * @note   When IRDA parity is not enabled (PCE = 0), and Word Length is configured to 9 bits (M1-M0
 * = 01), address of user data buffer containing data to be sent, should be aligned on a half word
 * frontier (16 bits) (as sent data will be handled by DMA from halfword frontier). Depending on
 * compilation chain, use of specific alignment compilation directives or pragmas might be required
 * to ensure proper alignment for pData.
 */
#endif /* CORE_CM0PLUS */
 ...
 * @note   When IRDA parity is not enabled (PCE = 0), and Word Length is configured to 9 bits (M1-M0
 * = 01), address of user data buffer for storing data to be received, should be aligned on a half
 * word frontier (16 bits) (as received data will be handled by DMA from halfword frontier).
...
static HAL_StatusTypeDef IRDA_SetConfig(IRDA_HandleTypeDef *hirda)
{
    ...
    static const uint16_t IRDAPrescTable[12]
    ...
    case IRDA_CLOCKSOURCE_PCLK1:
        ...
        tmpreg = (uint32_t)(IRDA_DIV_SAMPLING16(pclk,
                                                hirda->Init.BaudRate,
