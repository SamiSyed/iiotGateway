/**
  ...
  ******************************************************************************
  ...
  default weak (surcharged) function. HAL_IRDA_UnRegisterCallback() takes as
  ...
  (surcharged) functions: examples HAL_IRDA_TxCpltCallback(),
  ...
  functions in the HAL_IRDA_Init() and HAL_IRDA_DeInit() only when these
  callbacks are null (not registered beforehand). If not, MspInit or MspDeInit
  are not null, the HAL_IRDA_Init() and HAL_IRDA_DeInit() keep and use the user
...
/**
 * @note   When IRDA parity is not enabled (PCE = 0), and Word Length is
