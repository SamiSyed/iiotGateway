...
#endif /* USE_HAL_CRYP_REGISTER_CALLBACKS */
{
    ...
    FunctionalState AutoKeyDerivation; /*!< Used only in TinyAES to allow to bypass or not key
                                       write-up before decryption.
    ...
    void (*InCpltCallback)(struct __CRYP_HandleTypeDef *hcryp);  /*!< CRYP Input FIFO transfer
                                                                    completed callback  */
    void (*OutCpltCallback)(struct __CRYP_HandleTypeDef *hcryp); /*!< CRYP Output FIFO transfer
                                                                    completed callback */
    ...
    __IO HAL_CRYP_STATETypeDef State_saved; /*!< copy of CRYP peripheral state when processing is
                                               suspended */
...
#define CRYP_AES_GCM_GMAC                                                                          \
    (AES_CR_CHMOD_0 | AES_CR_CHMOD_1) /*!< Galois counter mode - Galois message authentication     \
                                         code */
