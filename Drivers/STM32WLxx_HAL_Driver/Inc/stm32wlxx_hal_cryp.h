...
#endif /* USE_HAL_CRYP_REGISTER_CALLBACKS */
{
  ...
  FunctionalState
      AutoKeyDerivation; /*!< Used only in TinyAES to allow to bypass or not key
                         write-up before decryption. This parameter can be a
  ...
  FunctionalState AutoKeyDerivation_saved; /*!< copy of CRYP handle auto key
 ...
 *            @arg CRYP_FLAG_BUSY: The CRYP core is currently processing a block
 * of data or a key preparation (for AES decryption).
...
#define IS_CRYP_INIT(CONFIG)                                                   \
  (((CONFIG) == CRYP_KEYIVCONFIG_ALWAYS) ||                                    \
   ((CONFIG) == CRYP_KEYIVCONFIG_ONCE) || ((CONFIG) == CRYP_IVCONFIG_ONCE))
