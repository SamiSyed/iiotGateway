...
#define HAL_SYSCFG_GRP1_RTCSTAMP_RTCTAMP_LSECSS                                                    \
    (LL_C2_SYSCFG_GRP1_RTCSTAMP_RTCTAMP_LSECSS | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of        \
                                                                              interrupt from RTC   \
                                                                              TimeStamp, RTC       \
                                                                              Tampers and LSE                                                                                           \
                                                                              Clock Security       \
...
#define HAL_SYSCFG_GRP1_RTCALARM                                                                   \
    (LL_C2_SYSCFG_GRP1_RTCALARM | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from RTC    \
                                                               Alarms to CPU2                 */
#define HAL_SYSCFG_GRP1_RTCSSRU                                                                    \
    (LL_C2_SYSCFG_GRP1_RTCSSRU | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from RTC     \
                                                              SSRU to CPU2                   */
#define HAL_SYSCFG_GRP1_RTCWKUP                                                                    \
    (LL_C2_SYSCFG_GRP1_RTCWKUP | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from RTC     \
                                                              Wakeup to CPU2                 */
#define HAL_SYSCFG_GRP1_RCC                                                                        \
    (LL_C2_SYSCFG_GRP1_RCC | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from RCC to CPU2 \
                                                        */
#define HAL_SYSCFG_GRP1_FLASH                                                                      \
    (LL_C2_SYSCFG_GRP1_FLASH | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from FLASH to  \
                                                            CPU2                      */
#define HAL_SYSCFG_GRP1_PKA                                                                        \
    (LL_C2_SYSCFG_GRP1_PKA | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from PKA to CPU2 \
                                                        */
#define HAL_SYSCFG_GRP1_AES                                                                        \
    (LL_C2_SYSCFG_GRP1_AES | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from AES to CPU2 \
                                                        */
#define HAL_SYSCFG_GRP1_COMP                                                                       \
    (LL_C2_SYSCFG_GRP1_COMP | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from Comparator \
                                                           to CPU2                 */
#define HAL_SYSCFG_GRP1_ADC                                                                        \
    (LL_C2_SYSCFG_GRP1_ADC | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from Analog      \
                                                          Digital Converter to CPU2   */
#define HAL_SYSCFG_GRP1_DAC                                                                        \
    (LL_C2_SYSCFG_GRP1_DAC | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from Digital     \
                                                          Analog Converter to CPU2   */

#define HAL_SYSCFG_GRP1_EXTI0                                                                      \
    (LL_C2_SYSCFG_GRP1_EXTI0 | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External  \
                                                            Interrupt Line 0 to CPU2  */
#define HAL_SYSCFG_GRP1_EXTI1                                                                      \
    (LL_C2_SYSCFG_GRP1_EXTI1 | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External  \
                                                            Interrupt Line 1 to CPU2  */
#define HAL_SYSCFG_GRP1_EXTI2                                                                      \
    (LL_C2_SYSCFG_GRP1_EXTI2 | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External  \
                                                            Interrupt Line 2 to CPU2  */
#define HAL_SYSCFG_GRP1_EXTI3                                                                      \
    (LL_C2_SYSCFG_GRP1_EXTI3 | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External  \
                                                            Interrupt Line 3 to CPU2  */
#define HAL_SYSCFG_GRP1_EXTI4                                                                      \
    (LL_C2_SYSCFG_GRP1_EXTI4 | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External  \
                                                            Interrupt Line 4 to CPU2  */
#define HAL_SYSCFG_GRP1_EXTI5                                                                      \
    (LL_C2_SYSCFG_GRP1_EXTI5 | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External  \
                                                            Interrupt Line 5 to CPU2  */
#define HAL_SYSCFG_GRP1_EXTI6                                                                      \
    (LL_C2_SYSCFG_GRP1_EXTI6 | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External  \
                                                            Interrupt Line 6 to CPU2  */
#define HAL_SYSCFG_GRP1_EXTI7                                                                      \
    (LL_C2_SYSCFG_GRP1_EXTI7 | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External  \
                                                            Interrupt Line 7 to CPU2  */
#define HAL_SYSCFG_GRP1_EXTI8                                                                      \
    (LL_C2_SYSCFG_GRP1_EXTI8 | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External  \
                                                            Interrupt Line 8 to CPU2  */
#define HAL_SYSCFG_GRP1_EXTI9                                                                      \
    (LL_C2_SYSCFG_GRP1_EXTI9 | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External  \
                                                            Interrupt Line 9 to CPU2  */
#define HAL_SYSCFG_GRP1_EXTI10                                                                     \
    (LL_C2_SYSCFG_GRP1_EXTI10 | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External \
                                                             Interrupt Line 10 to CPU2 */
#define HAL_SYSCFG_GRP1_EXTI11                                                                     \
    (LL_C2_SYSCFG_GRP1_EXTI11 | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External \
                                                             Interrupt Line 11 to CPU2 */
#define HAL_SYSCFG_GRP1_EXTI12                                                                     \
    (LL_C2_SYSCFG_GRP1_EXTI12 | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External \
                                                             Interrupt Line 12 to CPU2 */
#define HAL_SYSCFG_GRP1_EXTI13                                                                     \
    (LL_C2_SYSCFG_GRP1_EXTI13 | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External \
                                                             Interrupt Line 13 to CPU2 */
#define HAL_SYSCFG_GRP1_EXTI14                                                                     \
    (LL_C2_SYSCFG_GRP1_EXTI14 | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External \
                                                             Interrupt Line 14 to CPU2 */
#define HAL_SYSCFG_GRP1_EXTI15                                                                     \
    (LL_C2_SYSCFG_GRP1_EXTI15 | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External \
...
#define HAL_SYSCFG_GRP1_RTCSTAMPTAMPLSECSS                                                         \
    (LL_SYSCFG_GRP1_RTCSTAMPTAMPLSECSS | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from \
                                                                      RTCSTAMPTAMPLSECSS to CPU1   \
                                                                    */
#define HAL_SYSCFG_GRP1_RTCSSRU                                                                    \
    (LL_SYSCFG_GRP1_RTCSSRU | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from RTC SSRU   \
                                                           to CPU1                   */
#define HAL_SYSCFG_GRP1_EXTI5                                                                      \
    (LL_SYSCFG_GRP1_EXTI5 | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External     \
                                                         Interrupt Line 5 to CPU1  */
#define HAL_SYSCFG_GRP1_EXTI6                                                                      \
    (LL_SYSCFG_GRP1_EXTI6 | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External     \
                                                         Interrupt Line 6 to CPU1  */
#define HAL_SYSCFG_GRP1_EXTI7                                                                      \
    (LL_SYSCFG_GRP1_EXTI7 | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External     \
                                                         Interrupt Line 7 to CPU1  */
#define HAL_SYSCFG_GRP1_EXTI8                                                                      \
    (LL_SYSCFG_GRP1_EXTI8 | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External     \
                                                         Interrupt Line 8 to CPU1  */
#define HAL_SYSCFG_GRP1_EXTI9                                                                      \
    (LL_SYSCFG_GRP1_EXTI9 | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External     \
                                                         Interrupt Line 9 to CPU1  */
#define HAL_SYSCFG_GRP1_EXTI10                                                                     \
    (LL_SYSCFG_GRP1_EXTI10 | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External    \
                                                          Interrupt Line 10 to CPU1 */
#define HAL_SYSCFG_GRP1_EXTI11                                                                     \
    (LL_SYSCFG_GRP1_EXTI11 | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External    \
                                                          Interrupt Line 11 to CPU1 */
#define HAL_SYSCFG_GRP1_EXTI12                                                                     \
    (LL_SYSCFG_GRP1_EXTI12 | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External    \
                                                          Interrupt Line 12 to CPU1 */
#define HAL_SYSCFG_GRP1_EXTI13                                                                     \
    (LL_SYSCFG_GRP1_EXTI13 | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External    \
                                                          Interrupt Line 13 to CPU1 */
#define HAL_SYSCFG_GRP1_EXTI14                                                                     \
    (LL_SYSCFG_GRP1_EXTI14 | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External    \
                                                          Interrupt Line 14 to CPU1 */
#define HAL_SYSCFG_GRP1_EXTI15                                                                     \
    (LL_SYSCFG_GRP1_EXTI15 | HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External    \
...
#define HAL_SYSCFG_GRP2_DMA1CH1                                                                    \
    (LL_C2_SYSCFG_GRP2_DMA1CH1 | HAL_SYSCFG_GRP2_RESERVED) /*!< Enabling of interrupt from DMA1    \
                                                              Channel 1 to CPU2             */
#define HAL_SYSCFG_GRP2_DMA1CH2                                                                    \
    (LL_C2_SYSCFG_GRP2_DMA1CH2 | HAL_SYSCFG_GRP2_RESERVED) /*!< Enabling of interrupt from DMA1    \
                                                              Channel 2 to CPU2             */
#define HAL_SYSCFG_GRP2_DMA1CH3                                                                    \
    (LL_C2_SYSCFG_GRP2_DMA1CH3 | HAL_SYSCFG_GRP2_RESERVED) /*!< Enabling of interrupt from DMA1    \
                                                              Channel 3 to CPU2             */
#define HAL_SYSCFG_GRP2_DMA1CH4                                                                    \
    (LL_C2_SYSCFG_GRP2_DMA1CH4 | HAL_SYSCFG_GRP2_RESERVED) /*!< Enabling of interrupt from DMA1    \
                                                              Channel 4 to CPU2             */
#define HAL_SYSCFG_GRP2_DMA1CH5                                                                    \
    (LL_C2_SYSCFG_GRP2_DMA1CH5 | HAL_SYSCFG_GRP2_RESERVED) /*!< Enabling of interrupt from DMA1    \
                                                              Channel 5 to CPU2             */
#define HAL_SYSCFG_GRP2_DMA1CH6                                                                    \
    (LL_C2_SYSCFG_GRP2_DMA1CH6 | HAL_SYSCFG_GRP2_RESERVED) /*!< Enabling of interrupt from DMA1    \
                                                              Channel 6 to CPU2             */
#define HAL_SYSCFG_GRP2_DMA1CH7                                                                    \
    (LL_C2_SYSCFG_GRP2_DMA1CH7 | HAL_SYSCFG_GRP2_RESERVED) /*!< Enabling of interrupt from DMA1    \
                                                              Channel 7 to CPU2             */

#define HAL_SYSCFG_GRP2_DMA2CH1                                                                    \
    (LL_C2_SYSCFG_GRP2_DMA2CH1 | HAL_SYSCFG_GRP2_RESERVED) /*!< Enabling of interrupt from DMA2    \
                                                              Channel 1 to CPU2             */
#define HAL_SYSCFG_GRP2_DMA2CH2                                                                    \
    (LL_C2_SYSCFG_GRP2_DMA2CH2 | HAL_SYSCFG_GRP2_RESERVED) /*!< Enabling of interrupt from DMA2    \
                                                              Channel 2 to CPU2             */
#define HAL_SYSCFG_GRP2_DMA2CH3                                                                    \
    (LL_C2_SYSCFG_GRP2_DMA2CH3 | HAL_SYSCFG_GRP2_RESERVED) /*!< Enabling of interrupt from DMA2    \
                                                              Channel 3 to CPU2             */
#define HAL_SYSCFG_GRP2_DMA2CH4                                                                    \
    (LL_C2_SYSCFG_GRP2_DMA2CH4 | HAL_SYSCFG_GRP2_RESERVED) /*!< Enabling of interrupt from DMA2    \
                                                              Channel 4 to CPU2             */
#define HAL_SYSCFG_GRP2_DMA2CH5                                                                    \
    (LL_C2_SYSCFG_GRP2_DMA2CH5 | HAL_SYSCFG_GRP2_RESERVED) /*!< Enabling of interrupt from DMA2    \
                                                              Channel 5 to CPU2             */
#define HAL_SYSCFG_GRP2_DMA2CH6                                                                    \
    (LL_C2_SYSCFG_GRP2_DMA2CH6 | HAL_SYSCFG_GRP2_RESERVED) /*!< Enabling of interrupt from DMA2    \
                                                              Channel 6 to CPU2             */
#define HAL_SYSCFG_GRP2_DMA2CH7                                                                    \
    (LL_C2_SYSCFG_GRP2_DMA2CH7 | HAL_SYSCFG_GRP2_RESERVED) /*!< Enabling of interrupt from DMA2    \
                                                              Channel 7 to CPU2             */

#define HAL_SYSCFG_GRP2_DMAMUX1                                                                    \
    (LL_C2_SYSCFG_GRP2_DMAMUX1 | HAL_SYSCFG_GRP2_RESERVED) /*!< Enabling of interrupt from DMAMUX1 \
                                                              to CPU2                    */

#define HAL_SYSCFG_GRP2_PVM3                                                                       \
    (LL_C2_SYSCFG_GRP2_PVM3 | HAL_SYSCFG_GRP2_RESERVED) /*!< Enabling of interrupt from Power      \
                                                           Voltage Monitoring 3 to CPU2 */
#define HAL_SYSCFG_GRP2_PVD                                                                        \
    (LL_C2_SYSCFG_GRP2_PVD | HAL_SYSCFG_GRP2_RESERVED) /*!< Enabling of interrupt from Power       \
                                                          Voltage Detector to CPU2     */
 ...
 */
#define HAL_SYSCFG_GRP2_PVM3                                                                       \
    (LL_SYSCFG_GRP2_PVM3 | HAL_SYSCFG_GRP2_RESERVED) /*!< Enabling of interrupt from Power Voltage \
                                                        Monitoring 3 to CPU1 */
#define HAL_SYSCFG_GRP2_PVD                                                                        \
    (LL_SYSCFG_GRP2_PVD | HAL_SYSCFG_GRP2_RESERVED) /*!< Enabling of interrupt from Power Voltage  \
                                                       Detector to CPU1     */
...
#define __HAL_SYSCFG_GET_FLAG(__FLAG__)                                                            \
    ((((((__FLAG__) == SYSCFG_FLAG_SRAM2_PE) ? SYSCFG->CFGR2 : SYSCFG->SCSR) & (__FLAG__)) != 0)   \
         ? 1                                                                                       \
         : 0)
