...
#define IS_RCC_HSE(__HSE__)                                                                        \
    (((__HSE__) == RCC_HSE_OFF) || ((__HSE__) == RCC_HSE_ON) || ((__HSE__) == RCC_HSE_BYPASS_PWR))
...
typedef struct
{
    ...
    uint32_t PLLR; /*!< PLLR: Division for the main system clock.
                        User has to set the PLLR parameter correctly to not exceed max frequency 48
                      MHZ. This parameter must be a value of @ref RCC_PLLR_Clock_Divider */
...
#endif                       /* DUAL_CORE */
    uint32_t AHBCLK3Divider; /*!< The AHB shared clock (HCLK3) divider. This clock is derived from
...
#define RCC_HSE_BYPASS_PWR                                                                         \
    ((uint32_t)(RCC_CR_HSEBYPPWR | RCC_CR_HSEON)) /*!< TCXO external clock source for HSE clock */
/**
 * @}
 */
...
#define RCC_LSE_ON                                                                                 \
    ((uint32_t)(RCC_BDCR_LSESYSEN | RCC_BDCR_LSEON)) /*!< LSE clock activation for RTC and other   \
                                                        peripherals */
#define RCC_LSE_BYPASS_RTC_ONLY                                                                    \
    ((uint32_t)(RCC_BDCR_LSEBYP | RCC_BDCR_LSEON)) /*!< External clock source for LSE clock */
#define RCC_LSE_BYPASS                                                                             \
    ((uint32_t)(RCC_BDCR_LSEBYP | RCC_BDCR_LSESYSEN | RCC_BDCR_LSEON)) /*!< External clock source  \
                                                                          for LSE clock */
...
#define RCC_FLAG_MSIRDY                                                                            \
    ((CR_REG_INDEX << REG_INDEX_POS) | RCC_CR_MSIRDY_Pos) /*!< MSI Ready flag */
#define RCC_FLAG_HSIRDY                                                                            \
    ((CR_REG_INDEX << REG_INDEX_POS) | RCC_CR_HSIRDY_Pos) /*!< HSI Ready flag */
#define RCC_FLAG_HSIKERDY                                                                          \
    ((CR_REG_INDEX << REG_INDEX_POS) | RCC_CR_HSIKERDY_Pos) /*!< HSI Ready flag */
#define RCC_FLAG_HSERDY                                                                            \
    ((CR_REG_INDEX << REG_INDEX_POS) | RCC_CR_HSERDY_Pos) /*!< HSE Ready flag */
#define RCC_FLAG_PLLRDY                                                                            \
    ((CR_REG_INDEX << REG_INDEX_POS) | RCC_CR_PLLRDY_Pos) /*!< PLL Ready flag */

/* Flags in the BDCR register */
#define RCC_FLAG_LSERDY                                                                            \
    ((BDCR_REG_INDEX << REG_INDEX_POS) | RCC_BDCR_LSERDY_Pos) /*!< LSE Ready flag */
#define RCC_FLAG_LSECSSD                                                                           \
    ((BDCR_REG_INDEX << REG_INDEX_POS) | RCC_BDCR_LSECSSD_Pos) /*!< LSE Clock Security System      \
                                                                  failure detection flag */
#define RCC_FLAG_LSESYSRDY                                                                         \
    ((BDCR_REG_INDEX << REG_INDEX_POS) | RCC_BDCR_LSESYSRDY_Pos) /*!< LSE system clock ready flag  \
                                                                  */

/* Flags in the CSR register */
#define RCC_FLAG_LSIRDY                                                                            \
    ((CSR_REG_INDEX << REG_INDEX_POS) | RCC_CSR_LSIRDY_Pos) /*!< LSI Ready flag */
#define RCC_FLAG_RFRST                                                                             \
    ((CSR_REG_INDEX << REG_INDEX_POS) | RCC_CSR_RFRSTF_Pos) /*!< Sub-GHz radio reset flag */
#define RCC_FLAG_RFILARSTF                                                                         \
    ((CSR_REG_INDEX << REG_INDEX_POS) | RCC_CSR_RFILARSTF_Pos) /*!< Sub-GHz radio illegal command  \
                                                                  flag               */
#define RCC_FLAG_OBLRST                                                                            \
    ((CSR_REG_INDEX << REG_INDEX_POS)                                                              \
     | RCC_CSR_OBLRSTF_Pos) /*!< Option Byte Loader reset flag                    */
#define RCC_FLAG_PINRST                                                                            \
    ((CSR_REG_INDEX << REG_INDEX_POS) | RCC_CSR_PINRSTF_Pos) /*!< Pin reset flag (NRST pin) */
#define RCC_FLAG_BORRST                                                                            \
    ((CSR_REG_INDEX << REG_INDEX_POS) | RCC_CSR_BORRSTF_Pos) /*!< BOR reset flag */
#define RCC_FLAG_SFTRST                                                                            \
    ((CSR_REG_INDEX << REG_INDEX_POS) | RCC_CSR_SFTRSTF_Pos) /*!< Software Reset flag */
#define RCC_FLAG_IWDGRST                                                                           \
    ((CSR_REG_INDEX << REG_INDEX_POS) | RCC_CSR_IWDGRSTF_Pos) /*!< Watchdog reset flag */
#define RCC_FLAG_WWDGRST                                                                           \
    ((CSR_REG_INDEX << REG_INDEX_POS) | RCC_CSR_WWDGRSTF_Pos) /*!< Window watchdog reset flag */
#define RCC_FLAG_LPWRRST                                                                           \
    ((CSR_REG_INDEX << REG_INDEX_POS) | RCC_CSR_LPWRRSTF_Pos) /*!< Low-Power reset flag */
/**
 * @}
 */
...
/** @defgroup RCC_APB3_Clock_Sleep_Enable_Disable_Status APB3 Peripheral Clock Sleep Enabled or
 * Disabled Status
 ...
 *            @arg @ref RCC_HSE_BYPASS_PWR  HSE32 driven from an external TCXO powered by the
 * PB0-VDDTCXO pin.
 * @retval None
 */
...
/**
 * @brief  Enable or disable each clock output (RCC_PLL_SYSCLK, RCC_PLL_I2S2CLK, RCC_PLL_RNGCLK,
 * RCC_PLL_ADCCLK)
 * @note   Enabling/disabling clock outputs RCC_PLL_I2S2CLK, RCC_PLL_RNGCLK and RCC_PLL_ADCCLK can
 * be done at anytime without the need to stop the PLL in order to save power. But RCC_PLL_SYSCLK
...
/**
 * @brief  Get clock output enable status (RCC_PLL_SYSCLK, RCC_PLL_I2S2CLK, RCC_PLL_RNGCLK,
 * RCC_PLL_ADCCLK)
 ...
 *            @arg @ref RCC_FLAG_LSECSSD    Clock security system failure on LSE oscillator
 * detection
