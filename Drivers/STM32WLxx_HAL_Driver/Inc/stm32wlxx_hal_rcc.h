...
#define RCC_LSE_TIMEOUT_VALUE                                                  \
  LSE_STARTUP_TIMEOUT         /*!< LSE timeout in ms        */
...
#define IS_RCC_HSEDIV(__HSEDIV__)                                              \
  (((__HSEDIV__) == RCC_HSE_DIV1) || ((__HSEDIV__) == RCC_HSE_DIV2))
  ...
  ((1U <= (__CLK__)) &&                                                        \
   ((__CLK__) <=                                                               \
    (RCC_CLOCKTYPE_SYSCLK | RCC_CLOCKTYPE_HCLK | RCC_CLOCKTYPE_PCLK1 |         \
     RCC_CLOCKTYPE_PCLK2 | RCC_CLOCKTYPE_HCLK2 | RCC_CLOCKTYPE_HCLK3)))
#else
#define IS_RCC_CLOCKTYPE(__CLK__)                                              \
  ((1U <= (__CLK__)) &&                                                        \
   ((__CLK__) <=                                                               \
...
typedef struct {
  ...
  uint32_t PLLN; /*!< PLLN: Multiplication factor for PLL VCO output clock.
                      This parameter must be a number between Min_Data = 6 and
                    Max_Data = 127               */
  ...
  uint32_t
      PLLR; /*!< PLLR: Division for the main system clock.
                 User has to set the PLLR parameter correctly to not exceed max
               frequency 48 MHZ. This parameter must be a value of @ref
...
typedef struct {
  ...
  uint32_t HSICalibrationValue; /*!< The calibration trimming value (default is
                                   @ref RCC_HSICALIBRATION_DEFAULT). This
  ...
  uint32_t MSICalibrationValue; /*!< The calibration trimming value (default is
                                   @ref RCC_MSICALIBRATION_DEFAULT). This
                                   parameter must be a number between Min_Data =
...
typedef struct {
  ...
  uint32_t AHBCLKDivider; /*!< The AHBx clock (HCLK1) divider. This clock is
  ...
  uint32_t
      APB1CLKDivider; /*!< The APB1 clock (PCLK1) divider. This clock is derived
                         ...
                         value of @ref RCC_APBx_Clock_Source                */
...
#if defined(DUAL_CORE)
  uint32_t AHBCLK2Divider; /*!< The AHB clock (HCLK2) divider. This clock is
                              derived from the system clock (SYSCLK). This
                              parameter can be a value of @ref
                              RCC_AHBx_Clock_Source                */

#endif                     /* DUAL_CORE */
  uint32_t AHBCLK3Divider; /*!< The AHB shared clock (HCLK3) divider. This clock
                              is derived from the system clock (SYSCLK). This
                              parameter can be a value of @ref
                              RCC_AHBx_Clock_Source                */
...
#define RCC_OSCILLATORTYPE_HSE                                                 \
  0x00000001U /*!< HSE to configure                    */
#define RCC_OSCILLATORTYPE_HSI                                                 \
  0x00000002U /*!< HSI to configure                    */
#define RCC_OSCILLATORTYPE_LSE                                                 \
  0x00000004U /*!< LSE to configure                    */
#define RCC_OSCILLATORTYPE_LSI                                                 \
  0x00000008U /*!< LSI to configure                    */
#define RCC_OSCILLATORTYPE_MSI                                                 \
  0x00000020U /*!< MSI to configure                    */
/**
 * @}
 */
 ...
 */
#define RCC_HSE_OFF                                                            \
  0x00000000U /*!< HSE clock deactivation                    */
#define RCC_HSE_ON                                                             \
  RCC_CR_HSEON /*!< HSE clock activation                      */
#define RCC_HSE_BYPASS_PWR                                                     \
  ((uint32_t)(RCC_CR_HSEBYPPWR |                                               \
              RCC_CR_HSEON)) /*!< TCXO external clock source for HSE clock  */
/**
 * @}
 */
 ...
 */
#define RCC_LSE_OFF                                                            \
  0U /*!< LSE clock deactivation                             */
#define RCC_LSE_ON_RTC_ONLY                                                    \
  RCC_BDCR_LSEON /*!< LSE clock activation for RTC only                  */
#define RCC_LSE_ON                                                             \
  ((uint32_t)(RCC_BDCR_LSESYSEN |                                              \
              RCC_BDCR_LSEON)) /*!< LSE clock activation for RTC and other     \
                                  peripherals */
#define RCC_LSE_BYPASS_RTC_ONLY                                                \
  ((uint32_t)(RCC_BDCR_LSEBYP |                                                \
              RCC_BDCR_LSEON)) /*!< External clock source for LSE clock */
#define RCC_LSE_BYPASS                                                         \
  ((uint32_t)(RCC_BDCR_LSEBYP | RCC_BDCR_LSESYSEN |                            \
              RCC_BDCR_LSEON)) /*!< External clock source for LSE clock */
...
#define RCC_PLL_SYSCLK                                                         \
  RCC_PLLCFGR_PLLREN /*!< PLLCLK selected from main PLL     */
#define RCC_PLL_I2S2CLK                                                        \
  RCC_PLLCFGR_PLLQEN /*!< PLLI2S2CLK selected from main PLL */
#define RCC_PLL_RNGCLK                                                         \
  RCC_PLLCFGR_PLLQEN /*!< PLLRNGCLK selected from main PLL  */
#define RCC_PLL_ADCCLK                                                         \
  RCC_PLLCFGR_PLLPEN /*!< PLLADCCLK selected from main PLL  */
/**
 * @}
 */
...
#define RCC_SYSCLKSOURCE_MSI                                                   \
  LL_RCC_SYS_CLKSOURCE_MSI /*!< MSI selected as system clock */
#define RCC_SYSCLKSOURCE_HSI                                                   \
  LL_RCC_SYS_CLKSOURCE_HSI /*!< HSI selected as system clock */
#define RCC_SYSCLKSOURCE_HSE                                                   \
  LL_RCC_SYS_CLKSOURCE_HSE /*!< HSE selected as system clock */
#define RCC_SYSCLKSOURCE_PLLCLK                                                \
  LL_RCC_SYS_CLKSOURCE_PLL /*!< PLL selected as system clock */
/**
 * @}
 */
...
#define RCC_RTCCLKSOURCE_HSE_DIV32                                             \
  LL_RCC_RTC_CLKSOURCE_HSE_DIV32 /*!< HSE oscillator clock divided by 32 used  \
                                    as RTC clock */
/**
 * @}
 */
...
#define RCC_MCO                                                                \
  RCC_MCO1 /*!< MCO1 to be compliant with other families with 1 MCO */
/**
 * @}
 */
...
#define RCC_MCO1SOURCE_SYSCLK                                                  \
  LL_RCC_MCO1SOURCE_SYSCLK /*!< SYSCLK selected as MCO1 source */
#define RCC_MCO1SOURCE_MSI                                                     \
  LL_RCC_MCO1SOURCE_MSI /*!< MSI selected as MCO1 source */
#define RCC_MCO1SOURCE_HSI                                                     \
  LL_RCC_MCO1SOURCE_HSI /*!< HSI selected as MCO1 source */
#define RCC_MCO1SOURCE_HSE                                                     \
  LL_RCC_MCO1SOURCE_HSE /*!< HSE after stabilization selected as MCO1 source   \
                         */
#define RCC_MCO1SOURCE_PLLCLK                                                  \
  LL_RCC_MCO1SOURCE_PLLCLK /*!< Main PLLRCLK selected as MCO1 source */
#define RCC_MCO1SOURCE_LSI                                                     \
  LL_RCC_MCO1SOURCE_LSI /*!< LSI selected as MCO1 source */
#define RCC_MCO1SOURCE_LSE                                                     \
  LL_RCC_MCO1SOURCE_LSE /*!< LSE selected as MCO1 source */
#define RCC_MCO1SOURCE_PLLPCLK                                                 \
  LL_RCC_MCO1SOURCE_PLLPCLK /*!< Main PLLPCLK selected as MCO1 source */
#define RCC_MCO1SOURCE_PLLQCLK                                                 \
  LL_RCC_MCO1SOURCE_PLLQCLK /*!< Main PLLQCLK selected as MCO1 source */
/**
 * @}
 */
...
#define RCC_IT_HSECSS                                                          \
  LL_RCC_CIFR_CSSF /*!< HSE Clock Security System Interrupt flag */
...
#define RCC_FLAG_MSIRDY                                                        \
  ((CR_REG_INDEX << REG_INDEX_POS) |                                           \
   RCC_CR_MSIRDY_Pos) /*!< MSI Ready flag                                   */
#define RCC_FLAG_HSIRDY                                                        \
  ((CR_REG_INDEX << REG_INDEX_POS) |                                           \
   RCC_CR_HSIRDY_Pos) /*!< HSI Ready flag                                   */
#define RCC_FLAG_HSIKERDY                                                      \
  ((CR_REG_INDEX << REG_INDEX_POS) |                                           \
   RCC_CR_HSIKERDY_Pos) /*!< HSI Ready flag */
#define RCC_FLAG_HSERDY                                                        \
  ((CR_REG_INDEX << REG_INDEX_POS) |                                           \
   RCC_CR_HSERDY_Pos) /*!< HSE Ready flag                                   */
#define RCC_FLAG_PLLRDY                                                        \
  ((CR_REG_INDEX << REG_INDEX_POS) |                                           \
   RCC_CR_PLLRDY_Pos) /*!< PLL Ready flag                                   */

/* Flags in the BDCR register */
#define RCC_FLAG_LSERDY                                                        \
  ((BDCR_REG_INDEX << REG_INDEX_POS) |                                         \
...
#define RCC_FLAG_LSECSSD                                                       \
  ((BDCR_REG_INDEX << REG_INDEX_POS) |                                         \
   RCC_BDCR_LSECSSD_Pos) /*!< LSE Clock Security System failure detection flag \
                          */
#define RCC_FLAG_LSESYSRDY                                                     \
  ((BDCR_REG_INDEX << REG_INDEX_POS) |                                         \
   RCC_BDCR_LSESYSRDY_Pos) /*!< LSE system clock ready flag */

/* Flags in the CSR register */
#define RCC_FLAG_LSIRDY                                                        \
  ((CSR_REG_INDEX << REG_INDEX_POS) |                                          \
   RCC_CSR_LSIRDY_Pos) /*!< LSI Ready flag */
#define RCC_FLAG_RFRST                                                         \
  ((CSR_REG_INDEX << REG_INDEX_POS) |                                          \
   RCC_CSR_RFRSTF_Pos) /*!< Sub-GHz radio reset flag */
#define RCC_FLAG_RFILARSTF                                                     \
  ((CSR_REG_INDEX << REG_INDEX_POS) |                                          \
   RCC_CSR_RFILARSTF_Pos) /*!< Sub-GHz radio illegal command flag */
#define RCC_FLAG_OBLRST                                                        \
  ((CSR_REG_INDEX << REG_INDEX_POS) |                                          \
   RCC_CSR_OBLRSTF_Pos) /*!< Option Byte Loader reset flag */
#define RCC_FLAG_PINRST                                                        \
  ((CSR_REG_INDEX << REG_INDEX_POS) |                                          \
   RCC_CSR_PINRSTF_Pos) /*!< Pin reset flag (NRST pin) */
#define RCC_FLAG_BORRST                                                        \
  ((CSR_REG_INDEX << REG_INDEX_POS) |                                          \
   RCC_CSR_BORRSTF_Pos) /*!< BOR reset flag */
#define RCC_FLAG_SFTRST                                                        \
  ((CSR_REG_INDEX << REG_INDEX_POS) |                                          \
   RCC_CSR_SFTRSTF_Pos) /*!< Software Reset flag */
#define RCC_FLAG_IWDGRST                                                       \
  ((CSR_REG_INDEX << REG_INDEX_POS) |                                          \
   RCC_CSR_IWDGRSTF_Pos) /*!< Watchdog reset flag */
...
#define RCC_LSEDRIVE_LOW                                                       \
  LL_RCC_LSEDRIVE_LOW /*!< LSE low drive capability         */
#define RCC_LSEDRIVE_MEDIUMLOW                                                 \
  LL_RCC_LSEDRIVE_MEDIUMLOW /*!< LSE medium low drive capability  */
#define RCC_LSEDRIVE_MEDIUMHIGH                                                \
  LL_RCC_LSEDRIVE_MEDIUMHIGH /*!< LSE medium high drive capability */
#define RCC_LSEDRIVE_HIGH                                                      \
  LL_RCC_LSEDRIVE_HIGH /*!< LSE high drive capability        */
/**
 * @}
 */
...
#define RCC_STOP_WAKEUPCLOCK_MSI                                               \
  LL_RCC_STOP_WAKEUPCLOCK_MSI /*!< MSI selected after wake-up from STOP */
#define RCC_STOP_WAKEUPCLOCK_HSI                                               \
  LL_RCC_STOP_WAKEUPCLOCK_HSI /*!< HSI selected after wake-up from STOP */
/**
 * @}
 */
...
#define __HAL_RCC_DMA2_CLK_ENABLE()                                            \
  LL_C2_AHB1_GRP1_EnableClock(LL_C2_AHB1_GRP1_PERIPH_DMA2)
#define __HAL_RCC_DMAMUX1_CLK_ENABLE()                                         \
  LL_C2_AHB1_GRP1_EnableClock(LL_C2_AHB1_GRP1_PERIPH_DMAMUX1)
...
#define __HAL_RCC_DMA2_CLK_DISABLE()                                           \
  LL_C2_AHB1_GRP1_DisableClock(LL_C2_AHB1_GRP1_PERIPH_DMA2)
...
#define __HAL_RCC_GPIOH_CLK_ENABLE()                                           \
  LL_C2_AHB2_GRP1_EnableClock(LL_C2_AHB2_GRP1_PERIPH_GPIOH)

#define __HAL_RCC_GPIOA_CLK_DISABLE()                                          \
  LL_C2_AHB2_GRP1_DisableClock(LL_C2_AHB2_GRP1_PERIPH_GPIOA)
#define __HAL_RCC_GPIOB_CLK_DISABLE()                                          \
  LL_C2_AHB2_GRP1_DisableClock(LL_C2_AHB2_GRP1_PERIPH_GPIOB)
#define __HAL_RCC_GPIOC_CLK_DISABLE()                                          \
  LL_C2_AHB2_GRP1_DisableClock(LL_C2_AHB2_GRP1_PERIPH_GPIOC)
#define __HAL_RCC_GPIOH_CLK_DISABLE()                                          \
  LL_C2_AHB2_GRP1_DisableClock(LL_C2_AHB2_GRP1_PERIPH_GPIOH)
#else
#define __HAL_RCC_GPIOA_CLK_ENABLE()                                           \
...
#define __HAL_RCC_PKA_CLK_ENABLE()                                             \
  LL_C2_AHB3_GRP1_EnableClock(LL_C2_AHB3_GRP1_PERIPH_PKA)
#define __HAL_RCC_AES_CLK_ENABLE()                                             \
  LL_C2_AHB3_GRP1_EnableClock(LL_C2_AHB3_GRP1_PERIPH_AES)
#define __HAL_RCC_RNG_CLK_ENABLE()                                             \
  LL_C2_AHB3_GRP1_EnableClock(LL_C2_AHB3_GRP1_PERIPH_RNG)
...
#define __HAL_RCC_FLASH_CLK_ENABLE()                                           \
  LL_C2_AHB3_GRP1_EnableClock(LL_C2_AHB3_GRP1_PERIPH_FLASH)

#define __HAL_RCC_PKA_CLK_DISABLE()                                            \
  LL_C2_AHB3_GRP1_DisableClock(LL_C2_AHB3_GRP1_PERIPH_PKA)
#define __HAL_RCC_AES_CLK_DISABLE()                                            \
  LL_C2_AHB3_GRP1_DisableClock(LL_C2_AHB3_GRP1_PERIPH_AES)
#define __HAL_RCC_RNG_CLK_DISABLE()                                            \
  LL_C2_AHB3_GRP1_DisableClock(LL_C2_AHB3_GRP1_PERIPH_RNG)
#define __HAL_RCC_HSEM_CLK_DISABLE()                                           \
  LL_C2_AHB3_GRP1_DisableClock(LL_C2_AHB3_GRP1_PERIPH_HSEM)
#define __HAL_RCC_IPCC_CLK_DISABLE()                                           \
  LL_C2_AHB3_GRP1_DisableClock(LL_C2_AHB3_GRP1_PERIPH_IPCC)
#define __HAL_RCC_FLASH_CLK_DISABLE()                                          \
  LL_C2_AHB3_GRP1_DisableClock(LL_C2_AHB3_GRP1_PERIPH_FLASH)
#else
#define __HAL_RCC_PKA_CLK_ENABLE()                                             \
...
#define __HAL_RCC_PKA_CLK_DISABLE()                                            \
  LL_AHB3_GRP1_DisableClock(LL_AHB3_GRP1_PERIPH_PKA)
#define __HAL_RCC_AES_CLK_DISABLE()                                            \
  LL_AHB3_GRP1_DisableClock(LL_AHB3_GRP1_PERIPH_AES)
#define __HAL_RCC_RNG_CLK_DISABLE()                                            \
  LL_AHB3_GRP1_DisableClock(LL_AHB3_GRP1_PERIPH_RNG)
#define __HAL_RCC_HSEM_CLK_DISABLE()                                           \
  LL_AHB3_GRP1_DisableClock(LL_AHB3_GRP1_PERIPH_HSEM)
#define __HAL_RCC_IPCC_CLK_DISABLE()                                           \
  LL_AHB3_GRP1_DisableClock(LL_AHB3_GRP1_PERIPH_IPCC)
#define __HAL_RCC_FLASH_CLK_DISABLE()                                          \
  LL_AHB3_GRP1_DisableClock(LL_AHB3_GRP1_PERIPH_FLASH)
#endif /* CORE_CM0PLUS */
/**
 * @}
 */
...
#define __HAL_RCC_TIM2_CLK_ENABLE()                                            \
  LL_C2_APB1_GRP1_EnableClock(LL_C2_APB1_GRP1_PERIPH_TIM2)
...
#define __HAL_RCC_SPI2_CLK_ENABLE()                                            \
  LL_C2_APB1_GRP1_EnableClock(LL_C2_APB1_GRP1_PERIPH_SPI2)
#define __HAL_RCC_USART2_CLK_ENABLE()                                          \
  LL_C2_APB1_GRP1_EnableClock(LL_C2_APB1_GRP1_PERIPH_USART2)
#define __HAL_RCC_I2C1_CLK_ENABLE()                                            \
  LL_C2_APB1_GRP1_EnableClock(LL_C2_APB1_GRP1_PERIPH_I2C1)
#define __HAL_RCC_I2C2_CLK_ENABLE()                                            \
  LL_C2_APB1_GRP1_EnableClock(LL_C2_APB1_GRP1_PERIPH_I2C2)
#define __HAL_RCC_I2C3_CLK_ENABLE()                                            \
  LL_C2_APB1_GRP1_EnableClock(LL_C2_APB1_GRP1_PERIPH_I2C3)
#define __HAL_RCC_DAC_CLK_ENABLE()                                             \
  LL_C2_APB1_GRP1_EnableClock(LL_C2_APB1_GRP1_PERIPH_DAC)
#define __HAL_RCC_LPTIM1_CLK_ENABLE()                                          \
  LL_C2_APB1_GRP1_EnableClock(LL_C2_APB1_GRP1_PERIPH_LPTIM1)

#define __HAL_RCC_LPTIM2_CLK_ENABLE()                                          \
  LL_C2_APB1_GRP2_EnableClock(LL_C2_APB1_GRP2_PERIPH_LPTIM2)
#define __HAL_RCC_LPTIM3_CLK_ENABLE()                                          \
  LL_C2_APB1_GRP2_EnableClock(LL_C2_APB1_GRP2_PERIPH_LPTIM3)
...
#define __HAL_RCC_TIM2_CLK_DISABLE()                                           \
  LL_C2_APB1_GRP1_DisableClock(LL_C2_APB1_GRP1_PERIPH_TIM2)
#define __HAL_RCC_RTCAPB_CLK_DISABLE()                                         \
  LL_C2_APB1_GRP1_DisableClock(LL_C2_APB1_GRP1_PERIPH_RTCAPB)
#define __HAL_RCC_SPI2_CLK_DISABLE()                                           \
  LL_C2_APB1_GRP1_DisableClock(LL_C2_APB1_GRP1_PERIPH_SPI2)
#define __HAL_RCC_USART2_CLK_DISABLE()                                         \
  LL_C2_APB1_GRP1_DisableClock(LL_C2_APB1_GRP1_PERIPH_USART2)
#define __HAL_RCC_I2C1_CLK_DISABLE()                                           \
  LL_C2_APB1_GRP1_DisableClock(LL_C2_APB1_GRP1_PERIPH_I2C1)
#define __HAL_RCC_I2C2_CLK_DISABLE()                                           \
  LL_C2_APB1_GRP1_DisableClock(LL_C2_APB1_GRP1_PERIPH_I2C2)
#define __HAL_RCC_I2C3_CLK_DISABLE()                                           \
  LL_C2_APB1_GRP1_DisableClock(LL_C2_APB1_GRP1_PERIPH_I2C3)
#define __HAL_RCC_DAC_CLK_DISABLE()                                            \
  LL_C2_APB1_GRP1_DisableClock(LL_C2_APB1_GRP1_PERIPH_DAC)
#define __HAL_RCC_LPTIM1_CLK_DISABLE()                                         \
  LL_C2_APB1_GRP1_DisableClock(LL_C2_APB1_GRP1_PERIPH_LPTIM1)

#define __HAL_RCC_LPTIM2_CLK_DISABLE()                                         \
  LL_C2_APB1_GRP2_DisableClock(LL_C2_APB1_GRP2_PERIPH_LPTIM2)
#define __HAL_RCC_LPTIM3_CLK_DISABLE()                                         \
  LL_C2_APB1_GRP2_DisableClock(LL_C2_APB1_GRP2_PERIPH_LPTIM3)
...
#define __HAL_RCC_LPTIM3_CLK_ENABLE()                                          \
  LL_APB1_GRP2_EnableClock(LL_APB1_GRP2_PERIPH_LPTIM3)
#define __HAL_RCC_LPUART1_CLK_ENABLE()                                         \
...
#define __HAL_RCC_DAC_CLK_DISABLE()                                            \
  LL_APB1_GRP1_DisableClock(LL_APB1_GRP1_PERIPH_DAC)
#define __HAL_RCC_LPTIM1_CLK_DISABLE()                                         \
...
#define __HAL_RCC_LPTIM3_CLK_DISABLE()                                         \
  LL_APB1_GRP2_DisableClock(LL_APB1_GRP2_PERIPH_LPTIM3)
#define __HAL_RCC_LPUART1_CLK_DISABLE()                                        \
...
#define __HAL_RCC_ADC_CLK_ENABLE()                                             \
  LL_C2_APB2_GRP1_EnableClock(LL_C2_APB2_GRP1_PERIPH_ADC)
#define __HAL_RCC_TIM1_CLK_ENABLE()                                            \
  LL_C2_APB2_GRP1_EnableClock(LL_C2_APB2_GRP1_PERIPH_TIM1)
#define __HAL_RCC_SPI1_CLK_ENABLE()                                            \
  LL_C2_APB2_GRP1_EnableClock(LL_C2_APB2_GRP1_PERIPH_SPI1)
#define __HAL_RCC_USART1_CLK_ENABLE()                                          \
  LL_C2_APB2_GRP1_EnableClock(LL_C2_APB2_GRP1_PERIPH_USART1)
#define __HAL_RCC_TIM16_CLK_ENABLE()                                           \
  LL_C2_APB2_GRP1_EnableClock(LL_C2_APB2_GRP1_PERIPH_TIM16)
#define __HAL_RCC_TIM17_CLK_ENABLE()                                           \
  LL_C2_APB2_GRP1_EnableClock(LL_C2_APB2_GRP1_PERIPH_TIM17)

#define __HAL_RCC_ADC_CLK_DISABLE()                                            \
  LL_C2_APB2_GRP1_DisableClock(LL_C2_APB2_GRP1_PERIPH_ADC)
#define __HAL_RCC_TIM1_CLK_DISABLE()                                           \
  LL_C2_APB2_GRP1_DisableClock(LL_C2_APB2_GRP1_PERIPH_TIM1)
#define __HAL_RCC_SPI1_CLK_DISABLE()                                           \
  LL_C2_APB2_GRP1_DisableClock(LL_C2_APB2_GRP1_PERIPH_SPI1)
#define __HAL_RCC_USART1_CLK_DISABLE()                                         \
  LL_C2_APB2_GRP1_DisableClock(LL_C2_APB2_GRP1_PERIPH_USART1)
#define __HAL_RCC_TIM16_CLK_DISABLE()                                          \
  LL_C2_APB2_GRP1_DisableClock(LL_C2_APB2_GRP1_PERIPH_TIM16)
#define __HAL_RCC_TIM17_CLK_DISABLE()                                          \
  LL_C2_APB2_GRP1_DisableClock(LL_C2_APB2_GRP1_PERIPH_TIM17)
#else
#define __HAL_RCC_ADC_CLK_ENABLE()                                             \
 ...
 */
#if defined(CORE_CM0PLUS)
#define __HAL_RCC_SUBGHZSPI_CLK_ENABLE()                                       \
  LL_C2_APB3_GRP1_EnableClock(LL_C2_APB3_GRP1_PERIPH_SUBGHZSPI)

#define __HAL_RCC_SUBGHZSPI_CLK_DISABLE()                                      \
  LL_C2_APB3_GRP1_DisableClock(LL_C2_APB3_GRP1_PERIPH_SUBGHZSPI)
#else
#define __HAL_RCC_SUBGHZSPI_CLK_ENABLE()                                       \
...
#define __HAL_RCC_CRC_IS_CLK_ENABLED()                                         \
  LL_AHB1_GRP1_IsEnabledClock(LL_AHB1_GRP1_PERIPH_CRC)
#endif /* CORE_CM0PLUS */
/**
 * @}
 */
...
#else
#define __HAL_RCC_GPIOA_IS_CLK_ENABLED()                                       \
  LL_AHB2_GRP1_IsEnabledClock(LL_AHB2_GRP1_PERIPH_GPIOA)
#define __HAL_RCC_GPIOB_IS_CLK_ENABLED()                                       \
  LL_AHB2_GRP1_IsEnabledClock(LL_AHB2_GRP1_PERIPH_GPIOB)
#define __HAL_RCC_GPIOC_IS_CLK_ENABLED()                                       \
  LL_AHB2_GRP1_IsEnabledClock(LL_AHB2_GRP1_PERIPH_GPIOC)
#define __HAL_RCC_GPIOH_IS_CLK_ENABLED()                                       \
  LL_AHB2_GRP1_IsEnabledClock(LL_AHB2_GRP1_PERIPH_GPIOH)
#endif /* CORE_CM0PLUS */
/**
 * @}
 */
...
#define __HAL_RCC_AES_IS_CLK_ENABLED()                                         \
  LL_C2_AHB3_GRP1_IsEnabledClock(LL_C2_AHB3_GRP1_PERIPH_AES)
...
#define __HAL_RCC_IPCC_IS_CLK_ENABLED()                                        \
...
#else
#define __HAL_RCC_PKA_IS_CLK_ENABLED()                                         \
  LL_AHB3_GRP1_IsEnabledClock(LL_AHB3_GRP1_PERIPH_PKA)
#define __HAL_RCC_AES_IS_CLK_ENABLED()                                         \
  LL_AHB3_GRP1_IsEnabledClock(LL_AHB3_GRP1_PERIPH_AES)
#define __HAL_RCC_RNG_IS_CLK_ENABLED()                                         \
  LL_AHB3_GRP1_IsEnabledClock(LL_AHB3_GRP1_PERIPH_RNG)
#define __HAL_RCC_HSEM_IS_CLK_ENABLED()                                        \
  LL_AHB3_GRP1_IsEnabledClock(LL_AHB3_GRP1_PERIPH_HSEM)
#define __HAL_RCC_IPCC_IS_CLK_ENABLED()                                        \
  LL_AHB3_GRP1_IsEnabledClock(LL_AHB3_GRP1_PERIPH_IPCC)
#define __HAL_RCC_FLASH_IS_CLK_ENABLED()                                       \
  LL_AHB3_GRP1_IsEnabledClock(LL_AHB3_GRP1_PERIPH_FLASH)
#endif /* CORE_CM0PLUS */
/**
 * @}
 */
...
#define __HAL_RCC_USART2_IS_CLK_ENABLED()                                      \
  LL_C2_APB1_GRP1_IsEnabledClock(LL_C2_APB1_GRP1_PERIPH_USART2)
...
#define __HAL_RCC_I2C2_IS_CLK_ENABLED()                                        \
  LL_C2_APB1_GRP1_IsEnabledClock(LL_C2_APB1_GRP1_PERIPH_I2C2)
...
#define __HAL_RCC_DAC_IS_CLK_ENABLED()                                         \
  LL_C2_APB1_GRP1_IsEnabledClock(LL_C2_APB1_GRP1_PERIPH_DAC)
...
#define __HAL_RCC_LPTIM3_IS_CLK_ENABLED()                                      \
  LL_C2_APB1_GRP2_IsEnabledClock(LL_C2_APB1_GRP2_PERIPH_LPTIM3)
#define __HAL_RCC_LPUART1_IS_CLK_ENABLED()                                     \
  LL_C2_APB1_GRP2_IsEnabledClock(LL_C2_APB1_GRP2_PERIPH_LPUART1)
#else
#define __HAL_RCC_TIM2_IS_CLK_ENABLED()                                        \
  LL_APB1_GRP1_IsEnabledClock(LL_APB1_GRP1_PERIPH_TIM2)
#define __HAL_RCC_RTCAPB_IS_CLK_ENABLED()                                      \
  LL_APB1_GRP1_IsEnabledClock(LL_APB1_GRP1_PERIPH_RTCAPB)
#define __HAL_RCC_SPI2_IS_CLK_ENABLED()                                        \
  LL_APB1_GRP1_IsEnabledClock(LL_APB1_GRP1_PERIPH_SPI2)
#define __HAL_RCC_USART2_IS_CLK_ENABLED()                                      \
  LL_APB1_GRP1_IsEnabledClock(LL_APB1_GRP1_PERIPH_USART2)
#define __HAL_RCC_I2C1_IS_CLK_ENABLED()                                        \
  LL_APB1_GRP1_IsEnabledClock(LL_APB1_GRP1_PERIPH_I2C1)
#define __HAL_RCC_I2C2_IS_CLK_ENABLED()                                        \
  LL_APB1_GRP1_IsEnabledClock(LL_APB1_GRP1_PERIPH_I2C2)
#define __HAL_RCC_I2C3_IS_CLK_ENABLED()                                        \
  LL_APB1_GRP1_IsEnabledClock(LL_APB1_GRP1_PERIPH_I2C3)
#define __HAL_RCC_DAC_IS_CLK_ENABLED()                                         \
  LL_APB1_GRP1_IsEnabledClock(LL_APB1_GRP1_PERIPH_DAC)
#define __HAL_RCC_LPTIM1_IS_CLK_ENABLED()                                      \
...
#define __HAL_RCC_LPTIM3_IS_CLK_ENABLED()                                      \
  LL_APB1_GRP2_IsEnabledClock(LL_APB1_GRP2_PERIPH_LPTIM3)
#define __HAL_RCC_LPUART1_IS_CLK_ENABLED()                                     \
  LL_APB1_GRP2_IsEnabledClock(LL_APB1_GRP2_PERIPH_LPUART1)
#endif /* CORE_CM0PLUS */

#define __HAL_RCC_WWDG_IS_CLK_ENABLED()                                        \
  LL_APB1_GRP1_IsEnabledClock(LL_APB1_GRP1_PERIPH_WWDG)
/**
 * @}
 */
...
#else
#define __HAL_RCC_ADC_IS_CLK_ENABLED()                                         \
  LL_APB2_GRP1_IsEnabledClock(LL_APB2_GRP1_PERIPH_ADC)
#define __HAL_RCC_TIM1_IS_CLK_ENABLED()                                        \
  LL_APB2_GRP1_IsEnabledClock(LL_APB2_GRP1_PERIPH_TIM1)
#define __HAL_RCC_SPI1_IS_CLK_ENABLED()                                        \
  LL_APB2_GRP1_IsEnabledClock(LL_APB2_GRP1_PERIPH_SPI1)
#define __HAL_RCC_USART1_IS_CLK_ENABLED()                                      \
  LL_APB2_GRP1_IsEnabledClock(LL_APB2_GRP1_PERIPH_USART1)
#define __HAL_RCC_TIM16_IS_CLK_ENABLED()                                       \
  LL_APB2_GRP1_IsEnabledClock(LL_APB2_GRP1_PERIPH_TIM16)
#define __HAL_RCC_TIM17_IS_CLK_ENABLED()                                       \
  LL_APB2_GRP1_IsEnabledClock(LL_APB2_GRP1_PERIPH_TIM17)
#endif /* CORE_CM0PLUS */
/**
 * @}
 */

/** @defgroup RCC_APB3_Clock_Enable_Disable_Status APB3 Peripheral Clock Enabled
 * or Disabled Status
 ...
 */
#if defined(CORE_CM0PLUS)
#define __HAL_RCC_SUBGHZSPI_IS_CLK_ENABLED()                                   \
  LL_C2_APB3_GRP1_IsEnabledClock(LL_C2_APB3_GRP1_PERIPH_SUBGHZSPI)
#else
#define __HAL_RCC_SUBGHZSPI_IS_CLK_ENABLED()                                   \
  LL_APB3_GRP1_IsEnabledClock(LL_APB3_GRP1_PERIPH_SUBGHZSPI)
#endif /* CORE_CM0PLUS */
...
#define __HAL_RCC_DMAMUX1_FORCE_RESET()                                        \
  LL_AHB1_GRP1_ForceReset(LL_AHB1_GRP1_PERIPH_DMAMUX1)
...
#define __HAL_RCC_DMAMUX1_RELEASE_RESET()                                      \
  LL_AHB1_GRP1_ReleaseReset(LL_AHB1_GRP1_PERIPH_DMAMUX1)
 ...
 */
#if defined(DUAL_CORE)
#define __HAL_RCC_IPCC_FORCE_RESET()                                           \
  LL_AHB3_GRP1_ForceReset(LL_AHB3_GRP1_PERIPH_IPCC)
#define __HAL_RCC_IPCC_RELEASE_RESET()                                         \
  LL_AHB3_GRP1_ReleaseReset(LL_AHB3_GRP1_PERIPH_IPCC)
#endif /* DUAL_CORE */

#define __HAL_RCC_AHB3_FORCE_RESET()                                           \
  LL_AHB3_GRP1_ForceReset(LL_AHB3_GRP1_PERIPH_ALL)
#define __HAL_RCC_PKA_FORCE_RESET()                                            \
...
#define __HAL_RCC_HSEM_FORCE_RESET()                                           \
  LL_AHB3_GRP1_ForceReset(LL_AHB3_GRP1_PERIPH_HSEM)
#define __HAL_RCC_FLASH_FORCE_RESET()                                          \
  LL_AHB3_GRP1_ForceReset(LL_AHB3_GRP1_PERIPH_FLASH)
...
#define __HAL_RCC_HSEM_RELEASE_RESET()                                         \
  LL_AHB3_GRP1_ReleaseReset(LL_AHB3_GRP1_PERIPH_HSEM)
#define __HAL_RCC_FLASH_RELEASE_RESET()                                        \
  LL_AHB3_GRP1_ReleaseReset(LL_AHB3_GRP1_PERIPH_FLASH)
/**
 * @}
 */
...
#define __HAL_RCC_SUBGHZSPI_FORCE_RESET()                                      \
  LL_APB3_GRP1_ForceReset(LL_APB3_GRP1_PERIPH_SUBGHZSPI)

#define __HAL_RCC_APB3_RELEASE_RESET()                                         \
  LL_APB3_GRP1_ReleaseReset(LL_APB3_GRP1_PERIPH_ALL)
#define __HAL_RCC_SUBGHZSPI_RELEASE_RESET()                                    \
  LL_APB3_GRP1_ReleaseReset(LL_APB3_GRP1_PERIPH_SUBGHZSPI)
...
#define __HAL_RCC_SUBGHZ_RADIO_RELEASE_RESET()                                 \
...
#define __HAL_RCC_CRC_CLK_SLEEP_ENABLE()                                       \
  LL_AHB1_GRP1_EnableClockSleep(LL_AHB1_GRP1_PERIPH_CRC)

#define __HAL_RCC_DMA1_CLK_SLEEP_DISABLE()                                     \
  LL_AHB1_GRP1_DisableClockSleep(LL_AHB1_GRP1_PERIPH_DMA1)
#define __HAL_RCC_DMA2_CLK_SLEEP_DISABLE()                                     \
...
#else
#define __HAL_RCC_GPIOA_CLK_SLEEP_ENABLE()                                     \
  LL_AHB2_GRP1_EnableClockSleep(LL_AHB2_GRP1_PERIPH_GPIOA)
#define __HAL_RCC_GPIOB_CLK_SLEEP_ENABLE()                                     \
  LL_AHB2_GRP1_EnableClockSleep(LL_AHB2_GRP1_PERIPH_GPIOB)
#define __HAL_RCC_GPIOC_CLK_SLEEP_ENABLE()                                     \
  LL_AHB2_GRP1_EnableClockSleep(LL_AHB2_GRP1_PERIPH_GPIOC)
#define __HAL_RCC_GPIOH_CLK_SLEEP_ENABLE()                                     \
  LL_AHB2_GRP1_EnableClockSleep(LL_AHB2_GRP1_PERIPH_GPIOH)
...
#define __HAL_RCC_AES_CLK_SLEEP_ENABLE()                                       \
  LL_C2_AHB3_GRP1_EnableClockSleep(LL_C2_AHB3_GRP1_PERIPH_AES)
...
#define __HAL_RCC_SRAM1_CLK_SLEEP_ENABLE()                                     \
  LL_C2_AHB3_GRP1_EnableClockSleep(LL_C2_AHB3_GRP1_PERIPH_SRAM1)
...
#define __HAL_RCC_AES_CLK_SLEEP_DISABLE()                                      \
  LL_C2_AHB3_GRP1_DisableClockSleep(LL_C2_AHB3_GRP1_PERIPH_AES)
...
#define __HAL_RCC_SRAM1_CLK_SLEEP_DISABLE()                                    \
  LL_C2_AHB3_GRP1_DisableClockSleep(LL_C2_AHB3_GRP1_PERIPH_SRAM1)
...
#else
#define __HAL_RCC_PKA_CLK_SLEEP_ENABLE()                                       \
  LL_AHB3_GRP1_EnableClockSleep(LL_AHB3_GRP1_PERIPH_PKA)
#define __HAL_RCC_AES_CLK_SLEEP_ENABLE()                                       \
  LL_AHB3_GRP1_EnableClockSleep(LL_AHB3_GRP1_PERIPH_AES)
#define __HAL_RCC_RNG_CLK_SLEEP_ENABLE()                                       \
  LL_AHB3_GRP1_EnableClockSleep(LL_AHB3_GRP1_PERIPH_RNG)
#define __HAL_RCC_SRAM1_CLK_SLEEP_ENABLE()                                     \
  LL_AHB3_GRP1_EnableClockSleep(LL_AHB3_GRP1_PERIPH_SRAM1)
#define __HAL_RCC_SRAM2_CLK_SLEEP_ENABLE()                                     \
  LL_AHB3_GRP1_EnableClockSleep(LL_AHB3_GRP1_PERIPH_SRAM2)
#define __HAL_RCC_FLASH_CLK_SLEEP_ENABLE()                                     \
  LL_AHB3_GRP1_EnableClockSleep(LL_AHB3_GRP1_PERIPH_FLASH)

#define __HAL_RCC_PKA_CLK_SLEEP_DISABLE()                                      \
  LL_AHB3_GRP1_DisableClockSleep(LL_AHB3_GRP1_PERIPH_PKA)
#define __HAL_RCC_AES_CLK_SLEEP_DISABLE()                                      \
  LL_AHB3_GRP1_DisableClockSleep(LL_AHB3_GRP1_PERIPH_AES)
#define __HAL_RCC_RNG_CLK_SLEEP_DISABLE()                                      \
  LL_AHB3_GRP1_DisableClockSleep(LL_AHB3_GRP1_PERIPH_RNG)
#define __HAL_RCC_SRAM1_CLK_SLEEP_DISABLE()                                    \
  LL_AHB3_GRP1_DisableClockSleep(LL_AHB3_GRP1_PERIPH_SRAM1)
#define __HAL_RCC_SRAM2_CLK_SLEEP_DISABLE()                                    \
...
#define __HAL_RCC_USART2_CLK_SLEEP_ENABLE()                                    \
  LL_C2_APB1_GRP1_EnableClockSleep(LL_C2_APB1_GRP1_PERIPH_USART2)
...
#define __HAL_RCC_I2C2_CLK_SLEEP_ENABLE()                                      \
  LL_C2_APB1_GRP1_EnableClockSleep(LL_C2_APB1_GRP1_PERIPH_I2C2)
...
#define __HAL_RCC_DAC_CLK_SLEEP_ENABLE()                                       \
  LL_C2_APB1_GRP1_EnableClockSleep(LL_C2_APB1_GRP1_PERIPH_DAC)
...
#define __HAL_RCC_LPTIM3_CLK_SLEEP_ENABLE()                                    \
  LL_C2_APB1_GRP2_EnableClockSleep(LL_C2_APB1_GRP2_PERIPH_LPTIM3)
...
#define __HAL_RCC_USART2_CLK_SLEEP_DISABLE()                                   \
  LL_C2_APB1_GRP1_DisableClockSleep(LL_C2_APB1_GRP1_PERIPH_USART2)
...
#define __HAL_RCC_I2C2_CLK_SLEEP_DISABLE()                                     \
  LL_C2_APB1_GRP1_DisableClockSleep(LL_C2_APB1_GRP1_PERIPH_I2C2)
...
#define __HAL_RCC_DAC_CLK_SLEEP_DISABLE()                                      \
  LL_C2_APB1_GRP1_DisableClockSleep(LL_C2_APB1_GRP1_PERIPH_DAC)
...
#define __HAL_RCC_LPTIM3_CLK_SLEEP_DISABLE()                                   \
  LL_C2_APB1_GRP2_DisableClockSleep(LL_C2_APB1_GRP2_PERIPH_LPTIM3)
#else
#define __HAL_RCC_TIM2_CLK_SLEEP_ENABLE()                                      \
...
#define __HAL_RCC_I2C1_CLK_SLEEP_ENABLE()                                      \
  LL_APB1_GRP1_EnableClockSleep(LL_APB1_GRP1_PERIPH_I2C1)
#define __HAL_RCC_I2C2_CLK_SLEEP_ENABLE()                                      \
  LL_APB1_GRP1_EnableClockSleep(LL_APB1_GRP1_PERIPH_I2C2)
#define __HAL_RCC_I2C3_CLK_SLEEP_ENABLE()                                      \
  LL_APB1_GRP1_EnableClockSleep(LL_APB1_GRP1_PERIPH_I2C3)
#define __HAL_RCC_DAC_CLK_SLEEP_ENABLE()                                       \
  LL_APB1_GRP1_EnableClockSleep(LL_APB1_GRP1_PERIPH_DAC)
#define __HAL_RCC_LPTIM1_CLK_SLEEP_ENABLE()                                    \
...
#define __HAL_RCC_LPTIM3_CLK_SLEEP_ENABLE()                                    \
  LL_APB1_GRP2_EnableClockSleep(LL_APB1_GRP2_PERIPH_LPTIM3)

#define __HAL_RCC_TIM2_CLK_SLEEP_DISABLE()                                     \
  LL_APB1_GRP1_DisableClockSleep(LL_APB1_GRP1_PERIPH_TIM2)
#define __HAL_RCC_RTCAPB_CLK_SLEEP_DISABLE()                                   \
  LL_APB1_GRP1_DisableClockSleep(LL_APB1_GRP1_PERIPH_RTCAPB)
#define __HAL_RCC_USART2_CLK_SLEEP_DISABLE()                                   \
  LL_APB1_GRP1_DisableClockSleep(LL_APB1_GRP1_PERIPH_USART2)
#define __HAL_RCC_SPI2_CLK_SLEEP_DISABLE()                                     \
  LL_APB1_GRP1_DisableClockSleep(LL_APB1_GRP1_PERIPH_SPI2)
#define __HAL_RCC_I2C1_CLK_SLEEP_DISABLE()                                     \
  LL_APB1_GRP1_DisableClockSleep(LL_APB1_GRP1_PERIPH_I2C1)
#define __HAL_RCC_I2C2_CLK_SLEEP_DISABLE()                                     \
  LL_APB1_GRP1_DisableClockSleep(LL_APB1_GRP1_PERIPH_I2C2)
#define __HAL_RCC_I2C3_CLK_SLEEP_DISABLE()                                     \
  LL_APB1_GRP1_DisableClockSleep(LL_APB1_GRP1_PERIPH_I2C3)
#define __HAL_RCC_DAC_CLK_SLEEP_DISABLE()                                      \
  LL_APB1_GRP1_DisableClockSleep(LL_APB1_GRP1_PERIPH_DAC)
#define __HAL_RCC_LPTIM1_CLK_SLEEP_DISABLE()                                   \
...
#define __HAL_RCC_LPTIM3_CLK_SLEEP_DISABLE()                                   \
  LL_APB1_GRP2_DisableClockSleep(LL_APB1_GRP2_PERIPH_LPTIM3)
#endif /* CORE_CM0PLUS */

#define __HAL_RCC_WWDG_CLK_SLEEP_ENABLE()                                      \
  LL_APB1_GRP1_EnableClockSleep(LL_APB1_GRP1_PERIPH_WWDG)

#define __HAL_RCC_WWDG_CLK_SLEEP_DISABLE()                                     \
  LL_APB1_GRP1_DisableClockSleep(LL_APB1_GRP1_PERIPH_WWDG)
/**
 * @}
 */
...
#else
#define __HAL_RCC_ADC_CLK_SLEEP_ENABLE()                                       \
  LL_APB2_GRP1_EnableClockSleep(LL_APB2_GRP1_PERIPH_ADC)
#define __HAL_RCC_TIM1_CLK_SLEEP_ENABLE()                                      \
  LL_APB2_GRP1_EnableClockSleep(LL_APB2_GRP1_PERIPH_TIM1)
#define __HAL_RCC_SPI1_CLK_SLEEP_ENABLE()                                      \
  LL_APB2_GRP1_EnableClockSleep(LL_APB2_GRP1_PERIPH_SPI1)
#define __HAL_RCC_USART1_CLK_SLEEP_ENABLE()                                    \
  LL_APB2_GRP1_EnableClockSleep(LL_APB2_GRP1_PERIPH_USART1)
#define __HAL_RCC_TIM16_CLK_SLEEP_ENABLE()                                     \
  LL_APB2_GRP1_EnableClockSleep(LL_APB2_GRP1_PERIPH_TIM16)
#define __HAL_RCC_TIM17_CLK_SLEEP_ENABLE()                                     \
  LL_APB2_GRP1_EnableClockSleep(LL_APB2_GRP1_PERIPH_TIM17)

#define __HAL_RCC_ADC_CLK_SLEEP_DISABLE()                                      \
  LL_APB2_GRP1_DisableClockSleep(LL_APB2_GRP1_PERIPH_ADC)
#define __HAL_RCC_TIM1_CLK_SLEEP_DISABLE()                                     \
  LL_APB2_GRP1_DisableClockSleep(LL_APB2_GRP1_PERIPH_TIM1)
#define __HAL_RCC_SPI1_CLK_SLEEP_DISABLE()                                     \
 ...
 */
#if defined(CORE_CM0PLUS)
#define __HAL_RCC_SUBGHZSPI_CLK_SLEEP_ENABLE()                                 \
  LL_C2_APB3_GRP1_EnableClockSleep(LL_C2_APB3_GRP1_PERIPH_SUBGHZSPI)

#define __HAL_RCC_SUBGHZSPI_CLK_SLEEP_DISABLE()                                \
  LL_C2_APB3_GRP1_DisableClockSleep(LL_C2_APB3_GRP1_PERIPH_SUBGHZSPI)
#else
#define __HAL_RCC_SUBGHZSPI_CLK_SLEEP_ENABLE()                                 \
  LL_APB3_GRP1_EnableClockSleep(LL_APB3_GRP1_PERIPH_SUBGHZSPI)

#define __HAL_RCC_SUBGHZSPI_CLK_SLEEP_DISABLE()                                \
  LL_APB3_GRP1_DisableClockSleep(LL_APB3_GRP1_PERIPH_SUBGHZSPI)
#endif /* CORE_CM0PLUS */

/* Aliases used by CubeMX for HAL SUBGHZ Init, MspInit and DeInit generation */
#define __HAL_RCC_SUBGHZ_CLK_SLEEP_ENABLE()                                    \
  __HAL_RCC_SUBGHZSPI_CLK_SLEEP_ENABLE()
#define __HAL_RCC_SUBGHZ_CLK_SLEEP_DISABLE()                                   \
...
#define __HAL_RCC_DMA1_IS_CLK_SLEEP_ENABLED()                                  \
  LL_C2_AHB1_GRP1_IsEnabledClockSleep(LL_AHB1_GRP1_PERIPH_DMA1)
#define __HAL_RCC_DMA2_IS_CLK_SLEEP_ENABLED()                                  \
  LL_C2_AHB1_GRP1_IsEnabledClockSleep(LL_AHB1_GRP1_PERIPH_DMA2)
#define __HAL_RCC_DMAMUX1_IS_CLK_SLEEP_ENABLED()                               \
  LL_C2_AHB1_GRP1_IsEnabledClockSleep(LL_AHB1_GRP1_PERIPH_DMAMUX1)
#define __HAL_RCC_CRC_IS_CLK_SLEEP_ENABLED()                                   \
  LL_C2_AHB1_GRP1_IsEnabledClockSleep(LL_AHB1_GRP1_PERIPH_CRC)
#else
#define __HAL_RCC_DMA1_IS_CLK_SLEEP_ENABLED()                                  \
  LL_AHB1_GRP1_IsEnabledClockSleep(LL_AHB1_GRP1_PERIPH_DMA1)
#define __HAL_RCC_DMA2_IS_CLK_SLEEP_ENABLED()                                  \
  LL_AHB1_GRP1_IsEnabledClockSleep(LL_AHB1_GRP1_PERIPH_DMA2)
#define __HAL_RCC_DMAMUX1_IS_CLK_SLEEP_ENABLED()                               \
  LL_AHB1_GRP1_IsEnabledClockSleep(LL_AHB1_GRP1_PERIPH_DMAMUX1)
#define __HAL_RCC_CRC_IS_CLK_SLEEP_ENABLED()                                   \
  LL_AHB1_GRP1_IsEnabledClockSleep(LL_AHB1_GRP1_PERIPH_CRC)
#endif /* CORE_CM0PLUS */
/**
 * @}
 */
...
#define __HAL_RCC_GPIOA_IS_CLK_SLEEP_ENABLED()                                 \
  LL_C2_AHB2_GRP1_IsEnabledClockSleep(LL_C2_AHB2_GRP1_PERIPH_GPIOA)
#define __HAL_RCC_GPIOB_IS_CLK_SLEEP_ENABLED()                                 \
  LL_C2_AHB2_GRP1_IsEnabledClockSleep(LL_C2_AHB2_GRP1_PERIPH_GPIOB)
#define __HAL_RCC_GPIOC_IS_CLK_SLEEP_ENABLED()                                 \
  LL_C2_AHB2_GRP1_IsEnabledClockSleep(LL_C2_AHB2_GRP1_PERIPH_GPIOC)
#define __HAL_RCC_GPIOH_IS_CLK_SLEEP_ENABLED()                                 \
  LL_C2_AHB2_GRP1_IsEnabledClockSleep(LL_C2_AHB2_GRP1_PERIPH_GPIOH)
#else
#define __HAL_RCC_GPIOA_IS_CLK_SLEEP_ENABLED()                                 \
  LL_AHB2_GRP1_IsEnabledClockSleep(LL_AHB2_GRP1_PERIPH_GPIOA)
#define __HAL_RCC_GPIOB_IS_CLK_SLEEP_ENABLED()                                 \
  LL_AHB2_GRP1_IsEnabledClockSleep(LL_AHB2_GRP1_PERIPH_GPIOB)
#define __HAL_RCC_GPIOC_IS_CLK_SLEEP_ENABLED()                                 \
  LL_AHB2_GRP1_IsEnabledClockSleep(LL_AHB2_GRP1_PERIPH_GPIOC)
#define __HAL_RCC_GPIOH_IS_CLK_SLEEP_ENABLED()                                 \
  LL_AHB2_GRP1_IsEnabledClockSleep(LL_AHB2_GRP1_PERIPH_GPIOH)
#endif /* CORE_CM0PLUS */
/**
 * @}
 */
...
#define __HAL_RCC_AES_IS_CLK_SLEEP_ENABLED()                                   \
  LL_C2_AHB3_GRP1_IsEnabledClockSleep(LL_AHB3_GRP1_PERIPH_AES)
#define __HAL_RCC_RNG_IS_CLK_SLEEP_ENABLED()                                   \
  LL_C2_AHB3_GRP1_IsEnabledClockSleep(LL_AHB3_GRP1_PERIPH_RNG)
#define __HAL_RCC_SRAM1_IS_CLK_SLEEP_ENABLED()                                 \
  LL_C2_AHB3_GRP1_IsEnabledClockSleep(LL_AHB3_GRP1_PERIPH_SRAM1)
#define __HAL_RCC_SRAM2_IS_CLK_SLEEP_ENABLED()                                 \
  LL_C2_AHB3_GRP1_IsEnabledClockSleep(LL_AHB3_GRP1_PERIPH_SRAM2)
#define __HAL_RCC_FLASH_IS_CLK_SLEEP_ENABLED()                                 \
  LL_C2_AHB3_GRP1_IsEnabledClockSleep(LL_AHB3_GRP1_PERIPH_FLASH)
#else
#define __HAL_RCC_PKA_IS_CLK_SLEEP_ENABLED()                                   \
  LL_AHB3_GRP1_IsEnabledClockSleep(LL_AHB3_GRP1_PERIPH_PKA)
#define __HAL_RCC_AES_IS_CLK_SLEEP_ENABLED()                                   \
  LL_AHB3_GRP1_IsEnabledClockSleep(LL_AHB3_GRP1_PERIPH_AES)
#define __HAL_RCC_RNG_IS_CLK_SLEEP_ENABLED()                                   \
  LL_AHB3_GRP1_IsEnabledClockSleep(LL_AHB3_GRP1_PERIPH_RNG)
#define __HAL_RCC_SRAM1_IS_CLK_SLEEP_ENABLED()                                 \
  LL_AHB3_GRP1_IsEnabledClockSleep(LL_AHB3_GRP1_PERIPH_SRAM1)
#define __HAL_RCC_SRAM2_IS_CLK_SLEEP_ENABLED()                                 \
  LL_AHB3_GRP1_IsEnabledClockSleep(LL_AHB3_GRP1_PERIPH_SRAM2)
#define __HAL_RCC_FLASH_IS_CLK_SLEEP_ENABLED()                                 \
  LL_AHB3_GRP1_IsEnabledClockSleep(LL_AHB3_GRP1_PERIPH_FLASH)
#endif /* CORE_CM0PLUS */
/**
 * @}
 */
...
#define __HAL_RCC_TIM2_IS_CLK_SLEEP_ENABLED()                                  \
  LL_C2_APB1_GRP1_IsEnabledClockSleep(LL_C2_APB1_GRP1_PERIPH_TIM2)
#define __HAL_RCC_RTCAPB_IS_CLK_SLEEP_ENABLED()                                \
  LL_C2_APB1_GRP1_IsEnabledClockSleep(LL_C2_APB1_GRP1_PERIPH_RTCAPB)
#define __HAL_RCC_USART2_IS_CLK_SLEEP_ENABLED()                                \
  LL_C2_APB1_GRP1_IsEnabledClockSleep(LL_C2_APB1_GRP1_PERIPH_USART2)
...
#define __HAL_RCC_I2C1_IS_CLK_SLEEP_ENABLED()                                  \
  LL_C2_APB1_GRP1_IsEnabledClockSleep(LL_C2_APB1_GRP1_PERIPH_I2C1)
#define __HAL_RCC_I2C2_IS_CLK_SLEEP_ENABLED()                                  \
  LL_C2_APB1_GRP1_IsEnabledClockSleep(LL_C2_APB1_GRP1_PERIPH_I2C2)
#define __HAL_RCC_I2C3_IS_CLK_SLEEP_ENABLED()                                  \
  LL_C2_APB1_GRP1_IsEnabledClockSleep(LL_C2_APB1_GRP1_PERIPH_I2C3)
#define __HAL_RCC_DAC_IS_CLK_SLEEP_ENABLED()                                   \
  LL_C2_APB1_GRP1_IsEnabledClockSleep(LL_C2_APB1_GRP1_PERIPH_DAC)
#define __HAL_RCC_LPTIM1_IS_CLK_SLEEP_ENABLED()                                \
  LL_C2_APB1_GRP1_IsEnabledClockSleep(LL_C2_APB1_GRP1_PERIPH_LPTIM1)

#define __HAL_RCC_LPUART1_IS_CLK_SLEEP_ENABLED()                               \
  LL_C2_APB1_GRP2_IsEnabledClockSleep(LL_C2_APB1_GRP2_PERIPH_LPUART1)
#define __HAL_RCC_LPTIM2_IS_CLK_SLEEP_ENABLED()                                \
  LL_C2_APB1_GRP2_IsEnabledClockSleep(LL_C2_APB1_GRP2_PERIPH_LPTIM2)
#define __HAL_RCC_LPTIM3_IS_CLK_SLEEP_ENABLED()                                \
  LL_C2_APB1_GRP2_IsEnabledClockSleep(LL_C2_APB1_GRP2_PERIPH_LPTIM3)
#else
#define __HAL_RCC_TIM2_IS_CLK_SLEEP_ENABLED()                                  \
  LL_APB1_GRP1_IsEnabledClockSleep(LL_APB1_GRP1_PERIPH_TIM2)
#define __HAL_RCC_RTCAPB_IS_CLK_SLEEP_ENABLED()                                \
  LL_APB1_GRP1_IsEnabledClockSleep(LL_APB1_GRP1_PERIPH_RTCAPB)
#define __HAL_RCC_USART2_IS_CLK_SLEEP_ENABLED()                                \
  LL_APB1_GRP1_IsEnabledClockSleep(LL_APB1_GRP1_PERIPH_USART2)
#define __HAL_RCC_SPI2_IS_CLK_SLEEP_ENABLED()                                  \
  LL_APB1_GRP1_IsEnabledClockSleep(LL_APB1_GRP1_PERIPH_SPI2)
#define __HAL_RCC_I2C1_IS_CLK_SLEEP_ENABLED()                                  \
  LL_APB1_GRP1_IsEnabledClockSleep(LL_APB1_GRP1_PERIPH_I2C1)
#define __HAL_RCC_I2C2_IS_CLK_SLEEP_ENABLED()                                  \
  LL_APB1_GRP1_IsEnabledClockSleep(LL_APB1_GRP1_PERIPH_I2C2)
#define __HAL_RCC_I2C3_IS_CLK_SLEEP_ENABLED()                                  \
  LL_APB1_GRP1_IsEnabledClockSleep(LL_APB1_GRP1_PERIPH_I2C3)
#define __HAL_RCC_DAC_IS_CLK_SLEEP_ENABLED()                                   \
  LL_APB1_GRP1_IsEnabledClockSleep(LL_APB1_GRP1_PERIPH_DAC)
#define __HAL_RCC_LPTIM1_IS_CLK_SLEEP_ENABLED()                                \
  LL_APB1_GRP1_IsEnabledClockSleep(LL_APB1_GRP1_PERIPH_LPTIM1)

#define __HAL_RCC_LPUART1_IS_CLK_SLEEP_ENABLED()                               \
  LL_APB1_GRP2_IsEnabledClockSleep(LL_APB1_GRP2_PERIPH_LPUART1)
#define __HAL_RCC_LPTIM2_IS_CLK_SLEEP_ENABLED()                                \
  LL_APB1_GRP2_IsEnabledClockSleep(LL_APB1_GRP2_PERIPH_LPTIM2)
#define __HAL_RCC_LPTIM3_IS_CLK_SLEEP_ENABLED()                                \
  LL_APB1_GRP2_IsEnabledClockSleep(LL_APB1_GRP2_PERIPH_LPTIM3)
#endif /* CORE_CM0PLUS */

#define __HAL_RCC_WWDG_IS_CLK_SLEEP_ENABLED()                                  \
  LL_APB1_GRP1_IsEnabledClockSleep(LL_APB1_GRP1_PERIPH_WWDG)
/**
 * @}
 */
...
#define __HAL_RCC_ADC_IS_CLK_SLEEP_ENABLED()                                   \
  LL_C2_APB2_GRP1_IsEnabledClockSleep(LL_C2_APB2_GRP1_PERIPH_ADC)
#define __HAL_RCC_TIM1_IS_CLK_SLEEP_ENABLED()                                  \
  LL_C2_APB2_GRP1_IsEnabledClockSleep(LL_C2_APB2_GRP1_PERIPH_TIM1)
#define __HAL_RCC_SPI1_IS_CLK_SLEEP_ENABLED()                                  \
  LL_C2_APB2_GRP1_IsEnabledClockSleep(LL_C2_APB2_GRP1_PERIPH_SPI1)
#define __HAL_RCC_USART1_IS_CLK_SLEEP_ENABLED()                                \
  LL_C2_APB2_GRP1_IsEnabledClockSleep(LL_C2_APB2_GRP1_PERIPH_USART1)
#define __HAL_RCC_TIM16_IS_CLK_SLEEP_ENABLED()                                 \
  LL_C2_APB2_GRP1_IsEnabledClockSleep(LL_C2_APB2_GRP1_PERIPH_TIM16)
#define __HAL_RCC_TIM17_IS_CLK_SLEEP_ENABLED()                                 \
  LL_C2_APB2_GRP1_IsEnabledClockSleep(LL_C2_APB2_GRP1_PERIPH_TIM17)
#else
#define __HAL_RCC_ADC_IS_CLK_SLEEP_ENABLED()                                   \
  LL_APB2_GRP1_IsEnabledClockSleep(LL_APB2_GRP1_PERIPH_ADC)
#define __HAL_RCC_TIM1_IS_CLK_SLEEP_ENABLED()                                  \
  LL_APB2_GRP1_IsEnabledClockSleep(LL_APB2_GRP1_PERIPH_TIM1)
#define __HAL_RCC_SPI1_IS_CLK_SLEEP_ENABLED()                                  \
  LL_APB2_GRP1_IsEnabledClockSleep(LL_APB2_GRP1_PERIPH_SPI1)
#define __HAL_RCC_USART1_IS_CLK_SLEEP_ENABLED()                                \
  LL_APB2_GRP1_IsEnabledClockSleep(LL_APB2_GRP1_PERIPH_USART1)
#define __HAL_RCC_TIM16_IS_CLK_SLEEP_ENABLED()                                 \
  LL_APB2_GRP1_IsEnabledClockSleep(LL_APB2_GRP1_PERIPH_TIM16)
#define __HAL_RCC_TIM17_IS_CLK_SLEEP_ENABLED()                                 \
  LL_APB2_GRP1_IsEnabledClockSleep(LL_APB2_GRP1_PERIPH_TIM17)
#endif /* CORE_CM0PLUS */
/**
 * @}
 */

/** @defgroup RCC_APB3_Clock_Sleep_Enable_Disable_Status APB3 Peripheral Clock
 * Sleep Enabled or Disabled Status
 * @brief  Check whether the APB3 peripheral clock during Low Power (Sleep) mode
 * is enabled or not.
 * @note   Peripheral clock gating in SLEEP mode can be used to further reduce
 *         power consumption.
 * @note   After wakeup from SLEEP mode, the peripheral clock is enabled again.
...
/* Aliases used by CubeMX for HAL SUBGHZ Init, MspInit and DeInit generation */
#define __HAL_RCC_SUBGHZ_IS_CLK_SLEEP_ENABLED()                                \
  __HAL_RCC_SUBGHZSPI_IS_CLK_SLEEP_ENABLED()
/**
 * @}
 */
 ...
 * @note   The HSI is stopped by hardware when entering STOP, STANDBY or
 * SHUTDOWN modes. It is enabled by hardware to force the HSI oscillator ON when
 * STOPWUCK=1 or HSIASFS = 1 when leaving Stop modes, or in case of failure of
 * the HSE crystal oscillator and Security System CSS is enabled.
...
/** @brief  Macro to adjust the Internal Multi Speed oscillator (MSI)
 * calibration value.
 * @note   The calibration is used to compensate for the variations in voltage
 ...
 *         the application software should wait on HSERDY flag to be set
 * indicating that HSE clock is stable and can be used to clock the PLL and/or
 * system clock.
 ...
 *            @arg @ref RCC_HSE_BYPASS_PWR  HSE32 driven from an external TCXO
 * powered by the PB0-VDDTCXO pin.
 * @retval None
 */
...
#define __HAL_RCC_RTC_CONFIG(__RTC_CLKSOURCE__)                                \
  LL_RCC_SetRTCClockSource(__RTC_CLKSOURCE__)
 ...
 * input frequency ranges from 2.66 to 16 MHz. It is recommended to select a
 * frequency of 16 MHz to limit PLL jitter.
 *
 * @param  __PLLN__  specifies the multiplication factor for PLL VCO output
 * clock. This parameter must be a number between 6 and 127.
 ...
 * source.
 *              @arg @ref RCC_PLLSOURCE_MSI MSI oscillator is used as PLL clock
 * source.
...
/**
 * @brief  Enable or disable each clock output (RCC_PLL_SYSCLK, RCC_PLL_I2S2CLK,
 * RCC_PLL_RNGCLK, RCC_PLL_ADCCLK)
 * @note   Enabling/disabling clock outputs RCC_PLL_I2S2CLK, RCC_PLL_RNGCLK and
 * RCC_PLL_ADCCLK can be done at anytime without the need to stop the PLL in
 * order to save power. But RCC_PLL_SYSCLK cannot be stopped if used as System
 * Clock.
 * @param  __PLLCLOCKOUT__  specifies the PLL clock to be output.
 *          This parameter can be one or a combination of the following values:
 *            @arg @ref RCC_PLL_ADCCLK  This clock is used to generate the clock
 * for ADC
 *            @arg @ref RCC_PLL_I2S2CLK  This Clock is used to generate the
 * clock for the I2S
 *            @arg @ref RCC_PLL_RNGCLK  This clock is used to generate the clock
 * for RNG
 *            @arg @ref RCC_PLL_SYSCLK  This Clock is used to generate the high
 * speed system clock (up to 48 MHz)
 * @retval None
 */
...
/**
 * @brief  Get clock output enable status (RCC_PLL_SYSCLK, RCC_PLL_I2S2CLK,
 * RCC_PLL_RNGCLK, RCC_PLL_ADCCLK)
 ...
 *          This parameter can be one of the following values:
 *              @arg @ref RCC_SYSCLKSOURCE_MSI MSI oscillator is used as system
 * clock source.
...
#define __HAL_RCC_SYSCLK_CONFIG(__SYSCLKSOURCE__)                              \
  LL_RCC_SetSysClkSource(__SYSCLKSOURCE__)
...
#define __HAL_RCC_WAKEUPSTOP_CLK_CONFIG(__STOPWUCLK__)                         \
  LL_RCC_SetClkAfterWakeFromStop(__STOPWUCLK__)
 ...
 *            @arg @ref RCC_MCO1SOURCE_PLLPCLK  main PLLP clock selected as MCO
 * source
 *            @arg @ref RCC_MCO1SOURCE_PLLQCLK  main PLLQ clock selected as MCO
 * source
...
/** @brief  Clear RCC interrupt pending bits (Perform Byte access to
 * RCC_CICR[17:0] bits to clear the selected interrupt pending bits.
...
#define __HAL_RCC_GET_FLAG(__FLAG__)                                           \
  (((((((__FLAG__) >> REG_INDEX_POS) == CR_REG_INDEX)                          \
          ? RCC->CR                                                            \
          : ((((__FLAG__) >> REG_INDEX_POS) == BDCR_REG_INDEX)                 \
                 ? RCC->BDCR                                                   \
                 : ((((__FLAG__) >> REG_INDEX_POS) == CSR_REG_INDEX)           \
                        ? RCC->CSR                                             \
                        : RCC->CIFR))) &                                       \
