...
#define RCC_PERIPHCLOCK_ALL                                                                        \
    (RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_USART2 | RCC_PERIPHCLK_I2S2 | RCC_PERIPHCLK_LPUART1      \
     | RCC_PERIPHCLK_I2C1 | RCC_PERIPHCLK_I2C2 | RCC_PERIPHCLK_I2C3 | RCC_PERIPHCLK_LPTIM1         \
     | RCC_PERIPHCLK_LPTIM2 | RCC_PERIPHCLK_LPTIM3 | RCC_PERIPHCLK_ADC | RCC_PERIPHCLK_RNG         \
     | RCC_PERIPHCLK_RTC)
/**
 * @}
 */
...
#define IS_RCC_I2S2CLKSOURCE(__SOURCE__)                                                           \
    (((__SOURCE__) == RCC_I2S2CLKSOURCE_PLL) || ((__SOURCE__) == RCC_I2S2CLKSOURCE_HSI)            \
...
#define IS_RCC_LPTIM3CLKSOURCE(__SOURCE__)                                                         \
    (((__SOURCE__) == RCC_LPTIM3CLKSOURCE_PCLK1) || ((__SOURCE__) == RCC_LPTIM3CLKSOURCE_LSI)      \
     || ((__SOURCE__) == RCC_LPTIM3CLKSOURCE_HSI) || ((__SOURCE__) == RCC_LPTIM3CLKSOURCE_LSE))

#define IS_RCC_RNGCLKSOURCE(__SOURCE__)                                                            \
    (((__SOURCE__) == RCC_RNGCLKSOURCE_PLL) || ((__SOURCE__) == RCC_RNGCLKSOURCE_LSI)              \
     || ((__SOURCE__) == RCC_RNGCLKSOURCE_LSE) || ((__SOURCE__) == RCC_RNGCLKSOURCE_MSI))

#define IS_RCC_ADCCLKSOURCE(__SOURCE__)                                                            \
    (((__SOURCE__) == RCC_ADCCLKSOURCE_NONE) || ((__SOURCE__) == RCC_ADCCLKSOURCE_HSI)             \
     || ((__SOURCE__) == RCC_ADCCLKSOURCE_PLL) || ((__SOURCE__) == RCC_ADCCLKSOURCE_SYSCLK))
...
typedef struct
{
    ...
    uint32_t
        RngClockSelection; /*!< Specifies RNG clock source.
...
#define RCC_LPUART1CLKSOURCE_SYSCLK                                                                \
    LL_RCC_LPUART1_CLKSOURCE_SYSCLK /*!< SYSCLK clock selected as LPUART1 clock*/
...
#define RCC_EXTI_LINE_LSECSS                                                                       \
    EXTI_IMR1_IM19 /*!< External interrupt line 18 connected to the LSE CSS EXTI Line */
/**
 * @}
 */
...
#define RCC_EXTI_LINE_HSECSS                                                                       \
    EXTI_IMR2_IM43 /*!< External interrupt line 43 connected to the HSE CSS EXTI Line */
/**
 * @}
 */
