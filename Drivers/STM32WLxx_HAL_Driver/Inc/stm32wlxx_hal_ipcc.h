...
typedef enum {
  IPCC_CHANNEL_DIR_TX =
      0x00U, /*!< Channel direction Tx is used by an MCU to transmit */
  IPCC_CHANNEL_DIR_RX =
      0x01U /*!< Channel direction Rx is used by an MCU to receive */
...
typedef enum {
  IPCC_CHANNEL_STATUS_FREE =
      0x00U, /*!< Means that a new msg can be posted on that channel */
...
typedef struct __IPCC_HandleTypeDef {
  ...
  uint32_t callbackRequest; /*!< Store information about callback notification
                               by channel */
 ...
 *            @arg @ref IPCC_CHANNEL_DIR_TX Transmit channel free interrupt
 * enable
 *            @arg @ref IPCC_CHANNEL_DIR_RX Receive channel occupied interrupt
 * enable
 */
 ...
 * *******************************/
/** @defgroup IPCC_Exported_Functions_Group1 Initialization and deinitialization
 * functions
 *  @{
 */
...
/** @defgroup IPCC_Exported_Functions_Group3 Peripheral State and Error
 * functions
 *  @{
 */
...
/** @defgroup IPCC_IRQ_Handler_and_Callbacks Peripheral IRQ Handler and
 * Callbacks
 *  @{
 */
