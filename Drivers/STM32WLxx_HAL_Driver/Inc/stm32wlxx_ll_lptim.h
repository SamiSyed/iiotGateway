...
#define LL_LPTIM_TRIG_SOURCE_COMP1                                                                 \
    (LPTIM_CFGR_TRIGSEL_2 | LPTIM_CFGR_TRIGSEL_1) /*!<External input trigger is connected to COMP1 \
                                                     output*/
...
#define LL_LPTIM_TRIG_SOURCE_LPTIM1                                                                \
    LPTIM_CFGR_TRIGSEL_0 /*!<External input trigger is connected to LPTIM1 output*/
#define LL_LPTIM_TRIG_SOURCE_LPTIM2                                                                \
    LPTIM_CFGR_TRIGSEL_1 /*!<External input trigger is connected to LPTIM1 output*/
/**
 * @}
 */
