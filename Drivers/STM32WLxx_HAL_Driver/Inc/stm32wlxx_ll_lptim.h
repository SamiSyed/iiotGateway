...
#define LL_LPTIM_IER_CMPOKIE                                                   \
  LPTIM_IER_CMPOKIE                          /*!< Compare register update OK */
#define LL_LPTIM_IER_ARRMIE LPTIM_IER_ARRMIE /*!< Autoreload match */
#define LL_LPTIM_IER_EXTTRIGIE                                                 \
  LPTIM_IER_EXTTRIGIE /*!< External trigger edge event */
#define LL_LPTIM_IER_ARROKIE                                                   \
  LPTIM_IER_ARROKIE /*!< Autoreload register update OK */
#define LL_LPTIM_IER_UPIE                                                      \
  LPTIM_IER_UPIE /*!< Counter direction change down to up */
#define LL_LPTIM_IER_DOWNIE                                                    \
  LPTIM_IER_DOWNIE /*!< Counter direction change up to down */
#define LL_LPTIM_IER_UEIE LPTIM_IER_UEIE /*!< Update event */
#define LL_LPTIM_IER_REPOKIE                                                   \
...
#define LL_LPTIM_TRIG_SOURCE_RTCTAMP3                                          \
  (LPTIM_CFGR_TRIGSEL_2 | LPTIM_CFGR_TRIGSEL_0) /*!<External input trigger is  \
                                                   connected to RTC Tamper 3*/
...
#define LL_LPTIM_TRIG_SOURCE_LPTIM1                                            \
  LPTIM_CFGR_TRIGSEL_0 /*!<External input trigger is connected to LPTIM1       \
                          output*/
#define LL_LPTIM_TRIG_SOURCE_LPTIM2                                            \
  LPTIM_CFGR_TRIGSEL_1 /*!<External input trigger is connected to LPTIM1       \
                          output*/
/**
 * @}
 */
 ...
 */
__STATIC_INLINE uint32_t
LL_LPTIM_IsActiveFlag_CMPM(const LPTIM_TypeDef *LPTIMx) {
  return (
      ((READ_BIT(LPTIMx->ISR, LPTIM_ISR_CMPM) == LPTIM_ISR_CMPM) ? 1UL : 0UL));
}
...
/**
  ...
  */
__STATIC_INLINE uint32_t
LL_LPTIM_IsActiveFlag_CMPOK(const LPTIM_TypeDef *LPTIMx) {
  return (((READ_BIT(LPTIMx->ISR, LPTIM_ISR_CMPOK) == LPTIM_ISR_CMPOK) ? 1UL
                                                                       : 0UL));
}
 ...
 */
__STATIC_INLINE uint32_t
LL_LPTIM_IsEnabledIT_CMPM(const LPTIM_TypeDef *LPTIMx) {
 ...
 */
__STATIC_INLINE uint32_t
LL_LPTIM_IsEnabledIT_CMPOK(const LPTIM_TypeDef *LPTIMx) {
...
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_UP(const LPTIM_TypeDef *LPTIMx) {
  return (
      ((READ_BIT(LPTIMx->IER, LPTIM_IER_UPIE) == LPTIM_IER_UPIE) ? 1UL : 0UL));
}
...
LL_LPTIM_IsEnabledIT_DOWN(const LPTIM_TypeDef *LPTIMx) {
  return ((READ_BIT(LPTIMx->IER, LPTIM_IER_DOWNIE) == LPTIM_IER_DOWNIE) ? 1UL
                                                                        : 0UL);
}
...
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_UE(const LPTIM_TypeDef *LPTIMx) {
  return ((READ_BIT(LPTIMx->IER, LPTIM_IER_UEIE) == (LPTIM_IER_UEIE)) ? 1UL
                                                                      : 0UL);
}
/**
 * @}
