...
typedef struct
{
    uint32_t WindowMode; /*!< Set window mode of a pair of comparators instances
                              ...
                              Note: HAL COMP driver allows to set window mode from any COMP instance
                            of the pair of COMP instances composing window mode.
...
typedef enum
{
    ...
    HAL_COMP_STATE_RESET_LOCKED = (HAL_COMP_STATE_RESET | COMP_STATE_BITFIELD_LOCK), /*!< COMP not
                                                                                        yet
                                                                                        initialized
                                                                                        and
                                                                                        configuration
    ...
    HAL_COMP_STATE_READY_LOCKED
        = (HAL_COMP_STATE_READY | COMP_STATE_BITFIELD_LOCK), /*!< COMP initialized but configuration
                                                                is locked         */
    HAL_COMP_STATE_BUSY = 0x02U, /*!< COMP is running                                      */
    HAL_COMP_STATE_BUSY_LOCKED = (HAL_COMP_STATE_BUSY | COMP_STATE_BITFIELD_LOCK) /*!< COMP is
                                                                                     running and
                                                                                     configuration
                                                                                     is locked */
 ...
 */
typedef void (*pCOMP_CallbackTypeDef)(COMP_HandleTypeDef *hcomp); /*!< pointer to a COMP callback
                                                                     function */
...
#define COMP_WINDOWMODE_DISABLE                                                                    \
    (0x00000000UL) /*!< Window mode disable: Comparators instances pair COMP1 and COMP2 are        \
                      independent */
#define COMP_WINDOWMODE_COMP1_INPUT_PLUS_COMMON                                                    \
    (COMP_CSR_WINMODE) /*!< Window mode enable: Comparators instances pair COMP1 and COMP2 have    \
                          their input plus connected together. The common input is COMP1 input     \
                          plus (COMP2 input plus is no more accessible). */
/**
 * @}
 */
...
#define COMP_INPUT_PLUS_IO1                                                                        \
    (0x00000000UL) /*!< Comparator input plus connected to IO1 (pin PB4 for COMP1, pin PB4 for     \
                      COMP2) */
#define COMP_INPUT_PLUS_IO2                                                                        \
    (COMP_CSR_INPSEL_0) /*!< Comparator input plus connected to IO2 (pin PB2 for COMP1, pin PB1    \
                           for COMP2) */
#define COMP_INPUT_PLUS_IO3                                                                        \
    (COMP_CSR_INPSEL_1) /*!< Comparator input plus connected to IO3 (not applicable for COMP1, pin \
                           PA15 for COMP2) */
/**
 * @}
 */
...
#define COMP_INPUT_MINUS_1_2VREFINT                                                                \
    (COMP_CSR_INMSEL_0 | COMP_CSR_SCALEN | COMP_CSR_BRGEN) /*!< Comparator input minus connected   \
                                                              to 1/2 VrefInt */
#define COMP_INPUT_MINUS_3_4VREFINT                                                                \
    (COMP_CSR_INMSEL_1 | COMP_CSR_SCALEN | COMP_CSR_BRGEN) /*!< Comparator input minus connected   \
                                                              to 3/4 VrefInt */
#define COMP_INPUT_MINUS_VREFINT                                                                   \
    (COMP_CSR_INMSEL_1 | COMP_CSR_INMSEL_0 | COMP_CSR_SCALEN) /*!< Comparator input minus          \
                                                                 connected to VrefInt */
#define COMP_INPUT_MINUS_DAC_CH1                                                                   \
    (COMP_CSR_INMSEL_2) /*!< Comparator input minus connected to DAC channel 1 (DAC_OUT1) */
#define COMP_INPUT_MINUS_IO1                                                                       \
    (COMP_CSR_INMSEL_2 | COMP_CSR_INMSEL_1) /*!< Comparator input minus connected to IO1 (pin PB3  \
                                               for COMP1, pin PB3 for COMP2) */
#define COMP_INPUT_MINUS_IO2                                                                       \
    (COMP_CSR_INMSEL_2 | COMP_CSR_INMSEL_1 | COMP_CSR_INMSEL_0) /*!< Comparator input minus        \
                                                                   connected to IO2 (pin PA10 for  \
                                                                   COMP1, pin PB2 for COMP2) */
#define COMP_INPUT_MINUS_IO3                                                                       \
    (COMP_CSR_INMESEL_0 | COMP_CSR_INMSEL_2 | COMP_CSR_INMSEL_1 | COMP_CSR_INMSEL_0) /*!<          \
                                                                                        Comparator \
                                                                                        input      \
                                                                                        minus      \
                                                                                        connected  \
...
#define COMP_INPUT_MINUS_IO4                                                                       \
    (COMP_CSR_INMESEL_1 | COMP_CSR_INMSEL_2 | COMP_CSR_INMSEL_1 | COMP_CSR_INMSEL_0) /*!<          \
                                                                                        Comparator \
                                                                                        input      \
                                                                                        minus      \
                                                                                        connected  \
...
#define COMP_OUTPUTPOL_NONINVERTED                                                                 \
    (0x00000000UL) /*!< COMP output level is not inverted (comparator output is high when the      \
                      input plus is at a higher voltage than the input minus) */
#define COMP_OUTPUTPOL_INVERTED                                                                    \
    (COMP_CSR_POLARITY) /*!< COMP output level is inverted     (comparator output is low  when the \
                           input plus is at a higher voltage than the input minus) */
/**
 * @}
 */
...
#define COMP_BLANKINGSRC_TIM1_OC5                                                                  \
    (COMP_CSR_BLANKING_0) /*!< Comparator output blanking source TIM1 OC5 (common to all COMP      \
                             instances: COMP1, COMP2) */
#define COMP_BLANKINGSRC_TIM2_OC3                                                                  \
    (COMP_CSR_BLANKING_1) /*!< Comparator output blanking source TIM2 OC3 (common to all COMP      \
                             instances: COMP1, COMP2) */
/**
 * @}
 */
...
#define COMP_TRIGGERMODE_NONE                                                                      \
    (0x00000000UL) /*!< Comparator output triggering no External Interrupt Line */
#define COMP_TRIGGERMODE_IT_RISING                                                                 \
    (COMP_EXTI_IT | COMP_EXTI_RISING) /*!< Comparator output triggering External Interrupt Line    \
                                         event with interruption, on rising edge */
#define COMP_TRIGGERMODE_IT_FALLING                                                                \
    (COMP_EXTI_IT | COMP_EXTI_FALLING) /*!< Comparator output triggering External Interrupt Line   \
                                          event with interruption, on falling edge */
#define COMP_TRIGGERMODE_IT_RISING_FALLING                                                         \
    (COMP_EXTI_IT | COMP_EXTI_RISING | COMP_EXTI_FALLING) /*!< Comparator output triggering        \
                                                             External Interrupt Line event with    \
                                                             interruption, on both rising and      \
                                                             falling edges */
#define COMP_TRIGGERMODE_EVENT_RISING                                                              \
    (COMP_EXTI_EVENT | COMP_EXTI_RISING) /*!< Comparator output triggering External Interrupt Line \
                                            event only (without interruption), on rising edge */
#define COMP_TRIGGERMODE_EVENT_FALLING                                                             \
    (COMP_EXTI_EVENT | COMP_EXTI_FALLING) /*!< Comparator output triggering External Interrupt     \
                                             Line event only (without interruption), on falling    \
                                             edge */
#define COMP_TRIGGERMODE_EVENT_RISING_FALLING                                                      \
    (COMP_EXTI_EVENT | COMP_EXTI_RISING | COMP_EXTI_FALLING) /*!< Comparator output triggering     \
...
#define IS_COMP_OUTPUTPOL(__POL__)                                                                 \
    (((__POL__) == COMP_OUTPUTPOL_NONINVERTED) || ((__POL__) == COMP_OUTPUTPOL_INVERTED))
