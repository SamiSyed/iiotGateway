...
typedef struct {
  ...
  uint32_t
      WindowMode; /*!< Set window mode of a pair of comparators instances
                       (2 consecutive instances odd and even COMP<x> and
                     COMP<x+1>). Note: HAL COMP driver allows to set window mode
                     from any COMP instance of the pair of COMP instances
                     composing window mode. This parameter can be a value of
                     @ref COMP_WindowMode */
  ...
  uint32_t
      TriggerMode; /*!< Set the comparator output triggering External Interrupt
                      Line (EXTI). This parameter can be a value of @ref
...
#define COMP_WINDOWMODE_DISABLE                                                \
  (0x00000000UL) /*!< Window mode disable: Comparators instances pair COMP1    \
                    and COMP2 are independent */
...
#define COMP_POWERMODE_ULTRALOWPOWER                                           \
  (COMP_CSR_PWRMODE) /*!< Ultra-low power mode */
/**
 * @}
 */
...
#define COMP_INPUT_PLUS_IO3                                                    \
  (COMP_CSR_INPSEL_1) /*!< Comparator input plus connected to IO3 (not         \
...
#define COMP_OUTPUTPOL_NONINVERTED                                             \
  (0x00000000UL) /*!< COMP output level is not inverted (comparator output is  \
                    high when the input plus is at a higher voltage than the   \
                    input minus) */
...
#define COMP_TRIGGERMODE_IT_RISING                                             \
  (COMP_EXTI_IT |                                                              \
   COMP_EXTI_RISING) /*!< Comparator output triggering External Interrupt Line \
...
#define __HAL_COMP_COMP1_EXTI_ENABLE_IT()                                      \
  LL_C2_EXTI_EnableIT_0_31(COMP_EXTI_LINE_COMP1)
#else
#define __HAL_COMP_COMP1_EXTI_ENABLE_IT()                                      \
...
#define __HAL_COMP_COMP1_EXTI_DISABLE_IT()                                     \
  LL_C2_EXTI_DisableIT_0_31(COMP_EXTI_LINE_COMP1)
#else
#define __HAL_COMP_COMP1_EXTI_DISABLE_IT()                                     \
...
#define __HAL_COMP_COMP1_EXTI_ENABLE_EVENT()                                   \
  LL_C2_EXTI_EnableEvent_0_31(COMP_EXTI_LINE_COMP1)
#else
#define __HAL_COMP_COMP1_EXTI_ENABLE_EVENT()                                   \
...
#define __HAL_COMP_COMP1_EXTI_DISABLE_EVENT()                                  \
  LL_C2_EXTI_DisableEvent_0_31(COMP_EXTI_LINE_COMP1)
#else
#define __HAL_COMP_COMP1_EXTI_DISABLE_EVENT()                                  \
...
#define COMP_EXTI_LINE_COMP1                                                   \
  (LL_EXTI_LINE_21) /*!< EXTI line 21 connected to COMP1 output */
#define COMP_EXTI_LINE_COMP2                                                   \
  (LL_EXTI_LINE_22) /*!< EXTI line 22 connected to COMP2 output */
/**
 * @}
 */
