...
#define LL_DAC_TRIG_EXT_TIM1_TRGO                                                                  \
    (DAC_CR_TSEL1_0) /*!< DAC channel conversion trigger from external IP: TIM1 TRGO. */
#define LL_DAC_TRIG_EXT_TIM2_TRGO                                                                  \
    (DAC_CR_TSEL1_1) /*!< DAC channel conversion trigger from external IP: TIM2 TRGO. */
#define LL_DAC_TRIG_EXT_LPTIM1_OUT                                                                 \
    (DAC_CR_TSEL1_3 | DAC_CR_TSEL1_1 | DAC_CR_TSEL1_0) /*!< DAC channel conversion trigger from    \
                                                          external IP: LPTIM1 TRGO. */
#define LL_DAC_TRIG_EXT_LPTIM2_OUT                                                                 \
    (DAC_CR_TSEL1_3 | DAC_CR_TSEL1_2) /*!< DAC channel conversion trigger from external IP: LPTIM2 \
                                         TRGO. */
#define LL_DAC_TRIG_EXT_LPTIM3_OUT                                                                 \
    (DAC_CR_TSEL1_3 | DAC_CR_TSEL1_2 | DAC_CR_TSEL1_0) /*!< DAC channel conversion trigger from    \
                                                          external IP: LPTIM3 TRGO. */
#define LL_DAC_TRIG_EXT_EXTI_LINE9                                                                 \
    (DAC_CR_TSEL1_3 | DAC_CR_TSEL1_2 | DAC_CR_TSEL1_1) /*!< DAC channel conversion trigger from    \
                                                          external IP: external interrupt line 9.  \
                                                        */
/**
 * @}
 */
...
#define LL_DAC_NOISE_LFSR_UNMASK_BITS7_0                                                           \
    (DAC_CR_MAMP1_2 | DAC_CR_MAMP1_1 | DAC_CR_MAMP1_0) /*!< Noise wave generation, unmask LFSR     \
...
#define LL_DAC_NOISE_LFSR_UNMASK_BITS11_0                                                          \
    (DAC_CR_MAMP1_3 | DAC_CR_MAMP1_1 | DAC_CR_MAMP1_0) /*!< Noise wave generation, unmask LFSR     \
...
#define LL_DAC_TRIANGLE_AMPLITUDE_255                                                              \
    (DAC_CR_MAMP1_2 | DAC_CR_MAMP1_1 | DAC_CR_MAMP1_0) /*!< Triangle wave generation, amplitude of \
                                                          255 LSB of DAC output range, for the     \
                                                          selected DAC channel */
...
#define LL_DAC_TRIANGLE_AMPLITUDE_4095                                                             \
    (DAC_CR_MAMP1_3 | DAC_CR_MAMP1_1 | DAC_CR_MAMP1_0) /*!< Triangle wave generation, amplitude of \
...
#define LL_DAC_OUTPUT_MODE_SAMPLE_AND_HOLD                                                         \
    (DAC_MCR_MODE1_2) /*!< The selected DAC channel output is on mode sample-and-hold. Mode        \
                         sample-and-hold requires an external capacitor, refer to description of   \
                         function @ref LL_DAC_ConfigOutput() or @ref LL_DAC_SetOutputMode(). */
/**
 * @}
 */
...
#define LL_DAC_OUTPUT_BUFFER_DISABLE                                                               \
    (DAC_MCR_MODE1_1) /*!< The selected DAC channel output is not buffered: lower drive current    \
...
#define LL_DAC_OUTPUT_CONNECT_INTERNAL                                                             \
    (DAC_MCR_MODE1_0) /*!< The selected DAC channel output is connected to on-chip peripherals via \
                         internal paths. On this STM32 series, output connection depends on output \
                         mode (normal or sample and hold) and output buffer state. Refer to        \
...
#define LL_DAC_DELAY_STARTUP_VOLTAGE_SETTLING_US                                                   \
    8UL /*!< Delay for DAC channel voltage settling time from DAC channel startup (transition from \
           disable to enable) */
...
#define __LL_DAC_DECIMAL_NB_TO_CHANNEL(__DECIMAL_NB__)                                             \
    (((__DECIMAL_NB__) == 1UL) ? (LL_DAC_CHANNEL_1) : (0UL))
...
{
    return (
        uint32_t)(READ_BIT(DACx->CCR, DAC_CCR_OTRIM1 << (DAC_Channel & DAC_CR_CHX_BITOFFSET_MASK))
                  >> (DAC_Channel & DAC_CR_CHX_BITOFFSET_MASK));
}
 ...
 */
__STATIC_INLINE uint32_t LL_DAC_GetSampleAndHoldSampleTime(const DAC_TypeDef *DACx,
                                                           uint32_t DAC_Channel)
{
 ...
 * @retval Value between Min_Data=0x000 and Max_Data=0x3FF
 */
__STATIC_INLINE uint32_t LL_DAC_GetSampleAndHoldHoldTime(const DAC_TypeDef *DACx,
                                                         uint32_t DAC_Channel)
{
    return (
        uint32_t)(READ_BIT(DACx->SHHR, DAC_SHHR_THOLD1 << (DAC_Channel & DAC_CR_CHX_BITOFFSET_MASK))
                  >> (DAC_Channel & DAC_CR_CHX_BITOFFSET_MASK));
}
 ...
 */
__STATIC_INLINE uint32_t LL_DAC_GetSampleAndHoldRefreshTime(const DAC_TypeDef *DACx,
                                                            uint32_t DAC_Channel)
{
