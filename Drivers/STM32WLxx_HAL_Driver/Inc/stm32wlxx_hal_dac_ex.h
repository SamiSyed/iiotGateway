...
#define DAC_LFSRUNMASK_BITS7_0                                                                     \
    (DAC_CR_MAMP1_2 | DAC_CR_MAMP1_1 | DAC_CR_MAMP1_0) /*!< Unmask DAC channel LFSR bit[7:0] for   \
...
#define DAC_LFSRUNMASK_BITS11_0                                                                    \
    (DAC_CR_MAMP1_3 | DAC_CR_MAMP1_1 | DAC_CR_MAMP1_0) /*!< Unmask DAC channel LFSR bit[11:0] for  \
                                                          noise wave generation */
...
#define IS_DAC_TRIGGER(TRIGGER)                                                                    \
    (((TRIGGER) == DAC_TRIGGER_NONE) || ((TRIGGER) == DAC_TRIGGER_SOFTWARE)                        \
     ...
     || ((TRIGGER) == DAC_TRIGGER_LPTIM1_OUT) || ((TRIGGER) == DAC_TRIGGER_LPTIM2_OUT)             \
     || ((TRIGGER) == DAC_TRIGGER_LPTIM3_OUT) || ((TRIGGER) == DAC_TRIGGER_EXT_IT9))
