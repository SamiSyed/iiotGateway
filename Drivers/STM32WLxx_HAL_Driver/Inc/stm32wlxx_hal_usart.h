...
typedef struct
{
    uint32_t BaudRate; /*!< This member configures the Usart communication baud rate.
                          ...
                          Register[2:0]  =  (((2 * fclk_pres) / ((huart->Init.BaudRate)))[3:0]) >> 1
                               where fclk_pres is the USART input clock frequency (fclk) divided by
                          a prescaler.
                            @note  Oversampling by 8 is systematically applied to achieve high baud
                          rates. */
...
typedef struct __USART_HandleTypeDef
{
    ...
    void (*TxHalfCpltCallback)(struct __USART_HandleTypeDef *husart); /*!< USART Tx Half Complete
                                                                         Callback        */
    void (*TxCpltCallback)(
        struct __USART_HandleTypeDef *husart); /*!< USART Tx Complete Callback             */
    void (*RxHalfCpltCallback)(struct __USART_HandleTypeDef *husart); /*!< USART Rx Half Complete
                                                                         Callback        */
    void (*RxCpltCallback)(
        struct __USART_HandleTypeDef *husart); /*!< USART Rx Complete Callback             */
    void (*TxRxCpltCallback)(struct __USART_HandleTypeDef *husart);    /*!< USART Tx Rx Complete
                                                                          Callback          */
    void (*ErrorCallback)(struct __USART_HandleTypeDef *husart);       /*!< USART Error Callback       */
    void (*AbortCpltCallback)(struct __USART_HandleTypeDef *husart);   /*!< USART Abort Complete
                                                                          Callback          */
    void (*RxFifoFullCallback)(struct __USART_HandleTypeDef *husart);  /*!< USART Rx Fifo Full
                                                                          Callback            */
    void (*TxFifoEmptyCallback)(struct __USART_HandleTypeDef *husart); /*!< USART Tx Fifo Empty
                                                                          Callback           */
...
#define __HAL_USART_GET_IT(__HANDLE__, __INTERRUPT__)                                              \
    ((((__HANDLE__)->Instance->ISR                                                                 \
       & ((uint32_t)0x01U << (((__INTERRUPT__)&USART_ISR_MASK) >> USART_ISR_POS)))                 \
      != 0U)                                                                                       \
         ? SET                                                                                     \
         : RESET)
...
#define __HAL_USART_GET_IT_SOURCE(__HANDLE__, __INTERRUPT__)                                       \
    ((((((((uint8_t)(__INTERRUPT__)) >> 0x05U) == 0x01U)                                           \
       ...
       & (0x01U << (((uint16_t)(__INTERRUPT__)) & USART_IT_MASK)))                                 \
      != 0U)                                                                                       \
         ? SET                                                                                     \
         : RESET)
