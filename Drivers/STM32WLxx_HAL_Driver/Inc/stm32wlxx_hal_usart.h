...
typedef struct {
  uint32_t
      BaudRate; /*!< This member configures the Usart communication baud rate.
                   ...
                   ((huart->Init.BaudRate)))[15:4] Baud Rate Register[3]    = 0
                        Baud Rate Register[2:0]  =  (((2 * fclk_pres) /
                   ((huart->Init.BaudRate)))[3:0]) >> 1 where fclk_pres is the
                   USART input clock frequency (fclk) divided by a prescaler.
  ...
  uint32_t
      ClockPrescaler; /*!< Specifies the prescaler value used to divide the
                         USART clock source. This parameter can be a value of
                         @ref USART_ClockPrescaler. */
} USART_InitTypeDef;
...
typedef struct __USART_HandleTypeDef {
  ...
  void (*RxFifoFullCallback)(struct __USART_HandleTypeDef
 ...
 *         The maximum Baud Rate is derived from the maximum clock on WL (i.e.
 * 48 MHz) divided by the smallest oversampling used on the USART (i.e. 8)
