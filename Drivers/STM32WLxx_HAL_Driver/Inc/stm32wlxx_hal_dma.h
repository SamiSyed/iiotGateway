...
typedef struct __DMA_HandleTypeDef
{
    ...
    void (*XferHalfCpltCallback)(struct __DMA_HandleTypeDef *hdma); /*!< DMA Half transfer complete
                                                                       callback   */
...
#define DMA_CHANNEL_SRC_SEC                                                                        \
    (DMA_CHANNEL_ATTR_SEC_SRC_MASK | DMA_CCR_SSEC) /*!< Channel source is secure          */
#define DMA_CHANNEL_SRC_NSEC                                                                       \
    (DMA_CHANNEL_ATTR_SEC_SRC_MASK) /*!< Channel source is non-secure      */
#define DMA_CHANNEL_DEST_SEC                                                                       \
    (DMA_CHANNEL_ATTR_SEC_DEST_MASK | DMA_CCR_DSEC) /*!< Channel destination is secure     */
...
#define IS_DMA_ATTRIBUTES(ATTRIBUTE)                                                               \
    ((((ATTRIBUTE) & (~(0x001E001EU))) == 0U) && (((ATTRIBUTE)&0x0000001EU) != 0U))
#else
#define IS_DMA_ATTRIBUTES(ATTRIBUTE)                                                               \
    ((((ATTRIBUTE) & (~(0x00100010U))) == 0U) && (((ATTRIBUTE)&0x00000010U) != 0U))
#endif /* CORE_CM0PLUS */
#endif /* DMA_SECURE_SWITCH */
/**
 * @}
