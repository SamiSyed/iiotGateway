...
typedef struct {
  uint32_t
      CPU1CLKDivider; /*!< The CPU1 clock (HCLK1) divider. This clock is derived
  ...
  uint32_t
      CPU2CLKDivider; /*!< The CPU2 clock (HCLK2) divider. This clock is derived
                         from the system clock (SYSCLK). This parameter can be a
                         value of @ref RCC_LL_EC_SYSCLK_DIV
  ...
  uint32_t
      AHB3CLKDivider; /*!< The AHBS clock (HCLK3) divider. This clock is derived
                         from the system clock (SYSCLK). This parameter can be a
                         value of @ref RCC_LL_EC_SYSCLK_DIV
  ...
  uint32_t APB1CLKDivider; /*!< The APB1 clock (PCLK1) divider. This clock is
                              derived from the AHB clock (HCLK1). This parameter
