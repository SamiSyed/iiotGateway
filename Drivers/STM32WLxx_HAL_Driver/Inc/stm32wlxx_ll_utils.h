...
typedef struct
{
    ...
    uint32_t AHB3CLKDivider; /*!< The AHBS clock (HCLK3) divider. This clock is derived from the
                                system clock (SYSCLK). This parameter can be a value of @ref
                                RCC_LL_EC_SYSCLK_DIV
    ...
    uint32_t APB1CLKDivider; /*!< The APB1 clock (PCLK1) divider. This clock is derived from the AHB
                                clock (HCLK1). This parameter can be a value of @ref
                                RCC_LL_EC_APB1_DIV
...
__STATIC_INLINE void LL_InitTick(uint32_t HCLKFrequency, uint32_t Ticks)
{
    if (Ticks > 0U)
    {
        ...
        SysTick->CTRL = SysTick_CTRL_CLKSOURCE_Msk | SysTick_CTRL_ENABLE_Msk; /* Enable the Systick
                                                                                 Timer */
    }
}
