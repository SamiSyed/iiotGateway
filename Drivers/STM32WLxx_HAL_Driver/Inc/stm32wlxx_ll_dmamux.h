...
#define LL_DMAMUX_SYNC_POL_RISING_FALLING                                                          \
    (DMAMUX_CxCR_SPOL_0 | DMAMUX_CxCR_SPOL_1) /*!< Synchronization on event on rising and falling  \
                                                 edge */
/**
 * @}
 */
...
#define LL_DMAMUX_SYNC_EXTI_LINE7                                                                  \
    (DMAMUX_CxCR_SYNC_ID_2 | DMAMUX_CxCR_SYNC_ID_1 | DMAMUX_CxCR_SYNC_ID_0) /*!< Synchronization   \
                                                                               signal from EXTI    \
                                                                               Line7  */
...
#define LL_DMAMUX_SYNC_EXTI_LINE11                                                                 \
    (DMAMUX_CxCR_SYNC_ID_3 | DMAMUX_CxCR_SYNC_ID_1 | DMAMUX_CxCR_SYNC_ID_0) /*!< Synchronization   \
                                                                               signal from EXTI    \
                                                                               Line11 */
...
#define LL_DMAMUX_SYNC_EXTI_LINE13                                                                 \
    (DMAMUX_CxCR_SYNC_ID_3 | DMAMUX_CxCR_SYNC_ID_2 | DMAMUX_CxCR_SYNC_ID_0) /*!< Synchronization   \
                                                                               signal from EXTI    \
                                                                               Line13 */
#define LL_DMAMUX_SYNC_EXTI_LINE14                                                                 \
    (DMAMUX_CxCR_SYNC_ID_3 | DMAMUX_CxCR_SYNC_ID_2 | DMAMUX_CxCR_SYNC_ID_1) /*!< Synchronization   \
                                                                               signal from EXTI    \
                                                                               Line14 */
...
#define LL_DMAMUX_SYNC_LPTIM1_OUT                                                                  \
    (DMAMUX_CxCR_SYNC_ID_4 | DMAMUX_CxCR_SYNC_ID_1) /*!< Synchronization signal from LPTIM1 Output \
                                                     */
#define LL_DMAMUX_SYNC_LPTIM2_OUT                                                                  \
    (DMAMUX_CxCR_SYNC_ID_4 | DMAMUX_CxCR_SYNC_ID_1 | DMAMUX_CxCR_SYNC_ID_0) /*!< Synchronization   \
                                                                               signal from LPTIM2  \
                                                                               Output */
#define LL_DMAMUX_SYNC_LPTIM3_OUT                                                                  \
    (DMAMUX_CxCR_SYNC_ID_4 | DMAMUX_CxCR_SYNC_ID_2) /*!< Synchronization signal from LPTIM3 Output \
                                                     */
/**
 * @}
 */
...
#define LL_DMAMUX_REQ_GEN_EXTI_LINE7                                                               \
    (DMAMUX_RGxCR_SIG_ID_2 | DMAMUX_RGxCR_SIG_ID_1 | DMAMUX_RGxCR_SIG_ID_0) /*!< Request signal    \
                                                                               generation from     \
                                                                               EXTI Line7  */
...
#define LL_DMAMUX_REQ_GEN_EXTI_LINE11                                                              \
    (DMAMUX_RGxCR_SIG_ID_3 | DMAMUX_RGxCR_SIG_ID_1 | DMAMUX_RGxCR_SIG_ID_0) /*!< Request signal    \
                                                                               generation from     \
                                                                               EXTI Line11 */
...
#define LL_DMAMUX_REQ_GEN_EXTI_LINE13                                                              \
    (DMAMUX_RGxCR_SIG_ID_3 | DMAMUX_RGxCR_SIG_ID_2 | DMAMUX_RGxCR_SIG_ID_0) /*!< Request signal    \
                                                                               generation from     \
                                                                               EXTI Line13 */
#define LL_DMAMUX_REQ_GEN_EXTI_LINE14                                                              \
    (DMAMUX_RGxCR_SIG_ID_3 | DMAMUX_RGxCR_SIG_ID_2 | DMAMUX_RGxCR_SIG_ID_1) /*!< Request signal    \
                                                                               generation from     \
                                                                               EXTI Line14 */
...
#define LL_DMAMUX_REQ_GEN_LPTIM1_OUT                                                               \
    (DMAMUX_RGxCR_SIG_ID_4 | DMAMUX_RGxCR_SIG_ID_1) /*!< Request signal generation from LPTIM1     \
                                                       Output */
#define LL_DMAMUX_REQ_GEN_LPTIM2_OUT                                                               \
    (DMAMUX_RGxCR_SIG_ID_4 | DMAMUX_RGxCR_SIG_ID_1 | DMAMUX_RGxCR_SIG_ID_0) /*!< Request signal    \
                                                                               generation from     \
                                                                               LPTIM2 Output */
#define LL_DMAMUX_REQ_GEN_LPTIM3_OUT                                                               \
    (DMAMUX_RGxCR_SIG_ID_4 | DMAMUX_RGxCR_SIG_ID_2) /*!< Request signal generation from LPTIM3     \
                                                       Output */
/**
 * @}
 */
