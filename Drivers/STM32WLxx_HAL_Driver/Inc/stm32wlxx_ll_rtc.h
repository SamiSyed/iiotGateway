...
#define LL_RTC_TAMPER_ITAMP6                                                   \
  TAMP_CR1_ITAMP6E /*!< Internal tamper 6: JTAG access in RDP level 1 */
 ...
 * and RTC_DR) and prescaler register (RTC_PRER), plus BIN and BCDU fields.
 *         Counters are stopped and start counting from the new value when INIT
 * is reset.
 ...
 * @note   Bit is write-protected. @ref LL_RTC_DisableWriteProtection function
 * should be called before.
 * @note Bit can be written only when RTC_CR WUTE bit = 0 and RTC_ICSR WUTWF bit
 * = 1
