...
typedef struct
{
    ...
    uint32_t AlarmMask; /*!< Specifies the RTC Alarm Masks.
                           ...
                           or @ref RTC_LL_EC_ALMB_MASK for ALARM B.
                             ...
                             This feature can be modified afterwards using unitary function @ref
                           LL_RTC_ALMA_SetMask() for ALARM A or @ref LL_RTC_ALMB_SetMask() for ALARM
                           B
                        */
...
#define LL_RTC_ALMA_SUBSECONDBIN_AUTOCLR_YES                                                       \
    RTC_ALRMASSR_SSCLR /*!<  The synchronous binary counter (SS[31:0] in RTC_SSR) is running from  \
                          ...
                          reloaded with 0xFFFF FFFF when reaching RTC_ALRMABINR -> SS[31:0]. */
/**
 * @}
 */
...
#define LL_RTC_ALMB_SUBSECONDBIN_AUTOCLR_YES                                                       \
    RTC_ALRMBSSR_SSCLR /*!<  The synchronous binary counter (SS[31:0] in RTC_SSR) is running from  \
                          0xFFFF FFFF to RTC_ALRMABINR -> SS[31:0] value and is automatically                                              \
                          reloaded with 0xFFFF FFFF when reaching RTC_ALRMABINR -> SS[31:0]. */
/**
 * @}
...
#define LL_RTC_TAMPER_MASK_TAMPER3                                                                 \
    TAMP_CR2_TAMP3MSK /*!< Tamper 3 event generates a trigger event. TAMP2F is masked and          \
                         internally cleared by hardware. The backup registers are not erased. */
/**
 * @}
 */
...
#define LL_RTC_TAMPER_SAMPLFREQDIV_4096                                                            \
    (TAMP_FLTCR_TAMPFREQ_1 | TAMP_FLTCR_TAMPFREQ_0) /*!< Each of the tamper inputs are sampled     \
...
#define LL_RTC_TAMPER_SAMPLFREQDIV_1024                                                            \
    (TAMP_FLTCR_TAMPFREQ_2 | TAMP_FLTCR_TAMPFREQ_0) /*!< Each of the tamper inputs are sampled     \
                                                       with a frequency =  RTCCLK / 1024 */
#define LL_RTC_TAMPER_SAMPLFREQDIV_512                                                             \
    (TAMP_FLTCR_TAMPFREQ_2 | TAMP_FLTCR_TAMPFREQ_1) /*!< Each of the tamper inputs are sampled     \
...
#define LL_RTC_BINARY_MIX_BCDU_0                                                                   \
    0x00000000u /*!<  1s calendar increment is generated each time SS[7:0] = 0 */
...
__STATIC_INLINE uint32_t LL_RTC_TS_GetTime(RTC_TypeDef *RTCx)
{
    return (uint32_t)(READ_BIT(RTCx->TSTR,
                               RTC_TSTR_HT | RTC_TSTR_HU | RTC_TSTR_MNT | RTC_TSTR_MNU | RTC_TSTR_ST
                                   | RTC_TSTR_SU));
}
