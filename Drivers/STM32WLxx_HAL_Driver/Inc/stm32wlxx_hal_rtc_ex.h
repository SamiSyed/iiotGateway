...
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV256                                                       \
    (TAMP_FLTCR_TAMPFREQ_0 | TAMP_FLTCR_TAMPFREQ_1 | TAMP_FLTCR_TAMPFREQ_2) /*!< Each of the       \
                                                                               tamper inputs are   \
                                                                               sampled with a                                                                                            \
                                                                               frequency =  RTCCLK \
                                                                               / 256   */
...
#define RTC_IT_INT_TAMP_ALL                                                                        \
    (TAMP_IER_ITAMP3IE | TAMP_IER_ITAMP5IE | TAMP_IER_ITAMP6IE | TAMP_IER_ITAMP8IE)
/**
 * @}
 */
...
#define RTC_FLAG_INT_TAMP_ALL                                                                      \
    (RTC_FLAG_INT_TAMP3 | RTC_FLAG_INT_TAMP5 | RTC_FLAG_INT_TAMP6 | RTC_FLAG_INT_TAMP8)
/**
 * @}
 */
...
#define RTC_BINARY_MIX_BCDU_0                                                                      \
    0x00000000u /*!<  The 1s BCD calendar increment is generated each time SS[7:0] = 0 */
...
/** @defgroup RTCEx_Alarm_Sub_Seconds_binary_Masks_Definitions RTC Alarm Sub Seconds with binary
 * mode Masks Definitions
 * @{
 */
...
/** @defgroup RTCEx_Alarm_Sub_Seconds_binary_Clear_Definitions RTC Alarm Sub Seconds with binary
...
#define RTC_ALARMSUBSECONDBIN_AUTOCLR_YES                                                          \
    RTC_ALRMASSR_SSCLR /*!<  The synchronous Binary counter (SS[31:0] in RTC_SSR) is running from  \
                          0xFFFF FFFF to RTC_ALRMABINR -> SS[31:0] value and is automatically                                              \
                          reloaded with 0xFFFF FFFF whenreaching RTC_ALRMABINR -> SS[31:0]. */
/**
 * @}
 */
...
#define __HAL_RTC_GET_FLAG(__HANDLE__, __FLAG__)                                                   \
    (((((__FLAG__)) >> 8U) == 1U) ? (RTC->ICSR & (1U << (((uint16_t)(__FLAG__)) & RTC_FLAG_MASK))) \
 ...
 * @{
 */
/*#define RTC_EXTI_LINE_ALARM_EVENT           EXTI_IMR1_IM17 */ /*!< External interrupt line 17
...
#define RTC_EXTI_LINE_TIMESTAMP_EVENT                                                              \
    EXTI_IMR1_IM19 /*!< External interrupt line 19 Connected to the RTC Time Stamp events */
