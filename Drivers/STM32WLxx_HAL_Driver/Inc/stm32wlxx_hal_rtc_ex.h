...
#define RTC_INT_TAMPER_ALL                                                     \
  (TAMP_CR1_ITAMP3E | TAMP_CR1_ITAMP5E | TAMP_CR1_ITAMP6E | TAMP_CR1_ITAMP8E)
/**
 * @}
 */
...
#define RTC_FLAG_INT_TAMP_ALL                                                  \
  (RTC_FLAG_INT_TAMP3 | RTC_FLAG_INT_TAMP5 | RTC_FLAG_INT_TAMP6 |              \
   RTC_FLAG_INT_TAMP8)
/**
 * @}
 */
...
#define RTC_BINARY_NONE                                                        \
  0x00000000u /*!< Free running BCD calendar mode (Binary mode disabled). */
#define RTC_BINARY_ONLY                                                        \
  RTC_ICSR_BIN_0 /*!< Free running Binary mode (BCD mode disabled) */
#define RTC_BINARY_MIX                                                         \
  RTC_ICSR_BIN_1 /*!< Free running BCD calendar and Binary mode */
/**
 * @}
 */
...
#define RTC_BINARY_MIX_BCDU_0                                                  \
  0x00000000u /*!<  The 1s BCD calendar increment is generated each time       \
                 SS[7:0] = 0 */
 ...
 * Seconds with binary mode Masks Definitions
 * @{
 */
...
#define RTC_ALARMSUBSECONDBINMASK_SS31                                         \
  (31UL                                                                        \
   << RTC_ALRMASSR_MASKSS_Pos) /*!< SS[31] is don't care in Alarm              \
                                 comparison. Only SS[30:0] are compared  */
#define RTC_ALARMSUBSECONDBINMASK_NONE                                         \
  (32UL << RTC_ALRMASSR_MASKSS_Pos) /*!< SS[31:0] are compared and must match  \
                                       to activate alarm. */
/**
 * @}
 */
...
#define RTC_ALARMSUBSECONDBIN_AUTOCLR_NO                                       \
  0UL /*!<  The synchronous Binary counter (SS[31:0] in RTC_SSR) is            \
         free-running. */
#define RTC_ALARMSUBSECONDBIN_AUTOCLR_YES                                      \
  RTC_ALRMASSR_SSCLR /*!<  The synchronous Binary counter (SS[31:0] in         \
                        RTC_SSR) is running from 0xFFFF FFFF to RTC_ALRMABINR                                                                 \
                        -> SS[31:0] value and is automatically reloaded with   \
...
#define __HAL_RTC_TIMESTAMP_EXTI_ENABLE_IT()                                   \
  (EXTI->C2IMR1 |= RTC_EXTI_LINE_TIMESTAMP_EVENT)
...
#define __HAL_RTC_SSRU_GET_IT(__HANDLE__, __INTERRUPT__)                       \
  (((RTC->MISR) & ((__INTERRUPT__) >> 1) != 0U) ? 1U : 0U)
/**
 * @brief  Check whether the specified RTC Wake Up timer interrupt has been
 * enabled or not.
 * @param  __HANDLE__ specifies the RTC handle.
...
#define __HAL_RTC_SSRU_CLEAR_FLAG(__HANDLE__, __FLAG__)                        \
  (__HAL_RTC_CLEAR_FLAG((__HANDLE__), RTC_CLEAR_SSRUF))

/* SSR Underflow EXTI */
/* ------------------ */
#if defined(CORE_CM0PLUS)
#define __HAL_RTC_SSRU_EXTI_ENABLE_IT()                                        \
  (EXTI->C2IMR1 |= RTC_EXTI_LINE_SSRU_EVENT)
#define __HAL_RTC_SSRU_EXTI_DISABLE_IT()                                       \
  (EXTI->C2IMR1 &= ~(RTC_EXTI_LINE_SSRU_EVENT))
#define __HAL_RTC_SSRU_EXTI_ENABLE_EVENT()                                     \
  (EXTI->C2EMR1 |= RTC_EXTI_LINE_SSRU_EVENT)
#define __HAL_RTC_SSRU_EXTI_DISABLE_EVENT()                                    \
  (EXTI->C2EMR1 &= ~(RTC_EXTI_LINE_SSRU_EVENT))
#else
#define __HAL_RTC_SSRU_EXTI_ENABLE_IT() (EXTI->IMR1 |= RTC_EXTI_LINE_SSRU_EVENT)
#define __HAL_RTC_SSRU_EXTI_DISABLE_IT()                                       \
  (EXTI->IMR1 &= ~(RTC_EXTI_LINE_SSRU_EVENT))
#define __HAL_RTC_SSRU_EXTI_ENABLE_EVENT()                                     \
  (EXTI->EMR1 |= RTC_EXTI_LINE_SSRU_EVENT)
#define __HAL_RTC_SSRU_EXTI_DISABLE_EVENT()                                    \
  (EXTI->EMR1 &= ~(RTC_EXTI_LINE_SSRU_EVENT))
#endif
 ...
 * @{
 */
/*#define RTC_EXTI_LINE_ALARM_EVENT           EXTI_IMR1_IM17 */ /*!< External
                                                                   interrupt
                                                                   line 17
                                                                   Connected to
                                                                   the RTC Alarm
...
#define RTC_EXTI_LINE_SSRU_EVENT                                               \
  EXTI_IMR1_IM18 /*!< External interrupt line 18 Connected to the RTC SSR      \
                    Underflow event  */
#define RTC_EXTI_LINE_TIMESTAMP_EVENT                                          \
  EXTI_IMR1_IM19 /*!< External interrupt line 19 Connected to the RTC Time     \
                    Stamp events */
...
#define RTC_EXTI_LINE_TAMPER_EVENT                                             \
  EXTI_IMR1_IM19 /*!< External interrupt line 19 Connected to the RTC tamper   \
                    events */
/**
 * @}
 */
