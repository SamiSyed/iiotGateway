...
#define LL_PKA_MODE_MODULAR_EXP                                                \
  ((uint32_t)0x00000002U) /*!< Compute modular exponentiation only (Montgomery \
                             parameter should be loaded) */
#define LL_PKA_MODE_MONTGOMERY_PARAM_ECC                                       \
  ((uint32_t)0x00000020U) /*!< Compute Montgomery parameter and compute ECC kP \
                             operation */
#define LL_PKA_MODE_ECC_KP_PRIMITIVE                                           \
  ((uint32_t)0x00000022U) /*!< Compute the ECC kP primitive only (Montgomery   \
                             parameter should be loaded) */
