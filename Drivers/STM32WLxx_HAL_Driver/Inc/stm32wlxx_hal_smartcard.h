...
typedef struct {
  ...
  uint16_t NACKEnable; /*!< Specifies whether the SmartCard NACK transmission is
                          enabled in case of parity error.
                            This parameter can be a value of @ref
...
typedef struct __SMARTCARD_HandleTypeDef {
  ...
  __IO HAL_SMARTCARD_StateTypeDef
      gState; /*!< SmartCard state information related to global Handle
                 management and also related to Tx operations. This parameter
                 can be a value of @ref HAL_SMARTCARD_StateTypeDef */
 ...
 * @note   The maximum Baud Rate is derived from the maximum clock on WB (48
