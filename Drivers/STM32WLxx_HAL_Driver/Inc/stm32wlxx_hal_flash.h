...
typedef struct
{
    uint32_t OptionType;     /*!< Option byte to be configured.
                                  This parameter can be a combination of the values of @ref
                                FLASH_OB_TYPE */
    ...
    uint32_t PCROP1AStartAddr; /*!< PCROP Zone A Start address (used for OPTIONBYTE_PCROP). It
                                  represents first address of start block
                                    to protect. Make sure this parameter is multiple of PCROP
                                  granularity */
    ...
    uint32_t SecureFlashStartAddr;    /*!< Secure Flash start address (used for
                                         ...
                                         between begin and end of Flash bank
                                           => Contains the start address of the first 2kB page of the
                                         secure Flash area */
    uint32_t SecureSRAM2StartAddr;    /*!< Secure Backup SRAM2 start address (used for
                                         OPTIONBYTE_SECURE_MODE).
                                           This parameter must be aligned on 1kB boundary */
    uint32_t SecureSRAM1StartAddr;    /*!< Secure non-Backup SRAM1 start address (used for
                                         OPTIONBYTE_SECURE_MODE)
                                           This parameter must be aligned on 1kB boundary */
    uint32_t HideProtectionStartAddr; /*!< Hide Protection area start address (used for
                                         OPTIONBYTE_SECURE_MODE) This parameter must be aligned on
                                         2kB boundary */
    uint32_t SecureMode;              /*!< Secure mode activated or deactivated.
                                           This parameter can be a value of @ref FLASH_OB_SECURITY_MODE */
    uint32_t SUBGHZSPISecureAccess; /*!< Sub-GHz radio SPI security access enabled or disabled (used
                                       for OPTIONBYTE_SUBGHZSPI_SECURE_ACCESS). This parameter can
                                       be a value of @ref FLASH_OB_SUBGHZSPI_SECURE_ACCESS */
    uint32_t C2DebugAccessMode;     /*!< CPU2 debug access enabled or disabled (used for
                                       OPTIONBYTE_C2_DEBUG_ACCESS).     This parameter can be a value of
                                       @ref FLASH_OB_C2_DEBUG_ACCESS */
    ...
    uint32_t IPCCdataBufAddr;      /*!< IPCC mailbox data buffer base address (used for
                                      ...
                                      data buffer start address area      in SRAM1 or SRAM2. Make sure this
...
#define FLASH_TYPEPROGRAM_FAST                                                                     \
    FLASH_CR_FSTPG /*!< Fast program a 32 double-word (64-bit) row at a specified address.         \
...
#define OPTIONBYTE_ALL                                                                             \
    (OPTIONBYTE_WRP | OPTIONBYTE_RDP | OPTIONBYTE_USER | OPTIONBYTE_PCROP                          \
     ...
     | OPTIONBYTE_C2_DEBUG_ACCESS | OPTIONBYTE_SUBGHZSPI_SECURE_ACCESS) /*!< All option byte       \
                                                                           configuration */
#else

#define OPTIONBYTE_ALL                                                                             \
    (OPTIONBYTE_WRP | OPTIONBYTE_RDP | OPTIONBYTE_USER | OPTIONBYTE_PCROP) /*!< All option byte    \
                                                                              configuration */
#endif                                                                     /* DUAL_CORE */
...
#define OB_USER_ALL                                                                                \
    (OB_USER_BOR_LEV | OB_USER_nRST_STOP | OB_USER_nRST_STDBY | OB_USER_nRST_SHDW                  \
     | OB_USER_IWDG_SW | OB_USER_IWDG_STOP | OB_USER_IWDG_STDBY | OB_USER_WWDG_SW | OB_USER_nBOOT1 \
     | OB_USER_SRAM2_PE | OB_USER_SRAM_RST | OB_USER_nSWBOOT0 | OB_USER_nBOOT0 | OB_USER_BOOT_LOCK \
     | OB_USER_C2BOOT_LOCK) /*!< all option bits */
#else
#define OB_USER_ALL                                                                                \
    (OB_USER_BOR_LEV | OB_USER_nRST_STOP | OB_USER_nRST_STDBY | OB_USER_nRST_SHDW                  \
     | OB_USER_IWDG_SW | OB_USER_IWDG_STOP | OB_USER_IWDG_STDBY | OB_USER_WWDG_SW | OB_USER_nBOOT1 \
     | OB_USER_SRAM2_PE | OB_USER_SRAM_RST | OB_USER_nSWBOOT0 | OB_USER_nBOOT0                     \
...
#define OB_SECURE_SYSTEM_AND_ALL_AREAS_ENABLE                                                      \
    (OB_SECURE_SYSTEM_AND_FLASH_ENABLE | OB_SECURE_HIDE_PROTECTION_ENABLE | OB_SECURE_SRAM1_ENABLE \
     | OB_SECURE_SRAM2_ENABLE) /*!< All System in Secure mode : Security enabled on all areas */
...
#define OB_C2_DEBUG_ACCESS_ENABLE                                                                  \
    0x00000000U /*!< CPU2 debug access enabled (when also enabled by FLASH_ACR2_C2SWDBGEN) */
/**
 * @}
 */
...
#define SRAM_SECURE_PAGE_GRANULARITY                                                               \
    (1UL << FLASH_PCROP_GRANULARITY_OFFSET) /*!< Secure SRAM1 and SRAM2 Protection granularity,    \
                                               1KBytes */
/**
 * @}
 */
...
#define IS_FLASH_TYPEERASE(__VALUE__)                                                              \
    (((__VALUE__) == FLASH_TYPEERASE_PAGES) || ((__VALUE__) == FLASH_TYPEERASE_MASSERASE))
...
#define IS_OB_SBRSA_START_ADDR(__VALUE__)                                                          \
    (((__VALUE__) >= SRAM2_BASE) && ((__VALUE__) <= (SRAM2_BASE + SRAM2_SIZE))                     \
     && (((__VALUE__) & ~0x3FFU) == (__VALUE__)))
#define IS_OB_SNBRSA_START_ADDR(__VALUE__)                                                         \
    (((__VALUE__) >= SRAM1_BASE) && ((__VALUE__) <= (SRAM1_BASE + SRAM1_SIZE))                     \
     && (((__VALUE__) & ~0x3FFU) == (__VALUE__)))

#define IS_OB_SECURE_MODE(__VALUE__)                                                               \
    ((((__VALUE__)                                                                                 \
       & (OB_SECURE_SYSTEM_AND_ALL_AREAS_ENABLE | OB_SECURE_SYSTEM_AND_ALL_AREAS_DISABLE))         \
      != 0U)                                                                                       \
     && (((__VALUE__)                                                                              \
          & ~(OB_SECURE_SYSTEM_AND_ALL_AREAS_ENABLE | OB_SECURE_SYSTEM_AND_ALL_AREAS_DISABLE))     \
         == 0U)                                                                                    \
     && (((__VALUE__) & (OB_SECURE_SYSTEM_AND_FLASH_ENABLE | OB_SECURE_SYSTEM_AND_FLASH_DISABLE))  \
         != (OB_SECURE_SYSTEM_AND_FLASH_ENABLE | OB_SECURE_SYSTEM_AND_FLASH_DISABLE))              \
     && (((__VALUE__) & (OB_SECURE_HIDE_PROTECTION_ENABLE | OB_SECURE_HIDE_PROTECTION_DISABLE))    \
...
#define IS_OPTIONBYTE(__VALUE__)                                                                   \
    ((__VALUE__) <= (OPTIONBYTE_WRP | OPTIONBYTE_RDP | OPTIONBYTE_USER | OPTIONBYTE_PCROP          \
                     | OPTIONBYTE_IPCC_BUF_ADDR | OPTIONBYTE_C2_BOOT_VECT | OPTIONBYTE_SECURE_MODE \
...
#define IS_OB_C2_DEBUG_MODE(__VALUE__)                                                             \
    (((__VALUE__) == OB_C2_DEBUG_ACCESS_ENABLE) || ((__VALUE__) == OB_C2_DEBUG_ACCESS_DISABLE))
#endif /* DUAL_CORE */
