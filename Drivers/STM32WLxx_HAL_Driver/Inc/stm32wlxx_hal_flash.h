...
typedef struct {
  ...
  uint32_t
      UserConfig; /*!< Value of the user option byte (used for OPTIONBYTE_USER).
                     ...
                     FLASH_OB_USER_nBOOT0,
                           @ref FLASH_OB_USER_BOOT_LOCK, @ref
                     FLASH_OB_USER_C2BOOT_LOCK */
#else
  uint32_t
      UserConfig; /*!< Value of the user option byte (used for OPTIONBYTE_USER).
                       This parameter can be a combination of the values of
  ...
  uint32_t PCROP1AStartAddr; /*!< PCROP Zone A Start address (used for
  ...
  uint32_t
      PCROP1AEndAddr; /*!< PCROP Zone A End address (used for OPTIONBYTE_PCROP).
                         It represents first address of end block to protect.
                         Make sure this parameter is multiple of PCROP
                         granularity */
  uint32_t PCROP1BStartAddr; /*!< PCROP Zone B Start address (used for
                                OPTIONBYTE_PCROP). It represents first address
                                of start block to protect. Make sure this
                                parameter is multiple of PCROP granularity */
  uint32_t
      PCROP1BEndAddr; /*!< PCROP Zone B End address (used for OPTIONBYTE_PCROP).
                         It represents first address of end block to protect.
                         Make sure this parameter is multiple of PCROP
                         granularity */
#if defined(DUAL_CORE)
  uint32_t
      SecureFlashStartAddr; /*!< Secure Flash start address (used for
                               OPTIONBYTE_SECURE_MODE). This parameter must be a
                               value between begin and end of Flash bank
                                 => Contains the start address of the first 2kB
                               page of the secure Flash area */
  uint32_t
      SecureSRAM2StartAddr; /*!< Secure Backup SRAM2 start address (used for
                               OPTIONBYTE_SECURE_MODE). This parameter must be
                               aligned on 1kB boundary */
  uint32_t SecureSRAM1StartAddr;    /*!< Secure non-Backup SRAM1 start address
                                       (used for OPTIONBYTE_SECURE_MODE)    This
                                       parameter must be aligned on 1kB boundary */
  uint32_t HideProtectionStartAddr; /*!< Hide Protection area start address
                                       (used for OPTIONBYTE_SECURE_MODE) This
                                       parameter must be aligned on 2kB boundary
                                     */
  uint32_t SecureMode;              /*!< Secure mode activated or deactivated.
                                         This parameter can be a value of @ref
                                       FLASH_OB_SECURITY_MODE */
  uint32_t SUBGHZSPISecureAccess; /*!< Sub-GHz radio SPI security access enabled
                                     or disabled (used for
                                     OPTIONBYTE_SUBGHZSPI_SECURE_ACCESS). This
                                     parameter can be a value of @ref
                                     FLASH_OB_SUBGHZSPI_SECURE_ACCESS */
  uint32_t C2DebugAccessMode; /*!< CPU2 debug access enabled or disabled (used
                                 for OPTIONBYTE_C2_DEBUG_ACCESS).
                                   This parameter can be a value of @ref
                                 FLASH_OB_C2_DEBUG_ACCESS */
  uint32_t C2BootRegion;      /*!< CPU2 Secure Boot memory region(used for
                                 OPTIONBYTE_C2_BOOT_VECT).      This parameter can be a
                                 value of @ref FLASH_OB_C2_BOOT_REGION */
  uint32_t
      C2SecureBootVectAddr; /*!< CPU2 Secure Boot reset vector (used for
                               OPTIONBYTE_C2_BOOT_VECT). This parameter contains
                               the CPU2 boot reset start address within the
                               selected memory region. Make sure this parameter
                               is word aligned. */
  uint32_t IPCCdataBufAddr; /*!< IPCC mailbox data buffer base address (used for
                               OPTIONBYTE_IPCC_BUF_ADDR). This parameter
                               contains the IPCC mailbox data buffer start
                               address area in SRAM1 or SRAM2. Make sure this
                               parameter is double-word aligned. */
#endif                      /* DUAL_CORE */
...
typedef struct {
  ...
  uint32_t ProcedureOnGoing; /* Internal variable to indicate which procedure is
                                ongoing or not in IT context */
  uint32_t Address; /* Internal variable to save address selected for program in
                       IT context */
...
#define FLASH_FLAG_OPERR                                                       \
  FLASH_C2SR_OPERR /*!< CPU2 FLASH Operation error flag */
#define FLASH_FLAG_PROGERR                                                     \
  FLASH_C2SR_PROGERR /*!< CPU2 FLASH Programming error flag */
#define FLASH_FLAG_WRPERR                                                      \
  FLASH_C2SR_WRPERR /*!< CPU2 FLASH Write protection error flag */
#define FLASH_FLAG_PGAERR                                                      \
  FLASH_C2SR_PGAERR /*!< CPU2 FLASH Programming alignment error flag */
#define FLASH_FLAG_SIZERR FLASH_C2SR_SIZERR /*!< CPU2 FLASH Size error flag */
#define FLASH_FLAG_PGSERR                                                      \
  FLASH_C2SR_PGSERR /*!< CPU2 FLASH Programming sequence error flag */
#define FLASH_FLAG_MISERR                                                      \
  FLASH_C2SR_MISERR /*!< CPU2 FLASH Fast programming data miss error flag */
#define FLASH_FLAG_FASTERR                                                     \
  FLASH_C2SR_FASTERR /*!< CPU2 FLASH Fast programming error flag */
#define FLASH_FLAG_OPTNV                                                       \
  FLASH_C2SR_OPTNV /*!< CPU2 FLASH User Option OPTVAL indication */
#define FLASH_FLAG_RDERR                                                       \
  FLASH_C2SR_RDERR /*!< CPU2 FLASH PCROP read error flag */
...
#define FLASH_FLAG_CFGBSY                                                      \
  FLASH_C2SR_CFGBSY /*!< CPU2 FLASH Programming/erase configuration busy */
#define FLASH_FLAG_PESD                                                        \
  FLASH_C2SR_PESD /*!< CPU2 FLASH Programming/erase operation suspended */
#else
...
#define FLASH_IT_ECCC                                                          \
  (FLASH_ECCR_ECCCIE >>                                                        \
   FLASH_ECCR_ECCCIE_Pos) /*!< ECC Correction Interrupt source */
/**
 * @}
 */
...
#define FLASH_TYPEERASE_MASSERASE                                              \
  FLASH_CR_MER /*!< Flash mass erase activation*/
/**
 * @}
 */
...
#define FLASH_TYPEPROGRAM_FAST                                                 \
  FLASH_CR_FSTPG /*!< Fast program a 32 double-word (64-bit) row at a          \
                    specified address.                                         \
                      And another 32 double-word (64-bit) row will be          \
                    programmed */
/**
 * @}
 */
...
#define OPTIONBYTE_WRP                                                         \
  0x00000001U /*!< WRP option byte configuration             */
#define OPTIONBYTE_RDP                                                         \
  0x00000002U /*!< RDP option byte configuration             */
#define OPTIONBYTE_USER                                                        \
  0x00000004U /*!< User option byte configuration            */
#define OPTIONBYTE_PCROP                                                       \
  0x00000008U /*!< PCROP option byte configuration           */
#if defined(DUAL_CORE)
#define OPTIONBYTE_IPCC_BUF_ADDR                                               \
  0x00000010U /*!< IPCC mailbox buffer address configuration */
#define OPTIONBYTE_C2_BOOT_VECT                                                \
  0x00000100U /*!< CPU2 Secure Boot reset vector             */
#define OPTIONBYTE_SECURE_MODE                                                 \
  0x00000200U /*!< Secure mode on activated or not           */
#define OPTIONBYTE_C2_DEBUG_ACCESS                                             \
  0x00000400U /*!< CPU2 debug access enabled or disabled     */
#define OPTIONBYTE_SUBGHZSPI_SECURE_ACCESS                                     \
  0x00000800U /*!< Sub-GHz radio SPI security access enabled or disabled  */
...
#define OPTIONBYTE_ALL                                                         \
  (OPTIONBYTE_WRP | OPTIONBYTE_RDP | OPTIONBYTE_USER | OPTIONBYTE_PCROP |      \
   ...
   OPTIONBYTE_SECURE_MODE | OPTIONBYTE_C2_DEBUG_ACCESS |                       \
   OPTIONBYTE_SUBGHZSPI_SECURE_ACCESS) /*!< All option byte configuration */
#else
...
#define OB_USER_SRAM_RST                                                       \
  FLASH_OPTR_SRAM_RST /*!< SRAM1 and SRAM2 erase when system reset */
#define OB_USER_nSWBOOT0 FLASH_OPTR_nSWBOOT0 /*!< Software BOOT0 */
#define OB_USER_nBOOT0 FLASH_OPTR_nBOOT0     /*!< nBOOT0 option bit */
#define OB_USER_BOOT_LOCK                                                      \
  FLASH_OPTR_BOOT_LOCK /*!< CPU1 Boot Lock enable option bit */
#if defined(DUAL_CORE)
#define OB_USER_C2BOOT_LOCK                                                    \
  FLASH_OPTR_C2BOOT_LOCK /*!< CPU2 Boot Lock enable option bit */
#endif

#if defined(DUAL_CORE)
#define OB_USER_ALL                                                            \
  (OB_USER_BOR_LEV | OB_USER_nRST_STOP | OB_USER_nRST_STDBY |                  \
   OB_USER_nRST_SHDW | OB_USER_IWDG_SW | OB_USER_IWDG_STOP |                   \
   OB_USER_IWDG_STDBY | OB_USER_WWDG_SW | OB_USER_nBOOT1 | OB_USER_SRAM2_PE |  \
   OB_USER_SRAM_RST | OB_USER_nSWBOOT0 | OB_USER_nBOOT0 | OB_USER_BOOT_LOCK |  \
   OB_USER_C2BOOT_LOCK) /*!< all option bits */
#else
#define OB_USER_ALL                                                            \
  (OB_USER_BOR_LEV | OB_USER_nRST_STOP | OB_USER_nRST_STDBY |                  \
   OB_USER_nRST_SHDW | OB_USER_IWDG_SW | OB_USER_IWDG_STOP |                   \
   OB_USER_IWDG_STDBY | OB_USER_WWDG_SW | OB_USER_nBOOT1 | OB_USER_SRAM2_PE |  \
   OB_USER_SRAM_RST | OB_USER_nSWBOOT0 | OB_USER_nBOOT0 |                      \
   OB_USER_BOOT_LOCK) /*!< all option bits */
#endif
...
#define OB_BOR_LEVEL_1                                                         \
  FLASH_OPTR_BOR_LEV_0 /*!< Reset level threshold is around 2.0V */
#define OB_BOR_LEVEL_2                                                         \
  FLASH_OPTR_BOR_LEV_1 /*!< Reset level threshold is around 2.2V */
#define OB_BOR_LEVEL_3                                                         \
  (FLASH_OPTR_BOR_LEV_0 |                                                      \
   FLASH_OPTR_BOR_LEV_1) /*!< Reset level threshold is around 2.5V */
#define OB_BOR_LEVEL_4                                                         \
  FLASH_OPTR_BOR_LEV_2 /*!< Reset level threshold is around 2.8V */
/**
 * @}
 */
...
#define OB_SRAM2_PARITY_DISABLE                                                \
  FLASH_OPTR_SRAM2_PE /*!< SRAM2 parity check disable */
/**
 * @}
 */

/** @defgroup FLASH_OB_USER_SRAM_RST FLASH Option Bytes SRAM1 and SRAM2 erase
 * when system reset
 * @{
 */
#define OB_SRAM_RST_ERASE                                                      \
  0x00000000U /*!< SRAM2 and SRAM1 erased when a system reset        */
#define OB_SRAM_RST_NOT_ERASE                                                  \
  FLASH_OPTR_SRAM_RST /*!< SRAM2 and SRAM1 is not erased when a system reset   \
                       */
/**
 * @}
 */
...
#define OB_BOOT0_FROM_PIN                                                      \
  FLASH_OPTR_nSWBOOT0 /*!< BOOT0 taken from PH3/BOOT0 pin         */
/**
 * @}
 */
...
/** @defgroup FLASH_OB_USER_BOOT_LOCK FLASH Option Bytes CPU1 Boot Lock option
 * bit
 * @{
 */
...
#if defined(DUAL_CORE)
/** @defgroup FLASH_OB_USER_C2BOOT_LOCK FLASH Option Bytes CPU2 Boot Lock option
 * bit
 * @{
 */
 ...
 * @{
 */
#define OB_SECURE_SYSTEM_AND_FLASH_ENABLE                                      \
  0x00000001U /*!< Flash and System secure area enabled  */
#define OB_SECURE_HIDE_PROTECTION_ENABLE                                       \
  0x00000002U /*!< Hide Protection area enabled          */
#define OB_SECURE_SRAM1_ENABLE                                                 \
  0x00000004U /*!< SRAM1 area enabled                    */
#define OB_SECURE_SRAM2_ENABLE                                                 \
  0x00000008U /*!< SRAM2 area enabled                    */
#define OB_SECURE_SYSTEM_AND_FLASH_DISABLE                                     \
  0x00000010U /*!< Flash and System secure area disabled */
#define OB_SECURE_HIDE_PROTECTION_DISABLE                                      \
  0x00000020U /*!< Hide Protection area disabled         */
#define OB_SECURE_SRAM1_DISABLE                                                \
  0x00000040U /*!< SRAM1 area disabled                   */
#define OB_SECURE_SRAM2_DISABLE                                                \
  0x00000080U /*!< SRAM2 area disabled                   */
#define OB_SECURE_SYSTEM_AND_ALL_AREAS_ENABLE                                  \
  (OB_SECURE_SYSTEM_AND_FLASH_ENABLE | OB_SECURE_HIDE_PROTECTION_ENABLE |      \
   OB_SECURE_SRAM1_ENABLE |                                                    \
   OB_SECURE_SRAM2_ENABLE) /*!< All System in Secure mode : Security enabled   \
                              on all areas */
#define OB_SECURE_SYSTEM_AND_ALL_AREAS_DISABLE                                 \
  (OB_SECURE_SYSTEM_AND_FLASH_DISABLE | OB_SECURE_HIDE_PROTECTION_DISABLE |    \
   OB_SECURE_SRAM1_DISABLE |                                                   \
   OB_SECURE_SRAM2_DISABLE) /*!< Unsecure mode: Security disabled      */
/**
 * @}
 */

/** @defgroup FLASH_OB_SUBGHZSPI_SECURE_ACCESS Option Bytes Sub-GHz radio SPI
 * Secure Access
 * @{
 */
#define OB_SUBGHZSPI_SECURE_ACCESS_DISABLE                                     \
  FLASH_SFR_SUBGHZSPISD /*!< Sub-GHz radio SPI Secure access disabled  */
#define OB_SUBGHZSPI_SECURE_ACCESS_ENABLE                                      \
  0x00000000U /*!< Sub-GHz radio SPI Secure access enabled   */
/**
 * @}
 */
 ...
 * @{
 */
#define OB_C2_DEBUG_ACCESS_DISABLE                                             \
  FLASH_SFR_DDS /*!< CPU2 debug access disabled   */
#define OB_C2_DEBUG_ACCESS_ENABLE                                              \
  0x00000000U /*!< CPU2 debug access enabled (when also enabled by             \
                 FLASH_ACR2_C2SWDBGEN) */
/**
 * @}
 */
...
#define OB_C2_BOOT_FROM_FLASH                                                  \
  FLASH_SRRVR_C2OPT /*!< CPU2 boot from Flash          */
/**
 * @}
 */
#endif /* DUAL_CORE */
...
#define __HAL_FLASH_ENABLE_IT(__INTERRUPT__)                                   \
  do {                                                                         \
    ...
    if (((__INTERRUPT__) & (~FLASH_IT_ECCC)) != 0U) {                          \
      SET_BIT(FLASH->C2CR, ((__INTERRUPT__) & (~FLASH_IT_ECCC)));              \
    }                                                                          \
  } while (0)
#else
#define __HAL_FLASH_ENABLE_IT(__INTERRUPT__)                                   \
...
#define __HAL_FLASH_DISABLE_IT(__INTERRUPT__)                                  \
  do {                                                                         \
    ...
    if (((__INTERRUPT__) & (~FLASH_IT_ECCC)) != 0U) {                          \
      CLEAR_BIT(FLASH->C2CR, ((__INTERRUPT__) & (~FLASH_IT_ECCC)));            \
    }                                                                          \
  } while (0)
#else
#define __HAL_FLASH_DISABLE_IT(__INTERRUPT__)                                  \
...
#define __HAL_FLASH_CLEAR_FLAG(__FLAG__)                                       \
  do {                                                                         \
    ...
    if (((__FLAG__)&FLASH_FLAG_OPTVERR) != 0U) {                               \
      SET_BIT(FLASH->SR, FLASH_FLAG_OPTVERR);                                  \
    }                                                                          \
    if (((__FLAG__) & ~(FLASH_FLAG_ECCR_ERRORS)) != 0U) {                      \
      WRITE_REG(FLASH->C2SR, ((__FLAG__) & ~(FLASH_FLAG_ECCR_ERRORS)));        \
    }                                                                          \
  } while (0)
#else
#define __HAL_FLASH_CLEAR_FLAG(__FLAG__)                                       \
...
#define SRAM_SECURE_PAGE_GRANULARITY_OFFSET                                    \
  10U /*!< Secure SRAM1 and SRAM2 Protection granularity offset */
#define SRAM_SECURE_PAGE_GRANULARITY                                           \
  (1UL                                                                         \
   << FLASH_PCROP_GRANULARITY_OFFSET) /*!< Secure SRAM1 and SRAM2 Protection   \
                                         granularity, 1KBytes */
/**
 * @}
 */
...
#define IS_OB_SFSA_START_ADDR(__VALUE__)                                       \
  (((__VALUE__) >= FLASH_BASE) && ((__VALUE__) <= FLASH_END_ADDR) &&           \
   (((__VALUE__) & ~0x7FFU) == (__VALUE__)))
#define IS_OB_HDPSA_START_ADDR(__VALUE__) IS_OB_SFSA_START_ADDR(__VALUE__)
#define IS_OB_SBRSA_START_ADDR(__VALUE__)                                      \
  (((__VALUE__) >= SRAM2_BASE) &&                                              \
   ((__VALUE__) <= (SRAM2_BASE + SRAM2_SIZE)) &&                               \
   (((__VALUE__) & ~0x3FFU) == (__VALUE__)))
#define IS_OB_SNBRSA_START_ADDR(__VALUE__)                                     \
  (((__VALUE__) >= SRAM1_BASE) &&                                              \
   ((__VALUE__) <= (SRAM1_BASE + SRAM1_SIZE)) &&                               \
   (((__VALUE__) & ~0x3FFU) == (__VALUE__)))

#define IS_OB_SECURE_MODE(__VALUE__)                                           \
  ((((__VALUE__) & (OB_SECURE_SYSTEM_AND_ALL_AREAS_ENABLE |                    \
                    OB_SECURE_SYSTEM_AND_ALL_AREAS_DISABLE)) != 0U) &&         \
   (((__VALUE__) & ~(OB_SECURE_SYSTEM_AND_ALL_AREAS_ENABLE |                   \
                     OB_SECURE_SYSTEM_AND_ALL_AREAS_DISABLE)) == 0U) &&        \
   (((__VALUE__) & (OB_SECURE_SYSTEM_AND_FLASH_ENABLE |                        \
                    OB_SECURE_SYSTEM_AND_FLASH_DISABLE)) !=                    \
    (OB_SECURE_SYSTEM_AND_FLASH_ENABLE |                                       \
     OB_SECURE_SYSTEM_AND_FLASH_DISABLE)) &&                                   \
   (((__VALUE__) & (OB_SECURE_HIDE_PROTECTION_ENABLE |                         \
                    OB_SECURE_HIDE_PROTECTION_DISABLE)) !=                     \
    (OB_SECURE_HIDE_PROTECTION_ENABLE | OB_SECURE_HIDE_PROTECTION_DISABLE)) && \
   (((__VALUE__) & (OB_SECURE_SRAM1_ENABLE | OB_SECURE_SRAM1_DISABLE)) !=      \
    (OB_SECURE_SRAM1_ENABLE | OB_SECURE_SRAM1_DISABLE)) &&                     \
   (((__VALUE__) & (OB_SECURE_SRAM2_ENABLE | OB_SECURE_SRAM2_DISABLE)) !=      \
    (OB_SECURE_SRAM2_ENABLE | OB_SECURE_SRAM2_DISABLE)))
#endif /* DUAL_CORE */
...
#define IS_OPTIONBYTE(__VALUE__)                                               \
  ((__VALUE__) <=                                                              \
   (OPTIONBYTE_WRP | OPTIONBYTE_RDP | OPTIONBYTE_USER | OPTIONBYTE_PCROP |     \
    OPTIONBYTE_IPCC_BUF_ADDR | OPTIONBYTE_C2_BOOT_VECT |                       \
    OPTIONBYTE_SECURE_MODE | OPTIONBYTE_C2_DEBUG_ACCESS |                      \
    OPTIONBYTE_SUBGHZSPI_SECURE_ACCESS))
...
#define IS_OB_WRPAREA(__VALUE__)                                               \
  (((__VALUE__) == OB_WRPAREA_BANK1_AREAA) ||                                  \
...
#define IS_OB_USER_CONFIG(__TYPE__, __VALUE__)                                 \
  ((((__TYPE__)&OB_USER_BOR_LEV) == OB_USER_BOR_LEV)                           \
       ? ((((__VALUE__) & ~(OB_USER_ALL & ~OB_USER_BOR_LEV)) ==                \
           OB_BOR_LEVEL_0) ||                                                  \
          (((__VALUE__) & ~(OB_USER_ALL & ~OB_USER_BOR_LEV)) ==                \
           OB_BOR_LEVEL_1) ||                                                  \
          (((__VALUE__) & ~(OB_USER_ALL & ~OB_USER_BOR_LEV)) ==                \
...
#define IS_OB_BOOT_VECTOR_ADDR(__VALUE__)                                      \
  (IS_OB_SFSA_START_ADDR(__VALUE__) || IS_OB_SBRSA_START_ADDR(__VALUE__) ||    \
   IS_OB_SNBRSA_START_ADDR(__VALUE__))
#define IS_OB_BOOT_REGION(__VALUE__)                                           \
  (((__VALUE__) == OB_C2_BOOT_FROM_FLASH) ||                                   \
   ((__VALUE__) == OB_C2_BOOT_FROM_SRAM))

#define IS_OB_SUBGHZSPI_SECURE_ACCESS(__VALUE__)                               \
  (((__VALUE__) == OB_SUBGHZSPI_SECURE_ACCESS_ENABLE) ||                       \
   ((__VALUE__) == OB_SUBGHZSPI_SECURE_ACCESS_DISABLE))

#define IS_OB_C2_DEBUG_MODE(__VALUE__)                                         \
  (((__VALUE__) == OB_C2_DEBUG_ACCESS_ENABLE) ||                               \
