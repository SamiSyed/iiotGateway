...
#define LL_USART_PRESCALER_DIV16                                                                   \
    (USART_PRESC_PRESCALER_2 | USART_PRESC_PRESCALER_1 | USART_PRESC_PRESCALER_0) /*!< Input clock \
                                                                                     divided by 16 \
                                                                                   */
...
#define LL_USART_PRESCALER_DIV256                                                                  \
    (USART_PRESC_PRESCALER_3 | USART_PRESC_PRESCALER_1 | USART_PRESC_PRESCALER_0) /*!< Input clock \
                                                                                     divided by    \
                                                                                     256 */
/**
 * @}
 ...
 * @note   Macro @ref IS_USART_AUTOBAUDRATE_DETECTION_INSTANCE(USARTx) can be used to check whether
