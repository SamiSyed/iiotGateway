...
typedef struct
{
    ...
    uint32_t SubSeconds; /*!< Specifies the RTC_SSR RTC Sub Second register content.
                            ...
                            Second with [1 Sec / SecondFraction +1] granularity else
...
typedef struct
{
    ...
    uint32_t AlarmSubSecondMask; /*!< Specifies the RTC Alarm SubSeconds Masks.
                                      if Binary mode is RTC_BINARY_ONLY or is RTC_BINARY_MIX
                                        This parameter can be a value of @ref
                                    RTCEx_Alarm_Sub_Seconds_binary_Masks_Definitions else if Binary
                                    mode is RTC_BINARY_NONE This parameter can be a value of @ref
    ...
    uint32_t BinaryAutoClr; /*!< Clear synchronously counter (RTC_SSR) on binary alarm.
                               ...
                               is RTC_BINARY_ONLY This parameter can be a value of @ref
...
{
    RTC_TypeDef *Instance; /*!< Legacy register base address. Not used anymore, the driver directly
                              uses cmsis base address */
    ...
    RTC_IsEnabledTypeDef IsEnabled; /*!< Flag to avoid treatment of the interrupts activated by the
                                       other core  */
    ...
    void (*AlarmBEventCallback)(struct __RTC_HandleTypeDef *hrtc); /*!< RTC Alarm B Event callback
                                                                    */
    void (*TimeStampEventCallback)(struct __RTC_HandleTypeDef *hrtc);   /*!< RTC TimeStamp Event
                                                                           callback          */
    void (*WakeUpTimerEventCallback)(struct __RTC_HandleTypeDef *hrtc); /*!< RTC WakeUpTimer Event
                                                                           callback        */
    ...
    void (*Tamper3EventCallback)(struct __RTC_HandleTypeDef *hrtc); /*!< RTC Tamper 3 Event callback
                                                                     */
    void (*InternalTamper3EventCallback)(struct __RTC_HandleTypeDef *hrtc); /*!< RTC Internal Tamper
                                                                               3 Event callback  */
    void (*InternalTamper5EventCallback)(struct __RTC_HandleTypeDef *hrtc); /*!< RTC Internal Tamper
                                                                               5 Event callback  */
    void (*InternalTamper6EventCallback)(struct __RTC_HandleTypeDef *hrtc); /*!< RTC Internal Tamper
                                                                               6 Event callback  */
    void (*InternalTamper8EventCallback)(struct __RTC_HandleTypeDef *hrtc); /*!< RTC Internal Tamper
                                                                               8 Event callback  */
...
/** @defgroup RTC_Input_parameter_format_definitions RTC input or output data format for date (Year,
 * Month, Weekday) and time (Hours, Minutes, Seconds). Warning : It Should not be confused with the
 * Binary mode @ref RTCEx_Binary_Mode.
 * @{
 */
#define RTC_FORMAT_BIN                                                                             \
    0x00000000u /* This parameter will trigger a SW conversion to fit with the native BCD format   \
                   of the HW Calendar. It should not be confused with the Binary mode @ref                                               \
                   RTCEx_Binary_Mode. */
...
#define RTC_ALARMSUBSECONDMASK_SS14_7                                                              \
    (RTC_ALRMASSR_MASKSS_0 | RTC_ALRMASSR_MASKSS_1 | RTC_ALRMASSR_MASKSS_2) /*!< SS[14:7] not used \
                                                                               in Alarm            \
                                                                                 comparison. Only  \
                                                                               SS[6:0] are         \
                                                                               compared  */
...
#define RTC_ALARMSUBSECONDMASK_SS14_11                                                             \
    (RTC_ALRMASSR_MASKSS_0 | RTC_ALRMASSR_MASKSS_1 | RTC_ALRMASSR_MASKSS_3) /*!< SS[14:11] not     \
                                                                               used in Alarm       \
                                                                                 comparison. Only  \
                                                                               SS[10:0] are        \
                                                                               compared */
...
#define RTC_ALARMSUBSECONDMASK_SS14_13                                                             \
    (RTC_ALRMASSR_MASKSS_0 | RTC_ALRMASSR_MASKSS_2 | RTC_ALRMASSR_MASKSS_3) /*!< SS[14:13] not     \
                                                                               used in Alarm       \
                                                                                 comparison. Only  \
                                                                               SS[12:0] are        \
                                                                               compared */
#define RTC_ALARMSUBSECONDMASK_SS14                                                                \
    (RTC_ALRMASSR_MASKSS_1 | RTC_ALRMASSR_MASKSS_2 | RTC_ALRMASSR_MASKSS_3) /*!< SS[14] not used   \
                                                                               in Alarm            \
                                                                                 comparison. Only  \
                                                                               SS[13:0] are        \
                                                                               compared  */
...
#define __HAL_RTC_IS_CALENDAR_INITIALIZED(__HANDLE__)                                              \
    ((((RTC->ICSR) & (RTC_ICSR_INITS)) == RTC_ICSR_INITS) ? 1U : 0U)
