...
typedef struct {
  ...
  uint32_t
      DayLightSaving; /*!< This interface is deprecated. To manage Daylight
                         Saving Time, please use HAL_RTC_DST_xxx functions */

  uint32_t
      StoreOperation; /*!< This interface is deprecated. To manage Daylight
                         Saving Time, please use HAL_RTC_DST_xxx functions */
} RTC_TimeTypeDef;
...
#endif /* (USE_HAL_RTC_REGISTER_CALLBACKS) */
{
  ...
  RTC_IsEnabledTypeDef IsEnabled; /*!< Flag to avoid treatment of the interrupts
                                     activated by the other core  */
...
typedef enum {
  ...
  HAL_RTC_INTERNAL_TAMPER3_EVENT_CB_ID =
      8u, /*!< RTC Internal Tamper 3 Callback ID  */
  HAL_RTC_INTERNAL_TAMPER5_EVENT_CB_ID =
      9u, /*!< RTC Internal Tamper 5 Callback ID  */
  HAL_RTC_INTERNAL_TAMPER6_EVENT_CB_ID =
      10u, /*!< RTC Internal Tamper 6 Callback ID  */
  HAL_RTC_INTERNAL_TAMPER8_EVENT_CB_ID =
      11u,                      /*!< RTC Internal Tamper 8 Callback ID  */
...
/** @defgroup RTC_Input_parameter_format_definitions RTC input or output data
 * format for date (Year, Month, Weekday) and time (Hours, Minutes, Seconds).
 *           Warning : It Should not be confused with the Binary mode @ref
 * RTCEx_Binary_Mode.
 * @{
 */
#define RTC_FORMAT_BIN                                                         \
  0x00000000u /* This parameter will trigger a SW conversion to fit with the   \
                 native BCD format of the HW Calendar. It should not be                                                              \
                 confused with the Binary mode @ref RTCEx_Binary_Mode. */

#define RTC_FORMAT_BCD                                                         \
  0x00000001u /* Native format of the HW Calendar.                             \
                 It should not be confused with the Binary mode @ref           \
                 RTCEx_Binary_Mode. */
/**
 * @}
 */
...
#define RTC_FLAG_SSRUF                                                         \
  (0x00000200U | RTC_SR_SSRUF_Pos) /*!< SSR underflow flag */
