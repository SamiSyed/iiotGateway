...
#define LL_RNG_CLKDIV_BY_128                                                                       \
    (RNG_CR_CLKDIV_2 | RNG_CR_CLKDIV_1 | RNG_CR_CLKDIV_0) /*!< 128 RNG clock cycles per internal   \
                                                             RNG clock   */
...
#define LL_RNG_CLKDIV_BY_2048                                                                      \
    (RNG_CR_CLKDIV_3 | RNG_CR_CLKDIV_1 | RNG_CR_CLKDIV_0) /*!< 2048 RNG clock cycles per internal  \
                                                             RNG clock  */
...
#define LL_RNG_CLKDIV_BY_8192                                                                      \
    (RNG_CR_CLKDIV_3 | RNG_CR_CLKDIV_2 | RNG_CR_CLKDIV_0) /*!< 8192 RNG clock cycles per internal  \
                                                             RNG clock  */
#define LL_RNG_CLKDIV_BY_16384                                                                     \
    (RNG_CR_CLKDIV_3 | RNG_CR_CLKDIV_2 | RNG_CR_CLKDIV_1) /*!< 16384 RNG clock cycles per internal \
                                                             RNG clock */
#define LL_RNG_CLKDIV_BY_32768                                                                     \
    (RNG_CR_CLKDIV_3 | RNG_CR_CLKDIV_2 | RNG_CR_CLKDIV_1 | RNG_CR_CLKDIV_0) /*!< 32768 RNG clock   \
                                                                               cycles per internal \
                                                                               RNG clock */
/**
 * @}
