...
#endif /* USE_HAL_TIM_REGISTER_CALLBACKS */
{
    ...
    void (*Base_MspInitCallback)(struct __TIM_HandleTypeDef *htim); /*!< TIM Base Msp Init Callback
                                                                     */
    void (*Base_MspDeInitCallback)(struct __TIM_HandleTypeDef *htim); /*!< TIM Base Msp DeInit
                                                                         Callback */
    ...
    void (*PWM_MspDeInitCallback)(struct __TIM_HandleTypeDef *htim);    /*!< TIM PWM Msp DeInit
                                                                           Callback    */
    void (*OnePulse_MspInitCallback)(struct __TIM_HandleTypeDef *htim); /*!< TIM One Pulse Msp Init
                                                                           Callback */
    void (*OnePulse_MspDeInitCallback)(struct __TIM_HandleTypeDef *htim); /*!< TIM One Pulse Msp
                                                                             DeInit Callback */
    void (*Encoder_MspInitCallback)(struct __TIM_HandleTypeDef *htim);    /*!< TIM Encoder Msp Init
                                                                             Callback    */
    void (*Encoder_MspDeInitCallback)(struct __TIM_HandleTypeDef *htim); /*!< TIM Encoder Msp DeInit
                                                                            Callback */
    void (*HallSensor_MspInitCallback)(struct __TIM_HandleTypeDef *htim);   /*!< TIM Hall Sensor Msp
                                                                               Init Callback   */
    void (*HallSensor_MspDeInitCallback)(struct __TIM_HandleTypeDef *htim); /*!< TIM Hall Sensor Msp
                                                                               DeInit Callback */
    void (*PeriodElapsedCallback)(struct __TIM_HandleTypeDef *htim);        /*!< TIM Period Elapsed
                                                                               Callback        */
    void (*PeriodElapsedHalfCpltCallback)(struct __TIM_HandleTypeDef *htim); /*!< TIM Period Elapsed
                                                                                half complete
                                                                                Callback */
    ...
    void (*IC_CaptureHalfCpltCallback)(struct __TIM_HandleTypeDef *htim); /*!< TIM Input Capture
                                                                             half complete Callback
                                                                           */
    void (*OC_DelayElapsedCallback)(struct __TIM_HandleTypeDef *htim); /*!< TIM Output Compare Delay
                                                                          Elapsed Callback */
    void (*PWM_PulseFinishedCallback)(struct __TIM_HandleTypeDef *htim); /*!< TIM PWM Pulse Finished
                                                                            Callback */
    void (*PWM_PulseFinishedHalfCpltCallback)(struct __TIM_HandleTypeDef *htim); /*!< TIM PWM Pulse
                                                                                    Finished half
                                                                                    complete
                                                                                    Callback */
    ...
    void (*CommutationHalfCpltCallback)(struct __TIM_HandleTypeDef *htim); /*!< TIM Commutation half
                                                                              complete Callback */
...
typedef enum
{
    ...
    HAL_TIM_PWM_PULSE_FINISHED_CB_ID = 0x15U /*!< TIM PWM Pulse Finished Callback ID           */
        ,
    HAL_TIM_PWM_PULSE_FINISHED_HALF_CB_ID = 0x16U /*!< TIM PWM Pulse Finished half complete Callback
                                                     ID           */
        ,
...
#define TIM_TRGO2_OC1                                                                              \
    (TIM_CR2_MMS2_1 | TIM_CR2_MMS2_0) /*!< Capture or a compare match 1 is used as trigger output  \
                                         (TRGO2) */
...
#define TIM_TRGO2_OC5REF_RISING_OC6REF_RISING                                                      \
    (TIM_CR2_MMS2_3 | TIM_CR2_MMS2_2 | TIM_CR2_MMS2_1) /*!< OC5REF or OC6REF rising edges generate \
                                                          pulses on TRGO2         */
#define TIM_TRGO2_OC5REF_RISING_OC6REF_FALLING                                                     \
    (TIM_CR2_MMS2_3 | TIM_CR2_MMS2_2 | TIM_CR2_MMS2_1 | TIM_CR2_MMS2_0) /*!< OC5REF or OC6REF      \
                                                                           rising edges generate   \
                                                                           pulses on TRGO2 */
/**
 * @}
 */
...
#define TIM_BREAK_SYSTEM_ECC                                                                       \
    SYSCFG_CFGR2_ECCL /*!< Enables and locks the ECC error signal with Break Input of TIM1/16/17   \
                       */
#define TIM_BREAK_SYSTEM_PVD                                                                       \
    SYSCFG_CFGR2_PVDL /*!< Enables and locks the PVD connection with TIM1/16/17 Break Input and    \
                         also the PVDE and PLS bits of the Power Control Interface */
