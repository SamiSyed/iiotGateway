...
#define LL_SPI_NSS_HARD_OUTPUT                                                                     \
    (((uint32_t)SPI_CR2_SSOE << 16U)) /*!< NSS pin used in Output. Only used in Slave mode as chip \
                                         select */
/**
 * @}
 */
...
#define LL_SPI_DATAWIDTH_16BIT                                                                     \
    (SPI_CR2_DS_3 | SPI_CR2_DS_2 | SPI_CR2_DS_1 | SPI_CR2_DS_0) /*!< Data length for SPI transfer: \
                                                                   16 bits */
/**
 * @}
 */
...
typedef struct
{
    ...
    uint32_t AudioFreq; /*!< Specifies the frequency selected for the I2S communication.
                           ...
                           formulas to calculate Prescaler Linear, Parity
                             and unitary functions @ref LL_I2S_SetPrescalerLinear() and @ref
...
#define LL_I2S_STANDARD_PCM_LONG                                                                   \
    (SPI_I2SCFGR_I2SSTD_0 | SPI_I2SCFGR_I2SSTD_1 | SPI_I2SCFGR_PCMSYNC) /*!< PCM standard, long    \
