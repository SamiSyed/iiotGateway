...
#define PWR_PVDLEVEL_7                                                                             \
    (PWR_CR2_PLS_2 | PWR_CR2_PLS_1 | PWR_CR2_PLS_0) /*!< External input analog voltage (compared   \
...
#define PWR_PVD_MODE_NORMAL                                                                        \
    (0x00000000UL) /*!< PVD in polling mode (PVD flag update without interruption) */

#define PWR_PVD_MODE_IT_RISING                                                                     \
    (PVD_MODE_IT | PVD_RISING_EDGE) /*!< PVD in interrupt mode with rising edge trigger detection  \
                                     */
#define PWR_PVD_MODE_IT_FALLING                                                                    \
    (PVD_MODE_IT | PVD_FALLING_EDGE) /*!< PVD in interrupt mode with falling edge trigger          \
                                        detection */
#define PWR_PVD_MODE_IT_RISING_FALLING                                                             \
    (PVD_MODE_IT | PVD_RISING_FALLING_EDGE) /*!< PVD in interrupt mode with rising/falling edge    \
                                               trigger detection */
/**
 * @}
 */
...
#define PWR_LOWPOWERMODE_STOP2                                                                     \
    (PWR_C2CR1_LPMS_1) /*!< Stop 2: Stop mode with low power regulator and VDD12I interruptible    \
...
#define PWR_LOWPOWERMODE_STOP2                                                                     \
    (PWR_CR1_LPMS_1) /*!< Stop 2: Stop mode with low power regulator and VDD12I interruptible      \
                        digital core domain supply OFF (less peripherals activated than low power  \
                        mode stop 1 to reduce power consumption)*/
 ...
 *
 *            @arg @ref PWR_FLAG_WRFBUSY   Wake-up radio busy flag (triggered status: wake-up event
 ...
 *
 *            @arg @ref PWR_FLAG_REGLPS Low-power Regulator 1 started: Indicates whether the
 * regulator is ready after a power-on reset or a Standby/Shutdown.
 ...
 *
 *            @arg @ref PWR_FLAG_REGMRS Low-power regulator (main regulator or low-power regulator
 * used) flag.
 *
 ...
 *
 *            @arg @ref PWR_FLAG_RFEOL Indicate whether supply voltage is below radio operating
 * level (radio "end of life").
 *
