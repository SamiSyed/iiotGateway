...
static LmHandlerErrorStatus_t LmhpComplianceTxProcess(void) {
  ...
  if (ComplianceTestState.LinkCheck == true) {
    ...
    case 1:
      ...
      ComplianceTestState.DataBuffer[0] =
          ComplianceTestState.DownLinkCounter >> 8;
  ...
  LmHandlerAppData_t appData = {.Buffer = ComplianceTestState.DataBuffer,
                                .BufferSize =
                                    ComplianceTestState.DataBufferSize,
                                .Port = COMPLIANCE_PORT};
  ...
  return LmhpCompliancePackage.OnSendRequest(
      &appData, (LmHandlerMsgTypes_t)ComplianceTestState.IsTxConfirmed, true);
}
...
static void LmhpComplianceOnMcpsIndication(McpsIndication_t *mcpsIndication) {
  ...
  if (ComplianceTestState.IsRunning == false) {
    ...
    if ((mcpsIndication->BufferSize == 4) &&
      ...
      TimerInit(&ComplianceTxNextPacketTimer,
    ...
    case 4: /* (vii) */
      ...
      for (uint8_t i = 1; i < MIN(ComplianceTestState.DataBufferSize,
...
static void LmhpComplianceProcess(void) { /* Nothing to process */ }
...
LmhPackage_t *LmhpCompliancePackageFactory(void) { return &CompliancePackage; }
  ...
  if (ComplianceTestState.IsTxPending == true) {
    ...
    if (now > (ComplianceTestState.TxPendingTimestamp +
      ...
      if (ComplianceTestState.DataBufferSize != 0) {
        ...
        lmhStatus =
            LmHandlerSend(&appData, ComplianceTestState.IsTxConfirmed, true);
...
static void LmhpComplianceOnMcpsIndication(McpsIndication_t *mcpsIndication) {
  ...
  case COMPLIANCE_SWITCH_CLASS_REQ: {
    /* CLASS_A = 0, CLASS_B = 1, CLASS_C = 2 */
    ComplianceTestState.NewClass =
        (DeviceClass_t)mcpsIndication->Buffer[cmdIndex++];
  ...
  case COMPLIANCE_TX_FRAMES_CTRL_REQ: {
    ...
    if ((frameType == 1) || (frameType == 2)) {
      ...
      if (ComplianceParams->OnTxFrameCtrlChanged != NULL) {
        ComplianceParams->OnTxFrameCtrlChanged(
            ComplianceTestState.IsTxConfirmed);
      }
    }
    break;
  }
