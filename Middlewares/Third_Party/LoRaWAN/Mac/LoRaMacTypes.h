 ...
 * \file      LoRaMacTypes.h
 *
 * \brief     LoRa MAC layer internal types definition. Please do not include in application
 * sources.
 *
...
typedef union uDrRange {
    ...
    struct sFields
    {
         ...
         *
         * The allowed ranges are region specific. Please refer to \ref DR_0 to \ref DR_15 for
         * details.
         */
        int8_t Min : 4;
        /*!
