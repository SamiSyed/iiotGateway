...
void RegionIN865ApplyCFList(ApplyCFListParams_t *applyCFList)
{
    ...
    for (uint8_t i = 0, chanIdx = IN865_NUMB_DEFAULT_CHANNELS; chanIdx < IN865_MAX_NB_CHANNELS;
         i += 3, chanIdx++)
    {
                                          ...
                                          RxConfigParams_t *rxConfigParams)
{
    ...
    { // LoRa
        tSymbolInUs = RegionCommonComputeSymbolTimeLoRa(DataratesIN865[rxConfigParams->Datarate],
