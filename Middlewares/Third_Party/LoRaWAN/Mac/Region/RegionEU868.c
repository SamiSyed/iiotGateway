...
void RegionEU868ApplyCFList(ApplyCFListParams_t *applyCFList)
{
    ...
    for (uint8_t i = 0, chanIdx = EU868_NUMB_DEFAULT_CHANNELS; chanIdx < EU868_MAX_NB_CHANNELS;
         i += 3, chanIdx++)
    {
                                          ...
                                          RxConfigParams_t *rxConfigParams)
{
    ...
    { // LoRa
        tSymbolInUs = RegionCommonComputeSymbolTimeLoRa(DataratesEU868[rxConfigParams->Datarate],
