...
#define LORAMAC_JOIN_REQ_MSG_SIZE                                                                  \
    (LORAMAC_MHDR_FIELD_SIZE + LORAMAC_JOIN_EUI_FIELD_SIZE + LORAMAC_DEV_EUI_FIELD_SIZE            \
     + LORAMAC_DEV_NONCE_FIELD_SIZE + LORAMAC_MIC_FIELD_SIZE)
...
#define LORAMAC_RE_JOIN_1_MSG_SIZE                                                                 \
    (LORAMAC_MHDR_FIELD_SIZE + LORAMAC_JOIN_TYPE_FIELD_SIZE + LORAMAC_JOIN_EUI_FIELD_SIZE          \
     + LORAMAC_DEV_EUI_FIELD_SIZE + LORAMAC_RJCOUNT_1_FIELD_SIZE + LORAMAC_MIC_FIELD_SIZE)
...
#define LORAMAC_RE_JOIN_0_2_MSG_SIZE                                                               \
    (LORAMAC_MHDR_FIELD_SIZE + LORAMAC_JOIN_TYPE_FIELD_SIZE + LORAMAC_NET_ID_FIELD_SIZE            \
     + LORAMAC_DEV_EUI_FIELD_SIZE + LORAMAC_RJCOUNT_0_FIELD_SIZE + LORAMAC_MIC_FIELD_SIZE)
...
#define LORAMAC_JOIN_ACCEPT_FRAME_MIN_SIZE                                                         \
    (LORAMAC_MHDR_FIELD_SIZE + LORAMAC_JOIN_NONCE_FIELD_SIZE + LORAMAC_NET_ID_FIELD_SIZE           \
     + LORAMAC_DEV_ADDR_FIELD_SIZE + LORAMAC_DL_SETTINGS_FIELD_SIZE + LORAMAC_RX_DELAY_FIELD_SIZE  \
...
#define LORAMAC_FRAME_PAYLOAD_MAX_SIZE                                                             \
    (LORAMAC_MHDR_FIELD_SIZE                                                                       \
     + (LORAMAC_FHDR_DEV_ADDR_FIELD_SIZE + LORAMAC_FHDR_F_CTRL_FIELD_SIZE                          \
        + LORAMAC_FHDR_F_CNT_FIELD_SIZE)                                                           \
     + LORAMAC_F_PORT_FIELD_SIZE + LORAMAC_MAC_PAYLOAD_FIELD_MAX_SIZE + LORAMAC_MIC_FIELD_SIZE)
