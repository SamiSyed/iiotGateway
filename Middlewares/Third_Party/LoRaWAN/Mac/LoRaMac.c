...
__attribute__((section(".bss.LW_NVM_RAM"))) __NO_INIT __ROOT static LoRaMacNvmData_t Nvm;
#else
 ...
 * \param[IN]     macMsg                - Data message object, holding the current 16 bit
 * transmitted frame counter \param[IN]     lrWanVersion          - LoRaWAN version \param[IN]
 * maxFCntGap            - Maximum allowed frame counter difference (only for 1.0.X necessary)
 ...
 * \param [in]    fType                 - Frame type
 * \param [in]    macMsg                - Data message object, holding the current 16 bit
 * transmitted frame counter \param [in]    lrWanVersion          - LoRaWAN version \param [out]
 * fCntID                - Frame counter identifier \param [out]   currentDown           - Current
 * downlink counter value
 *
 * \retval                              - Status of the operation
 */
static LoRaMacCryptoStatus_t GetFCntDown(AddressIdentifier_t addrID,
 ...
 */
static LoRaMacStatus_t Send(LoRaMacHeader_t *macHdr,
                            uint8_t fPort,
                            void *fBuffer,
 ...
 * \retval status          Status of the operation.
 */
static LoRaMacStatus_t PrepareFrame(LoRaMacHeader_t *macHdr,
...
static void ProcessRadioRxDone(void)
{
    ...
    case FRAME_TYPE_JOIN_ACCEPT:
    {
        ...
        {
            macCryptoStatus
                = LoRaMacCryptoHandleJoinAccept(REJOIN_REQ_0, joinEui, &macMsgJoinAccept);
        ...
        {
            macCryptoStatus
                = LoRaMacCryptoHandleJoinAccept(REJOIN_REQ_1, joinEui, &macMsgJoinAccept);
        ...
        {
            macCryptoStatus
                = LoRaMacCryptoHandleJoinAccept(REJOIN_REQ_2, joinEui, &macMsgJoinAccept);
    ...
    case FRAME_TYPE_DATA_UNCONFIRMED_DOWN:
        ...
        phyParam = RegionGetPhyParam(Nvm.MacGroup2.Region, &getPhy);
        if ((MAX(0, (int16_t)((int16_t)size - (int16_t)LORAMAC_FRAME_PAYLOAD_OVERHEAD_SIZE))
     ...
     && ((LORAMAC_VERSION == 0x01000400) || (LORAMAC_VERSION == 0x01010100)))
        ...
        macCryptoStatus = GetFCntDown(addrID,
                                      fType,
                                      &macMsgData,
                                      Nvm.MacGroup2.Version,
                                      phyParam.Value,
                                      &fCntID,
                                      &downLinkCounter);
        ...
        macCryptoStatus
            = LoRaMacCryptoUnsecureMessage(addrID, address, fCntID, downLinkCounter, &macMsgData);
        if (macCryptoStatus != LORAMAC_CRYPTO_SUCCESS)
        {
       ...
       && ((LORAMAC_VERSION == 0x01000400) || (LORAMAC_VERSION == 0x01010100)))
        ...
        if ((MacCtx.RxStatus.RxSlot == RX_SLOT_WIN_1) || (MacCtx.RxStatus.RxSlot == RX_SLOT_WIN_2))
        {
     ...
     && ((LORAMAC_VERSION == 0x01000400) || (LORAMAC_VERSION == 0x01010100)))
        ...
        RemoveMacCommands(MacCtx.RxStatus.RxSlot,
                          macMsgData.FHDR.FCtrl,
        ...
        { /* +----------+------+-------+--------------+
           ...
           */
            ...
            ProcessMacCommands(macMsgData.FHDR.FOpts,
                               0,
                               macMsgData.FHDR.FCtrl.Bits.FOptsLen,
                               snr,
                               MacCtx.RxStatus.RxSlot);
        ...
        { /* +----------+------+-------+--------------+
           ...
           */
            ...
            ProcessMacCommands(macMsgData.FRMPayload,
                               0,
                               macMsgData.FRMPayloadSize,
                               snr,
                               MacCtx.RxStatus.RxSlot);
            MacCtx.McpsIndication.Port = macMsgData.FPort;
            break;
...
static void LoRaMacHandleNvm(LoRaMacNvmData_t *nvmData)
{
    ...
    crc = Crc32((uint8_t *)&nvmData->SecureElement,
                sizeof(nvmData->SecureElement) - sizeof(nvmData->SecureElement.Crc32));
    ...
    crc = Crc32((uint8_t *)&nvmData->RegionGroup1,
                sizeof(nvmData->RegionGroup1) - sizeof(nvmData->RegionGroup1.Crc32));
    ...
    crc = Crc32((uint8_t *)&nvmData->RegionGroup2,
                sizeof(nvmData->RegionGroup2) - sizeof(nvmData->RegionGroup2.Crc32));
        ...
        if (deviceClass == CLASS_C)
        {
            ...
            for (int8_t i = 0; i < LORAMAC_MAX_MC_CTX; i++)
            {
                if ((Nvm.MacGroup2.MulticastChannelList[i].ChannelParams.IsEnabled == true)
                    && (Nvm.MacGroup2.MulticastChannelList[i].ChannelParams.RxParams.Class
                        == CLASS_C))
                {
                    ...
                    Nvm.MacGroup2.MacParams.RxCChannel.Datarate
                        = Nvm.MacGroup2.MulticastChannelList[i]
                              .ChannelParams.RxParams.Params.ClassC.Datarate;

                    MacCtx.RxWindowCConfig.Channel = MacCtx.Channel;
                    MacCtx.RxWindowCConfig.Frequency = Nvm.MacGroup2.MacParams.RxCChannel.Frequency;
                    MacCtx.RxWindowCConfig.DownlinkDwellTime
                        = Nvm.MacGroup2.MacParams.DownlinkDwellTime;
                    MacCtx.RxWindowCConfig.RepeaterSupport
                        = Nvm.MacGroup2.MacParams.RepeaterSupport;
            ...
            if (Nvm.MacGroup2.Version.Fields.Minor >= 1)
            {
                LoRaMacCommandsAddCmd(MOTE_MAC_DEVICE_MODE_IND,
                                      (uint8_t *)&Nvm.MacGroup2.DeviceClass,
                                      1);
            }
#endif /* LORAMAC_VERSION */
    ...
    while (macIndex < commandsSize)
    {
        ...
        case SRV_MAC_LINK_ADR_REQ:
        {
            ...
            if (adrBlockFound == false)
            {
                ...
                status = RegionLinkAdrReq(Nvm.MacGroup2.Region,
                                          &linkAdrReq,
                                          &linkAdrDatarate,
                                          &linkAdrTxPower,
                                          &linkAdrNbRep,
            ...
            if (adrBlockFound == false)
            {
                ...
                do
                {
                    ...
                    else
                    {
                        ...
                        // LinkAdrRequests and will call RegionLinkAdrReq for each individually, as
                        // every request requires an individual answer. When ADR is off, the
                        // function RegionLinkAdrReq ignores the new values for ChannelsDatarate,
                        // ChannelsTxPower and ChannelsNbTrans.
       ...
       && ((LORAMAC_VERSION == 0x01000400) || (LORAMAC_VERSION == 0x01010100)))
        ...
        case SRV_MAC_BEACON_TIMING_ANS:
        {
            if (LoRaMacConfirmQueueIsCmdActive(MLME_BEACON_TIMING) == true)
            {
                ...
                LoRaMacClassBBeaconTimingAns(beaconTimingDelay,
                                             beaconTimingChannel,
                            ...
                            bool allowDelayedTx)
{
    ...
    fCtrl.Bits.AdrAckReq = LoRaMacAdrCalcNext(&adrNext,
                                              &Nvm.MacGroup1.ChannelsDatarate,
...
static LoRaMacStatus_t SendReJoinReq(JoinReqIdentifier_t joinReqType)
{
    ...
    case REJOIN_REQ_1:
    {
        ...
        if (LORAMAC_CRYPTO_SUCCESS
            != LoRaMacCryptoGetRJcount(RJ_COUNT_1, &MacCtx.TxMsg.Message.ReJoin1.RJcount1))
        {
    ...
    case REJOIN_REQ_2:
    {
        ...
        if (LORAMAC_CRYPTO_SUCCESS
            != LoRaMacCryptoGetRJcount(RJ_COUNT_0, &MacCtx.TxMsg.Message.ReJoin0or2.RJcount0))
        {
            return LORAMAC_STATUS_CRYPTO_ERROR;
        }
...
static void ComputeRxWindowParameters(void)
{
    ...
    MacCtx.RxWindow1Delay
        = Nvm.MacGroup2.MacParams.ReceiveDelay1 + MacCtx.RxWindow1Config.WindowOffset;
    MacCtx.RxWindow2Delay
        = Nvm.MacGroup2.MacParams.ReceiveDelay2 + MacCtx.RxWindow2Config.WindowOffset;

    if (MacCtx.TxMsg.Type != LORAMAC_MSG_TYPE_DATA)
    {
        MacCtx.RxWindow1Delay
            = Nvm.MacGroup2.MacParams.JoinAcceptDelay1 + MacCtx.RxWindow1Config.WindowOffset;
        MacCtx.RxWindow2Delay
            = Nvm.MacGroup2.MacParams.JoinAcceptDelay2 + MacCtx.RxWindow2Config.WindowOffset;
    }
}
...
static LoRaMacStatus_t ScheduleTx(bool allowDelayedTx)
{
    ...
    // Select channel
    status = RegionNextChannel(Nvm.MacGroup2.Region,
                               &nextChan,
                               &MacCtx.Channel,
...
static LoRaMacStatus_t SecureFrame(uint8_t txDr, uint8_t txCh)
{
    ...
    case LORAMAC_MSG_TYPE_DATA:
       ...
       && ((LORAMAC_VERSION == 0x01000400) || (LORAMAC_VERSION == 0x01010100)))
        ...
        macCryptoStatus
            = LoRaMacCryptoSecureMessage(fCntUp, txDr, txCh, &MacCtx.TxMsg.Message.Data);
        if (LORAMAC_CRYPTO_SUCCESS != macCryptoStatus)
        {
            return LORAMAC_STATUS_CRYPTO_ERROR;
        }
...
static void CalculateBackOff(void)
{
    // Make sure that the calculation of the backoff time for the aggregated time off will only be
    // done in case the value is zero. It will be set to zero in the function RegionNextChannel.
    if (Nvm.MacGroup1.AggregatedTimeOff == 0)
    {
        // Update aggregated time-off. This must be an assignment and no incremental
        // update as we do only calculate the time-off based on the last transmission
        Nvm.MacGroup1.AggregatedTimeOff
            = (MacCtx.TxTimeOnAir * Nvm.MacGroup2.AggregatedDCycle - MacCtx.TxTimeOnAir);
    }
}
...
static bool IsReJoin0Required()
{
    if ((Nvm.MacGroup2.Rejoin0UplinksLimit == Nvm.MacGroup1.Rejoin0UplinksCounter)
        && (Nvm.MacGroup2.Version.Fields.Minor >= 1) && (Nvm.MacGroup2.Rejoin0UplinksLimit != 0))
    {
...
static void OpenContinuousRxCWindow(void)
{
    ...
    if (RegionRxConfig(Nvm.MacGroup2.Region,
                       &MacCtx.RxWindowCConfig,
                       (int8_t *)&MacCtx.McpsIndication.RxDatarate)
        == true)
    {
        MacCtx.MlmeIndication.RxDatarate = MacCtx.McpsIndication.RxDatarate;
                                    ...
                                    uint16_t fBufferSize)
{
    ...
    case FRAME_TYPE_DATA_UNCONFIRMED_UP:
       ...
       && ((LORAMAC_VERSION == 0x01000400) || (LORAMAC_VERSION == 0x01010100)))
        ...
        if (macCmdsSize > 0)
        {
            ...
            {
                if (LoRaMacCommandsSerializeCmds(LORA_MAC_COMMAND_MAX_FOPTS_LENGTH,
                                                 &macCmdsSize,
            ...
            // There is application payload available but the MAC commands does NOT fit into FOpts
            // field.
            else if ((MacCtx.AppDataSize > 0) && (macCmdsSize > LORA_MAC_COMMAND_MAX_FOPTS_LENGTH))
            {
                if (LoRaMacCommandsSerializeCmds(availableSize,
                                                 &macCmdsSize,
    ...
    case FRAME_TYPE_PROPRIETARY:
        ...
        {
            memcpy1(MacCtx.PktBuffer + LORAMAC_MHDR_FIELD_SIZE,
                    (uint8_t *)fBuffer,
                    MacCtx.AppDataSize);
...
static LoRaMacStatus_t RestoreNvmData(void)
{
    ...
    // Crypto
    crc = Crc32((uint8_t *)&(NvmBackup.Crypto),
                sizeof(NvmBackup.Crypto) - sizeof(NvmBackup.Crypto.Crc32));
    ...
    // MacGroup1
    crc = Crc32((uint8_t *)&(NvmBackup.MacGroup1),
                sizeof(NvmBackup.MacGroup1) - sizeof(NvmBackup.MacGroup1.Crc32));
    ...
    // MacGroup2
    crc = Crc32((uint8_t *)&(NvmBackup.MacGroup2),
                sizeof(NvmBackup.MacGroup2) - sizeof(NvmBackup.MacGroup2.Crc32));
    ...
    // Secure Element
    crc = Crc32((uint8_t *)&(NvmBackup.SecureElement),
                sizeof(NvmBackup.SecureElement) - sizeof(NvmBackup.SecureElement.Crc32));
    ...
    // RegionGroup1
    crc = Crc32((uint8_t *)&(NvmBackup.RegionGroup1),
                sizeof(NvmBackup.RegionGroup1) - sizeof(NvmBackup.RegionGroup1.Crc32));
    ...
    // RegionGroup2
    crc = Crc32((uint8_t *)&(NvmBackup.RegionGroup2),
                sizeof(NvmBackup.RegionGroup2) - sizeof(NvmBackup.RegionGroup2.Crc32));
    if (crc != NvmBackup.RegionGroup2.Crc32)
    {
        return LORAMAC_STATUS_NVM_DATA_INCONSISTENT;
    }

    crc = Crc32((uint8_t *)&(NvmBackup.ClassB),
                sizeof(NvmBackup.ClassB) - sizeof(NvmBackup.ClassB.Crc32));
...
static LoRaMacStatus_t DetermineFrameType(LoRaMacMessageData_t *macMsg, FType_t *fType)
{
    ...
    /* The LoRaWAN specification allows several possible configurations how data up/down frames are
     * built up. In sake of clearness the following naming is applied. Please keep in mind that this
     * is implementation specific since there is no definition in the LoRaWAN specification
     * included.
     *
...
static bool CheckRetransUnconfirmedUplink(void)
{
    ...
    if (MacCtx.ChannelsNbTransCounter >= Nvm.MacGroup2.MacParams.ChannelsNbTrans)
    {
        return true;
    }
...
static bool CheckRetransUnconfirmedUplink(void)
{
    ...
    if (CheckRetrans(MacCtx.ChannelsNbTransCounter, Nvm.MacGroup2.MacParams.ChannelsNbTrans)
        == true)
    {
        return true;
    }
...
static bool StopRetransmission(void)
{
    ...
    if ((MacCtx.MacFlags.Bits.McpsInd == 0)
        || ((MacCtx.RxStatus.RxSlot != RX_SLOT_WIN_1) && (MacCtx.RxStatus.RxSlot != RX_SLOT_WIN_2)))
...
LoRaMacStatus_t LoRaMacMibGetRequestConfirm(MibRequestConfirm_t *mibGet)
{
    ...
    case MIB_RSSI_FREE_THRESHOLD:
    {
        ...
        if (Nvm.MacGroup2.Region != LORAMAC_REGION_AS923
            && Nvm.MacGroup2.Region != LORAMAC_REGION_KR920)
        {
...
LoRaMacStatus_t LoRaMacMibSetRequestConfirm(MibRequestConfirm_t *mibSet)
{
    ...
    case MIB_NETWORK_ACTIVATION:
    {
        ...
        { // Do not allow to set ACTIVATION_TYPE_OTAA since the MAC will set it automatically after
    ...
    case MIB_DEV_ADDR:
    {
        if (SecureElementSetDevAddr(Nvm.MacGroup2.NetworkActivation, mibSet->Param.DevAddr)
...
LoRaMacStatus_t LoRaMacMcChannelSetup(McChannelParams_t *channel)
{
    ...
    if (channel->IsRemotelySetup == true)
    {
        ...
        if (LoRaMacCryptoDeriveMcSessionKeyPair(channel->GroupID, channel->Address)
            != LORAMAC_CRYPTO_SUCCESS)
        {
            return LORAMAC_STATUS_CRYPTO_ERROR;
        }
    ...
    {
        if (LORAMAC_CRYPTO_SUCCESS
            != LoRaMacCryptoSetKey(MCAppSKeys[channel->GroupID], channel->McKeys.Session.McAppSKey))
        {
            return LORAMAC_STATUS_CRYPTO_ERROR;
        }
        if (LORAMAC_CRYPTO_SUCCESS
            != LoRaMacCryptoSetKey(MCNwkSKeys[channel->GroupID], channel->McKeys.Session.McNwkSKey))
        {
            return LORAMAC_STATUS_CRYPTO_ERROR;
        }
    }
                                              ...
                                              uint32_t *mic)
{
    ...
    macCryptoStatus
        = LoRaMacCryptoComputeDataBlock(buffer, size, sessionCnt, fragIndex, descriptor, mic);
    if (LORAMAC_CRYPTO_SUCCESS != macCryptoStatus)
    {
        return LORAMAC_STATUS_CRYPTO_ERROR;
    }
...
LoRaMacStatus_t LoRaMacMlmeRequest(MlmeReq_t *mlmeRequest)
{
    ...
    case MLME_JOIN:
    {
        ...
        Nvm.MacGroup1.ChannelsDatarate
            = RegionAlternateDr(Nvm.MacGroup2.Region, mlmeRequest->Req.Join.Datarate, ALTERNATE_DR);
        ...
        if (status != LORAMAC_STATUS_OK)
        {
            ...
            Nvm.MacGroup1.ChannelsDatarate = RegionAlternateDr(Nvm.MacGroup2.Region,
                                                               mlmeRequest->Req.Join.Datarate,
    ...
    case MLME_DEVICE_TIME:
    {
        ...
        /* ST_CODE End */
        else if (LoRaMacCommandsAddCmd(MOTE_MAC_DEVICE_TIME_REQ, macCmdPayload, 0)
                 != LORAMAC_COMMANDS_SUCCESS)
        {
            status = LORAMAC_STATUS_MAC_COMMAD_ERROR;
        }
    ...
    case MLME_PING_SLOT_INFO:
    {
        if (Nvm.MacGroup2.DeviceClass == CLASS_A)
        {
            ...
            status = LORAMAC_STATUS_OK;
            if (LoRaMacCommandsAddCmd(MOTE_MAC_PING_SLOT_INFO_REQ, macCmdPayload, 1)
                != LORAMAC_COMMANDS_SUCCESS)
            {
                status = LORAMAC_STATUS_MAC_COMMAD_ERROR;
            }
...
LoRaMacStatus_t LoRaMacMcpsRequest(McpsReq_t *mcpsRequest, bool allowDelayedTx)
{
    ...
    // AckTimeoutRetriesCounter must be reset every time a new request (unconfirmed or confirmed) is
    // performed.
    MacCtx.AckTimeoutRetriesCounter = 1;
    ...
    if ((Nvm.MacGroup2.NetworkActivation == ACTIVATION_TYPE_OTAA)
        && (Nvm.MacGroup2.DeviceClass == CLASS_C) && (Nvm.MacGroup2.DownlinkReceived == false)
    ...
    if (CheckForMinimumAbpDatarate(Nvm.MacGroup2.AdrCtrlOn,
                                   Nvm.MacGroup2.NetworkActivation,
    ...
    {
        if ((Nvm.MacGroup2.AdrCtrlOn == false)
            || (CheckForMinimumAbpDatarate(Nvm.MacGroup2.AdrCtrlOn,
                                           Nvm.MacGroup2.NetworkActivation,
                                           Nvm.MacGroup2.ChannelsDatarateChangedLinkAdrReq)
                == true))
        {
