...
uint32_t HAL_GetTick(void)
{
    ...
    if (SYS_TimerInitialisedFlag == 0)
    {
         ...
         */
        /* Note: when TIMER_IF is based on RTC, stm32wlxx_hal_rtc.c calls this function before
         * TimeServer is functional */
        /* RTC TIMEOUT will not expire, i.e. if RTC has an hw problem it will keep looping in the
         * RTC_Init function */
